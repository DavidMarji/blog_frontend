...
var require_tinymce_min = __commonJS({
  "node_modules/tinymce/tinymce.min.js"(exports, module) {
    !function() {
      ...
      }, k = (e2, t2) => (...n2) => e2(t2.apply(null, n2)), S = (e2, t2) => (n2) => e2(t2(n2)), N = (e2) => () => e2, R = (e2) => e2, A = (e2, t2) => e2 === t2;
      function T(e2, ...t2) {
        return (...n2) => {
      ...
      }, we = (e2) => Ce(e2, R), xe = (e2, t2) => Ee(e2, t2) ? I.from(e2[t2]) : I.none(), Ee = (e2, t2) => fe.call(e2, t2), _e = (e2, t2) => Ee(e2, t2) && void 0 !== e2[t2] && null !== e2[t2], ke = (e2) => {
        const t2 = {};
        return V(e2, (e3) => {
          t2[e3] = {};
        }), me(t2);
      }, Se = (e2) => void 0 !== e2.length, Ne = Array.isArray, Re = (e2, t2, n2) => {
        if (!e2) return false;
        if (n2 = n2 || e2, Se(e2)) {
      ...
      const xt = () => wt(), Et = navigator.userAgent, _t = xt(), kt = _t.browser, St = _t.os, Nt = _t.deviceType, Rt = -1 !== Et.indexOf("Windows Phone"), At = { transparentSrc: "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", documentMode: kt.isIE() ? document.documentMode || 7 : 10, cacheSuffix: null, container: null, canHaveCSP: !kt.isIE(), windowsPhone: Rt, browser: { current: kt.current, version: kt.version, isChromium: kt.isChromium, isEdge: kt.isEdge, isFirefox: kt.isFirefox, isIE: kt.isIE, isOpera: kt.isOpera, isSafari: kt.isSafari }, os: { current: St.current, version: St.version, isAndroid: St.isAndroid, isChromeOS: St.isChromeOS, isFreeBSD: St.isFreeBSD, isiOS: St.isiOS, isLinux: St.isLinux, isMacOS: St.isMacOS, isSolaris: St.isSolaris, isWindows: St.isWindows }, deviceType: { isDesktop: Nt.isDesktop, isiPad: Nt.isiPad, isiPhone: Nt.isiPhone, isPhone: Nt.isPhone, isTablet: Nt.isTablet, isTouch: Nt.isTouch, isWebView: Nt.isWebView } }, Tt = /^\s*|\s*$/g, Ot = (e2) => y(e2) ? "" : ("" + e2).replace(Tt, ""), Bt = function(e2, t2, n2, o2) {
      ...
      }, En = (e2) => 1 !== e2.nodeType && 9 !== e2.nodeType && 11 !== e2.nodeType || 0 === e2.childElementCount, _n = (e2, t2) => e2.dom === t2.dom, kn = (e2, t2) => {
        const n2 = e2.dom, o2 = t2.dom;
        return n2 !== o2 && n2.contains(o2);
      }, Sn = (e2) => yn(e2.dom.ownerDocument), Nn = (e2) => Yt(e2) ? e2 : Sn(e2), Rn = (e2) => yn(Nn(e2).dom.defaultView), An = (e2) => I.from(e2.dom.parentNode).map(yn), Tn = (e2) => I.from(e2.dom.parentElement).map(yn), On = (e2, t2) => {
        const n2 = w(t2) ? t2 : L;
        let o2 = e2.dom;
        const r2 = [];
        ...
        })(yn(t2)).fold(() => n2.body.contains(t2), S(Gn, Wn));
      };
      ...
      const Qn = (e2, t2, n2) => {
      ...
      }, _o = (e2) => q(e2, yn), ko = (e2) => e2.dom.innerHTML, So = (e2, t2) => {
        const n2 = Sn(e2).dom, o2 = yn(n2.createDocumentFragment()), r2 = ((e3, t3) => {
        ...
        const s2 = /* @__PURE__ */ ((e4, t4) => (n4) => {
          e4(n4) && t4(((e5) => {
            const t5 = yn(Kn(e5).getOr(e5.target)), n5 = () => e5.stopPropagation(), o4 = () => e5.preventDefault(), r3 = k(o4, n5);
      ...
      }, Er = (e2) => Wt(e2) && "br" === Ht(e2), _r = xr(["h1", "h2", "h3", "h4", "h5", "h6", "p", "div", "address", "pre", "form", "blockquote", "center", "dir", "fieldset", "header", "footer", "article", "section", "hgroup", "aside", "nav", "figure"]), kr = xr(["ul", "ol", "dl"]), Sr = xr(["li", "dd", "dt"]), Nr = xr(["thead", "tbody", "tfoot"]), Rr = xr(["td", "th"]), Ar = xr(["pre", "script", "textarea", "style"]), Tr = () => {
        const e2 = bn("br");
      ...
      const fs = (e2) => Tn(yn(e2)).exists((e3) => !oo(e3)), gs = (e2, t2 = true) => ((e3, t3) => {
        ...
        })), delete n2.svg, A2(e2.custom_elements), T2(e2.valid_children), S2(e2.extended_valid_elements), T2("+ol[ul|ol],+ul[ul|ol]"), sa({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, (e3, t3) => {
          n2[t3] && (n2[t3].parentsRequired = ta(e3));
        }), e2.invalid_elements && sa(ia(e2.invalid_elements), (e3) => {
          n2[e3] && delete n2[e3];
        }), O2("span") || S2("span[!data-mce-type|*]");
        const B2 = N(c2), P2 = N(u2), D2 = N(m2), L2 = N(h2), M2 = N(x2), F2 = N(w2), U2 = N(E2), z2 = N(Object.seal(p2)), j2 = N(g2), H2 = N(v2), $2 = N(y2), q2 = N(f2), W2 = N(_2), K2 = N(k2), Y2 = N(Object.seal(a2)), G2 = (e3, t3) => {
          const n3 = O2(e3);
          if (n3) {
            if (!t3) return true;
            {
        ...
        }, isValid: G2, isBlock: X2, isInline: Q2, isWrapper: (e3) => Ee(K2(), e3) || Q2(e3), getCustomElements: J2, addValidElements: S2, setValidElements: R2, addCustomElements: A2, addValidChildren: T2 };
      }, ma = (e2) => {
        ...
        "complete" === o2.readyState || "interactive" === o2.readyState && o2.body ? s2() : Sa(e2, "DOMContentLoaded", s2), n2.domLoaded || Sa(e2, "load", s2);
      };
      class Ta {
        constructor() {
        ...
        bind(e2, t2, n2, o2) {
          ...
          for (; c2--; ) {
            ...
            }), s2 = r2.events[l2][t3], s2 ? "ready" === t3 && r2.domLoaded ? n2(Ra({ type: t3 })) : s2.push({ func: n2, scope: o2 }) : (r2.events[l2][t3] = s2 = [{ func: n2, scope: o2 }], s2.fakeName = f2, s2.capture = m2, s2.nativeHandler = u2, "ready" === t3 ? Aa(e2, u2, r2) : Sa(e2, f2 || t3, u2, m2)));
          }
      ...
      const Oa = Pt.each, Ba = Pt.grep, Pa = "data-mce-style", Da = Pt.makeMap("fill-opacity font-weight line-height opacity orphans widows z-index zoom", " "), La = (e2, t2, n2) => {
        ...
        const a2 = Is.forElement(yn(e2), { contentCssCors: t2.contentCssCors, referrerPolicy: t2.referrerPolicy }), i2 = [], l2 = t2.schema ? t2.schema : ua({}), d2 = wa({ url_converter: t2.url_converter, url_converter_scope: t2.url_converter_scope, force_hex_color: t2.force_hex_color }, t2.schema), c2 = t2.ownEvents ? new Ta() : Ta.Event, u2 = l2.getBlockElements(), f2 = (t3) => t3 && e2 && m(t3) ? e2.getElementById(t3) : t3, g2 = (e3) => {
          ...
          let n3 = k2(t3, "width"), o3 = k2(t3, "height");
          ...
          const t3 = f2(e3), n3 = E2(t3), o3 = S2(t3);
          return { x: n3.x, y: n3.y, w: o3.w, h: o3.h };
        }, getSize: S2, getParent: (e3, t3, n3) => {
      ...
      const ui = (e2) => {
        ...
        return e2;
      }, Si = new RegExp("[̀-ͯ҃-҇҈-҉֑-ֽֿׁ-ׂׄ-ׇׅؐ-ًؚ-ٰٟۖ-ۜ۟-ۤۧ-۪ۨ-ܑۭܰ-݊ަ-ް߫-߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࣣ-ंऺ़ु-ै्॑-ॗॢ-ॣঁ়াু-ৄ্ৗৢ-ৣਁ-ਂ਼ੁ-ੂੇ-ੈੋ-੍ੑੰ-ੱੵઁ-ં઼ુ-ૅે-ૈ્ૢ-ૣଁ଼ାିୁ-ୄ୍ୖୗୢ-ୣஂாீ்ௗఀా-ీె-ైొ-్ౕ-ౖౢ-ౣಁ಼ಿೂೆೌ-್ೕ-ೖೢ-ೣഁാു-ൄ്ൗൢ-ൣ්ාි-ුූෟัิ-ฺ็-๎ັິ-ູົ-ຼ່-ໍ༘-ཱ༹༙༵༷-ཾྀ-྄྆-྇ྍ-ྗྙ-ྼ࿆ိ-ူဲ-့္-်ွ-ှၘ-ၙၞ-ၠၱ-ၴႂႅ-ႆႍႝ፝-፟ᜒ-᜔ᜲ-᜴ᝒ-ᝓᝲ-ᝳ឴-឵ិ-ួំ៉-៓៝᠋-᠍ᢩᤠ-ᤢᤧ-ᤨᤲ᤹-᤻ᨗ-ᨘᨛᩖᩘ-ᩞ᩠ᩢᩥ-ᩬᩳ-᩿᩼᪰-᪽᪾ᬀ-ᬃ᬴ᬶ-ᬺᬼᭂ᭫-᭳ᮀ-ᮁᮢ-ᮥᮨ-ᮩ᮫-ᮭ᯦ᯨ-ᯩᯭᯯ-ᯱᰬ-ᰳᰶ-᰷᳐-᳔᳒-᳢᳠-᳨᳭᳴᳸-᳹᷀-᷵᷼-᷿‌-‍⃐-⃜⃝-⃠⃡⃢-⃤⃥-⃰⳯-⵿⳱ⷠ-〪ⷿ-〭〮-゙〯-゚꙯꙰-꙲ꙴ-꙽ꚞ-ꚟ꛰-꛱ꠂ꠆ꠋꠥ-ꠦ꣄꣠-꣱ꤦ-꤭ꥇ-ꥑꦀ-ꦂ꦳ꦶ-ꦹꦼꧥꨩ-ꨮꨱ-ꨲꨵ-ꨶꩃꩌꩼꪰꪲ-ꪴꪷ-ꪸꪾ-꪿꫁ꫬ-ꫭ꫶ꯥꯨ꯭ﬞ︀-️︠-︯ﾞ-ﾟ]"), Ni = (e2) => m(e2) && e2.charCodeAt(0) >= 768 && Si.test(e2), Ri = qo, Ai = ts, Ti = Yo("display", "block table"), Oi = Yo("float", "left right"), Bi = /* @__PURE__ */ ((...e2) => (t2) => {
        for (let n2 = 0; n2 < e2.length; n2++) if (!e2[n2](t2)) return false;
        return true;
      })(Ri, Ai, O(Oi)), Pi = O(Yo("white-space", "pre pre-line pre-wrap")), Di = er, Li = ar, Mi = za.nodeIndex, Ii = (e2, t2) => t2 < 0 && qo(e2) && e2.hasChildNodes() ? void 0 : ki(e2, t2), Fi = (e2) => e2 ? e2.createRange() : za.DOM.createRng(), Ui = (e2) => m(e2) && /[\r\n\t ]/.test(e2), zi = (e2) => !!e2.setStart && !!e2.setEnd, ji = (e2) => {
        const t2 = e2.startContainer, n2 = e2.startOffset;
      ...
      const Wi = (e2, t2) => {
        ...
        if (qo(e2) && (e2 = ki(e2, t2), ol(e2))) return e2;
        if (Ur(e2)) {
      ...
      const bl = (e2) => "inline-command" === e2.type || "inline-format" === e2.type, vl = (e2) => "block-command" === e2.type || "block-format" === e2.type, yl = (e2) => {
      ...
      }, El = xt().deviceType, _l = El.isTouch(), kl = za.DOM, Sl = (e2) => u(e2, RegExp), Nl = (e2) => (t2) => t2.options.get(e2), Rl = (e2) => m(e2) || f(e2), Al = (e2, t2 = "") => (n2) => {
        const o2 = m(n2);
        if (o2) {
          if (-1 !== n2.indexOf("=")) {
            const r2 = ((e3) => {
      ...
      }, Sc = (e2, t2) => (Rc(e2), t2), Nc = (e2, t2) => Vi.isTextPosition(t2) ? ((e3, t3) => xc(e3) && t3.container() === e3 ? ((e4, t4) => {
        const n2 = _c(e4.data.substr(0, t4.offset())), o2 = _c(e4.data.substr(t4.offset()));
        return (n2.text + o2.text).length > 0 ? (kc(e4), Vi(e4, t4.offset() - n2.count)) : t4;
      })(e3, t3) : Sc(e3, t3))(e2, t2) : ((e3, t3) => t3.container() === e3.parentNode ? ((e4, t4) => {
        ...
        return Rc(e4), o2;
      })(e3, t3) : Sc(e3, t3))(e2, t2), Rc = (e2) => {
        wc(e2) && Ur(e2) && (zr(e2) ? e2.removeAttribute("data-mce-caret") : Ec(e2)), xc(e2) && (kc(e2), 0 === e2.data.length && Ec(e2));
      ...
      const uu = dr, mu = er, fu = qo, gu = ar, pu = ts, hu = (e2) => Jr(e2) || ((e3) => !!ns(e3) && !X(ce(e3.getElementsByTagName("*")), (e4, t2) => e4 || Kr(t2), false))(e2), bu = os, vu = (e2, t2) => e2.hasChildNodes() && t2 < e2.childNodes.length ? e2.childNodes[t2] : null, yu = (e2, t2) => {
      ...
      }, _u = (e2, t2) => !Vi.isTextPosition(e2) && !Vi.isTextPosition(t2) && e2.getNode() === t2.getNode(true), ku = (e2, t2, n2) => {
        const o2 = wu(t2);
        return I.from(e2 ? o2.next(n2) : o2.prev(n2));
      }, Su = (e2, t2, n2) => ku(e2, t2, n2).bind((o2) => Qc(n2, o2, t2) && ((e3, t3, n3) => {
        return e3 ? !_u(t3, n3) && (o3 = t3, !(!Vi.isTextPosition(o3) && ar(o3.getNode()))) && Eu(t3) && xu(n3) : !_u(n3, t3) && xu(t3) && Eu(n3);
        var o3;
      })(e2, n2, o2) ? ku(e2, t2, o2) : I.some(o2)), Nu = (e2, t2, n2, o2) => Su(e2, t2, n2).bind((n3) => o2(n3) ? Nu(e2, t2, n3, o2) : I.some(n3)), Ru = (e2, t2) => {
        ...
        var o2;
      }, Au = T(ku, true), Tu = T(ku, false), Ou = T(Ru, true), Bu = T(Ru, false), Pu = "_mce_caret", Du = (e2) => qo(e2) && e2.id === Pu, Lu = (e2, t2) => {
        let n2 = t2;
        for (; n2 && n2 !== e2; ) {
          if (Du(n2)) return n2;
          n2 = n2.parentNode;
      ...
      const Xu = (e2) => "" !== e2 && -1 !== " \f\n\r	\v".indexOf(e2), Qu = (e2) => !Xu(e2) && !Yu(e2) && !vr(e2), Ju = (e2) => {
        ...
        return C(o2) && $(o2, n2);
      }, km = (e2) => _e(e2, "block"), Sm = (e2) => _e(e2, "selector"), Nm = (e2) => _e(e2, "inline"), Rm = (e2) => Sm(e2) && false !== e2.expand && !Nm(e2), Am = (e2) => ((e3) => {
        const t2 = [];
        let n2 = e3;
        for (; n2; ) {
        ...
        for (let o3 = 0; o3 < a2.length; o3++) for (let r3 = 0; r3 < t2.length; r3++) {
          const s3 = t2[r3];
          if ((!C(s3.collapsed) || s3.collapsed === n2.collapsed) && Sm(s3) && e2.is(a2[o3], s3.selector)) return a2[o3];
        }
        return o2;
      }, jm = (e2, t2, n2, o2) => {
        var r2;
        ...
        if (km(i2) && (s2 = i2.wrapper ? null : e2.getParent(n2, i2.block, a2)), !s2) {
        ...
        if (s2 && km(i2) && i2.wrapper && (s2 = Bm(e2, s2, "ul,ol").reverse()[0] || s2), !s2) for (s2 = n2; s2 && s2[o2] && !e2.isBlock(s2[o2]) && (s2 = s2[o2], !ym(s2, "br")); ) ;
        return s2 || n2;
      }, Hm = (e2, t2, n2, o2) => {
        ...
        const l2 = n2[0];
        return qo(r2) && r2.hasChildNodes() && (r2 = ki(r2, s2), er(r2) && (s2 = 0)), qo(a2) && a2.hasChildNodes() && (a2 = ki(a2, t2.collapsed ? i2 : i2 - 1), er(a2) && (i2 = a2.data.length)), r2 = Lm(e2, r2), a2 = Lm(e2, a2), qm(r2) && (r2 = Om(r2) ? r2 : r2.parentNode, r2 = t2.collapsed ? r2.previousSibling || r2 : r2.nextSibling || r2, er(r2) && (s2 = t2.collapsed ? r2.length : 0)), qm(a2) && (a2 = Om(a2) ? a2 : a2.parentNode, a2 = t2.collapsed ? a2.nextSibling || a2 : a2.previousSibling || a2, er(a2) && (i2 = t2.collapsed ? 0 : a2.length)), t2.collapsed && (Um(e2, e2.getRoot(), r2, s2, true, o2).each(({ container: e3, offset: t3 }) => {
          r2 = e3, s2 = t3;
        }), Um(e2, e2.getRoot(), a2, i2, false, o2).each(({ container: e3, offset: t3 }) => {
          a2 = e3, i2 = t3;
        })), (Nm(l2) || l2.block_expand) && (Nm(l2) && er(r2) && 0 !== s2 || (r2 = $m(e2, n2, r2, s2, true)), Nm(l2) && er(a2) && i2 !== a2.data.length || (a2 = $m(e2, n2, a2, i2, false))), Rm(l2) && (r2 = zm(e2, n2, t2, r2, "previousSibling"), a2 = zm(e2, n2, t2, a2, "nextSibling")), (km(l2) || Sm(l2)) && (r2 = jm(e2, n2, r2, "previousSibling"), a2 = jm(e2, n2, a2, "nextSibling"), km(l2) && (e2.isBlock(r2) || (r2 = $m(e2, n2, r2, s2, true)), e2.isBlock(a2) || (a2 = $m(e2, n2, a2, i2, false)))), qo(r2) && r2.parentNode && (s2 = e2.nodeIndex(r2), r2 = r2.parentNode), qo(a2) && a2.parentNode && (i2 = e2.nodeIndex(a2) + 1, a2 = a2.parentNode), { startContainer: r2, startOffset: s2, endContainer: a2, endOffset: i2 };
      }, Wm = (e2, t2, n2) => {
        var o2;
        const r2 = t2.startOffset, s2 = ki(t2.startContainer, r2), a2 = t2.endOffset, i2 = ki(t2.endContainer, a2 - 1), l2 = (e3) => {
          const t3 = e3[0];
            ...
            ((e3, t4, n4, o4) => {
              e3.undoManager.transact(() => {
                ...
                if (s2.collapsed && !a2 && ((e4, t5) => {
                  ...
                  So(s3, br), r3.getRng().insertNode(s3.dom), r3.select(s3.dom);
                } else lm(r3, false, () => {
                  im(e3, (r4) => {
      ...
      const Zm = (e2, t2, n2) => !n2.collapsed && $(n2.getClientRects(), (n3) => ((e3, t3, n4) => t3 >= e3.left && t3 <= e3.right && n4 >= e3.top && n4 <= e3.bottom)(n3, e2, t2)), ef = (e2, t2, n2) => {
        ...
        const x2 = (e3) => C(e3) && (ir(e3) || n2.is(e3, "figure.image")), E2 = (e3) => mr(e3) || n2.hasClass(e3, "mce-preview-object"), _2 = (e3) => {
        ...
        }, k2 = (e3) => n2.hasClass(e3, "mce-preview-object") && C(e3.firstElementChild) ? [e3, e3.firstElementChild] : n2.is(e3, "figure.image") ? [e3.querySelector("img")] : [e3], S2 = (e3) => {
          const o3 = cd(t2);
          ...
          S2(e3) && !B3.isDefaultPrevented() ? ge(uf, (e4, t3) => {
        ...
        }), t2.on("remove", M2), { isResizable: S2, showResizeRect: O2, hideResizeRect: P2, updateResizeRect: L2, destroy: () => {
      ...
      const bf = (e2, t2, n2, o2) => ({ start: e2, soffset: t2, finish: n2, foffset: o2 }), vf = document.caretPositionFromPoint ? (e2, t2, n2) => {
        ...
        const t2 = xf.getWin(e2).dom, n2 = (e3, n3, o3, r2) => gf(t2, e3, n3, o3, r2), o2 = ((e3) => e3.match({ domRange: (e4) => {
          ...
          return kf(t3, e4.startOffset, n3, e4.endOffset);
        }, relative: _f, exact: kf }))(e2);
        return ((e3, t3) => {
      ...
      }, cg = (e2) => xf.range(e2.start, dg(e2.soffset, e2.start), e2.finish, dg(e2.foffset, e2.finish)), ug = (e2, t2) => !$o(t2.dom) && (kn(e2, t2) || _n(e2, t2)), mg = (e2) => (t2) => ug(e2, t2.start) && ug(e2, t2.finish), fg = (e2) => xf.range(yn(e2.startContainer), e2.startOffset, yn(e2.endContainer), e2.endOffset), gg = (e2) => {
      ...
      const Cg = za.DOM, wg = (e2) => {
        ...
        ((e3, t3) => ((e4) => e4.collapsed ? I.from(ki(e4.startContainer, e4.startOffset)).map(yn) : I.none())(t3).bind((t4) => Nr(t4) ? I.some(t4) : kn(e3, t4) ? I.none() : I.some(e3)))(yn(e2.getBody()), t2).bind((e3) => Ou(e3.dom)).fold(() => {
      ...
      const Kg = Pt.makeMap("NOSCRIPT STYLE SCRIPT XMP IFRAME NOEMBED NOFRAMES PLAINTEXT", " "), Yg = (e2) => m(e2.nodeValue) && e2.nodeValue.includes(Br), Gg = (e2) => (0 === e2.length ? "" : `${q(e2, (e3) => `[${e3}]`).join(",")},`) + '[data-mce-bogus="all"]', Xg = (e2) => document.createTreeWalker(e2, NodeFilter.SHOW_COMMENT, (e3) => Yg(e3) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP), Qg = (e2) => document.createTreeWalker(e2, NodeFilter.SHOW_TEXT, (e3) => {
      ...
      }, op = k(np, Xg), rp = k(np, Qg), sp = (e2, t2) => {
        ...
        return o2 = "raw" === t2.format ? Pt.trim(Dr(sp(n2, e2.serializer.getTempAttrs()).innerHTML)) : "text" === t2.format ? ((e3, t3) => {
          ...
          Jt(r2, "data-mce-bogus", "all"), lo(r2, { position: "fixed", left: "-9999999px", top: "0" }), So(r2, t3.innerHTML), ap(r2), ip(r2);
      ...
      const fp = ["font", "text-decoration", "text-emphasis"], gp = (e2, t2) => me(e2.parseStyle(e2.getAttrib(t2, "style"))), pp = (e2, t2, n2) => {
      ...
      }, Cp = (e2, t2) => (n2) => Jc(e2 ? 0 : -1, n2).filter(t2).isSome(), wp = (e2) => ir(e2) && "block" === co(yn(e2), "display"), xp = (e2) => dr(e2) && !((e3) => qo(e3) && "all" === e3.getAttribute("data-mce-bogus"))(e2), Ep = Cp(true, wp), _p = Cp(false, wp), kp = Cp(true, mr), Sp = Cp(false, mr), Np = Cp(true, Qo), Rp = Cp(false, Qo), Ap = Cp(true, xp), Tp = Cp(false, xp), Op = (e2, t2) => ((e3, t3, n2) => kn(t3, e3) ? On(e3, (e4) => n2(e4) || _n(e4, t3)).slice(0, -1) : [])(e2, t2, L), Bp = (e2, t2) => [e2].concat(Op(e2, t2)), Pp = (e2, t2, n2) => Nu(e2, t2, n2, yp), Dp = (e2, t2, n2) => J(Bp(yn(t2.container()), e2), /* @__PURE__ */ ((e3) => (t3) => e3.isBlock(Ht(t3)))(n2)), Lp = (e2, t2, n2, o2) => Pp(e2, t2.dom, n2).forall((e3) => Dp(t2, n2, o2).fold(() => !Qc(e3, n2, t2.dom), (o3) => !Qc(e3, n2, t2.dom) && kn(o3, yn(e3.container())))), Mp = (e2, t2, n2, o2) => Dp(t2, n2, o2).fold(() => Pp(e2, t2.dom, n2).forall((e3) => !Qc(e3, n2, t2.dom)), (t3) => Pp(e2, t3.dom, n2).isNone()), Ip = T(Mp, false), Fp = T(Mp, true), Up = T(Lp, false), zp = T(Lp, true), jp = (e2) => iu(e2).exists(Er), Hp = (e2, t2, n2, o2) => {
        const r2 = Y(Bp(yn(n2.container()), t2), (e3) => o2.isBlock(Ht(e3))), s2 = le(r2).getOr(t2);
        return ku(e2, s2.dom, n2).filter(jp);
      ...
      }, _h = T(Eh, true), kh = T(Eh, false), Sh = (e2, t2) => {
      ...
      }, Nh = (e2) => Sh(e2, "Delete"), Rh = (e2) => _r(e2) || Sr(e2), Ah = (e2, t2) => kn(e2, t2) ? Jn(t2, Rh, /* @__PURE__ */ ((e3) => (t3) => Dt(An(t3), e3, _n))(e2)) : I.none(), Th = (e2, t2 = true) => {
        ...
        return ob(o2, n2).fold(() => ((e3, t3, n3, o3) => {
          ...
          return nb(n3, o3).bind((o4) => gs(o4) ? rb(e3, o4) : ((e4, t4, n4, o5, r3) => Su(n4, e4.getBody(), r3).bind((e5) => nb(t4, yn(e5.getNode())).bind((e6) => _n(e6, o5) ? I.none() : I.some(_))))(e3, n3, t3, o4, r2));
        })(e2, t2, o2, n2).orThunk(() => It(((e3, t3) => {
          const n3 = Vi.fromRangeStart(e3.selection.getRng());
          return sb(t3, n3) || ku(t3, e3.getBody(), n3).exists((e4) => sb(t3, e4));
        })(e2, t2), _)), (n3) => ((e3, t3, n4, o3) => {
          const r2 = Vi.fromRangeStart(e3.selection.getRng());
          return gs(o3) ? rb(e3, o3) : ((e4, t4, n5, o4, r3) => Su(n5, e4.getBody(), r3).fold(() => I.some(_), (s2) => ((e5, t5, n6, o5) => Ou(e5.dom).bind((r4) => Bu(e5.dom).map((e6) => t5 ? n6.isEqual(r4) && o5.isEqual(e6) : n6.isEqual(e6) && o5.isEqual(r4))).getOr(true))(o4, n5, r3, s2) ? ((e5, t5) => rb(e5, t5))(e4, o4) : ((e5, t5, n6) => ob(e5, yn(n6.getNode())).fold(() => I.some(_), (e6) => It(!_n(e6, t5), _)))(t4, o4, s2)))(e3, n4, t3, o3, r2);
        })(e2, t2, o2, n3));
      }, ib = (e2, t2) => {
        ...
        return ku(false, o2, n2).map((r2) => !Qc(t2, n2, o2) && Qc(t2, r2, o2) ? ((e4, t3, n3, o3) => {
        ...
        })(t2, e2, o2), s2 = Sb(t2, n2.startContainer), a2 = kb((i2 = r2.firstChild, Y(null !== (l2 = null == i2 ? void 0 : i2.childNodes) && void 0 !== l2 ? l2 : [], (e3) => "LI" === e3.nodeName)));
        var i2, l2;
        ...
        if (true === n2.paste && _b(e2.schema, h2) && ((e3, t3) => !!Sb(e3, t3))(a2, g2)) return u2 = Rb(d2, a2, s2.getRng(), h2), u2 && s2.setRng(u2), t2;
        ...
        return ((e3, t3) => {
          ...
          ie(o3, o3.length - 2).filter(Wt).fold(() => ks(e3, t3), (t4) => ks(e3, t4.dom));
        ...
        if (o2) for (let n3 = 0; n3 < o2.length; n3++) {
          const r2 = o2[n3];
          if (Sm(r2) && false === r2.inherit && e2.dom.is(t2, r2.selector)) return true;
        }
        return false;
      }, Fb = (e2, t2, n2, o2, r2) => {
      ...
      }, Ub = (e2, t2, n2) => !(!Nm(n2) || !Mb(t2, n2.inline)) || !(!km(n2) || !Mb(t2, n2.block)) || !!Sm(n2) && qo(t2) && e2.is(t2, n2.selector), zb = (e2, t2, n2, o2, r2, s2) => {
      ...
      const nv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"], ov = (e2, t2) => {
        ...
        km(n2) && o2 === s2.getRoot() && (n2.list_block && yv(t2, n2.list_block) || V(ce(t2.childNodes), (t3) => {
          pm(e2, a2, t3.nodeName.toLowerCase()) ? r2 ? r2.appendChild(t3) : (r2 = Ev(s2, t3, a2), s2.setAttribs(r2, Fl(e2))) : r2 = null;
        })), ((e3) => Sm(e3) && Nm(e3) && Dt(xe(e3, "mixed"), true))(n2) && !yv(n2.inline, t2) || s2.remove(t2, true);
      }, Sv = (e2, t2, n2) => x(e2) ? { name: t2, value: null } : { name: e2, value: vm(t2, n2) }, Nv = (e2, t2) => {
        "" === e2.getAttrib(t2, "style") && (t2.removeAttribute("style"), t2.removeAttribute("data-mce-style"));
      }, Rv = (e2, t2, n2, o2, r2) => {
        let s2 = false;
        vv(n2.styles, (a2, i2) => {
          const { name: l2, value: d2 } = Sv(i2, a2, o2), c2 = Cm(d2, l2);
          (n2.remove_similar || h(d2) || !qo(r2) || yv(wm(e2, r2, l2), c2)) && e2.setStyle(t2, l2, ""), s2 = true;
        }), s2 && Nv(e2, t2);
      }, Av = (e2, t2, n2, o2, r2) => {
        const s2 = e2.dom, a2 = ub(e2), i2 = e2.schema;
        if (Nm(t2) && Rs(i2, t2.inline) && Ts(i2, o2) && o2.parentElement === e2.getBody()) return kv(e2, o2, t2), hv.removed();
        ...
        if ("all" !== t2.remove) {
          Rv(s2, l2, t2, n2, r2), vv(t2.attributes, (e4, o3) => {
            const { name: a3, value: i3 } = Sv(o3, e4, n2);
        ...
        return "none" !== t2.remove ? (kv(e2, l2, t2), hv.removed()) : hv.keep();
        ...
        const r2 = e2.formatter.get(t2), s2 = r2[0], a2 = !o2 && e2.selection.isCollapsed(), i2 = e2.dom, l2 = e2.selection, d2 = (e3, t3 = s2) => {
          ...
          let n3 = false;
          return Dv(e3, (e4) => !(!Sm(e4) || ("false" !== i2.getContentEditable(t3) || e4.ceFalseOverride) && (!C(e4.collapsed) || e4.collapsed === a2) && i2.is(t3, e4.selector) && !Du(t3) && (d2(t3, e4), n3 = true, 1))), n3;
        }, u2 = (e3) => {
          if (m(e3)) {
          ...
          Wm(o3, a3, (a4) => {
            ...
            const p2 = (a5) => {
              ...
              if (ar(a5) && !((e3, t3, n3, o4) => {
                ...
                return false;
              })(e2, s2, a5, w2)) return u3 = null, void (km(s2) && o3.remove(a5));
              if (((o4) => ((e3) => km(e3) && true === e3.wrapper)(s2) && jb(e2, o4, t2, n2))(a5)) u3 = null;
              else {
                if (((t3, n3, o4) => {
                  const r3 = ((e3) => km(e3) && true !== e3.wrapper)(s2) && gm(e2.schema, t3) && pm(e2, n3, f3);
                  return o4 && r3;
                })(a5, w2, E2)) {
            ...
            !(l3.length > 1) && o3.isBlock(a4) || 0 !== i4 ? (Nm(s2) || km(s2) && s2.wrapper) && (s2.exact || 1 !== i4 || (a4 = ((e3) => {
      ...
      const my = _y(Array.prototype.forEach), fy = _y(Array.prototype.pop), gy = _y(Array.prototype.push), py = _y(String.prototype.toLowerCase), hy = _y(String.prototype.toString), by = _y(String.prototype.match), vy = _y(String.prototype.replace), yy = _y(String.prototype.indexOf), Cy = _y(String.prototype.trim), wy = _y(RegExp.prototype.test), xy = (Ey = TypeError, function() {
      ...
      function ky(e2, t2, n2) {
        var o2;
        n2 = null !== (o2 = n2) && void 0 !== o2 ? o2 : py, oy && oy(e2, null);
        let r2 = t2.length;
        for (; r2--; ) {
          let o3 = t2[r2];
          if ("string" == typeof o3) {
            const e3 = n2(o3);
            e3 !== o3 && (ry(t2) || (t2[r2] = e3), o3 = e3);
          }
          e2[o3] = true;
        }
        return e2;
      ...
      function Sy(e2) {
        const t2 = dy(null);
        for (const [n2, o2] of ny(e2)) t2[n2] = o2;
        return t2;
      }
      function Ny(e2, t2) {
        for (; null !== e2; ) {
          const n2 = ay(e2, t2);
          if (n2) {
            if (n2.get) return _y(n2.get);
            if ("function" == typeof n2.value) return _y(n2.value);
          }
          e2 = sy(e2);
        }
        return function(e3) {
      ...
      const Ry = iy(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]), Ay = iy(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]), Ty = iy(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]), Oy = iy(["animate", "color-profile", "cursor", "discard", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"]), By = iy(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover", "mprescripts"]), Py = iy(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]), Dy = iy(["#text"]), Ly = iy(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "pattern", "placeholder", "playsinline", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "xmlns", "slot"]), My = iy(["accent-height", "accumulate", "additive", "alignment-baseline", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dur", "edgemode", "elevation", "end", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]), Iy = iy(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]), Fy = iy(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]), Uy = ly(/\{\{[\w\W]*|[\w\W]*\}\}/gm), zy = ly(/<%[\w\W]*|[\w\W]*%>/gm), jy = ly(/\${[\w\W]*}/gm), Hy = ly(/^data-[\-\w.\u00B7-\uFFFF]/), $y = ly(/^aria-[\-\w]+$/), qy = ly(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), Vy = ly(/^(?:\w+script|data):/i), Wy = ly(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), Ky = ly(/^html$/i);
      var Yy = Object.freeze({ __proto__: null, MUSTACHE_EXPR: Uy, ERB_EXPR: zy, TMPLIT_EXPR: jy, DATA_ATTR: Hy, ARIA_ATTR: $y, IS_ALLOWED_URI: qy, IS_SCRIPT_OR_DATA: Vy, ATTR_WHITESPACE: Wy, DOCTYPE_NAME: Ky });
      const Gy = () => "undefined" == typeof window ? null : window;
      var Xy = function e2() {
        let t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Gy();
        const n2 = (t3) => e2(t3);
        if (n2.version = "3.0.5", n2.removed = [], !t2 || !t2.document || 9 !== t2.document.nodeType) return n2.isSupported = false, n2;
        const o2 = t2.document, r2 = o2.currentScript;
        let { document: s2 } = t2;
        const { DocumentFragment: a2, HTMLTemplateElement: i2, Node: l2, Element: d2, NodeFilter: c2, NamedNodeMap: u2 = t2.NamedNodeMap || t2.MozNamedAttrMap, HTMLFormElement: m2, DOMParser: f2, trustedTypes: g2 } = t2, p2 = d2.prototype, h2 = Ny(p2, "cloneNode"), b2 = Ny(p2, "nextSibling"), v2 = Ny(p2, "childNodes"), y2 = Ny(p2, "parentNode");
        if ("function" == typeof i2) {
          const e3 = s2.createElement("template");
          e3.content && e3.content.ownerDocument && (s2 = e3.content.ownerDocument);
        }
        let C2, w2 = "";
        const { implementation: x2, createNodeIterator: E2, createDocumentFragment: _2, getElementsByTagName: k2 } = s2, { importNode: S2 } = o2;
        let N2 = {};
        n2.isSupported = "function" == typeof ny && "function" == typeof y2 && x2 && void 0 !== x2.createHTMLDocument;
        const { MUSTACHE_EXPR: R2, ERB_EXPR: A2, TMPLIT_EXPR: T2, DATA_ATTR: O2, ARIA_ATTR: B2, IS_SCRIPT_OR_DATA: P2, ATTR_WHITESPACE: D2 } = Yy;
        let { IS_ALLOWED_URI: L2 } = Yy, M2 = null;
        const I2 = ky({}, [...Ry, ...Ay, ...Ty, ...By, ...Dy]);
        let F2 = null;
        const U2 = ky({}, [...Ly, ...My, ...Iy, ...Fy]);
        let z2 = Object.seal(Object.create(null, { tagNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, allowCustomizedBuiltInElements: { writable: true, configurable: false, enumerable: true, value: false } })), j2 = null, H2 = null, $2 = true, q2 = true, V2 = false, W2 = true, K2 = false, Y2 = false, G2 = false, X2 = false, Q2 = false, J2 = false, Z2 = false, ee2 = true, te2 = false, ne2 = true, oe2 = false, re2 = {}, se2 = null;
        const ae2 = ky({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
        let ie2 = null;
        const le2 = ky({}, ["audio", "video", "img", "source", "image", "track"]);
        let de2 = null;
        const ce2 = ky({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), ue2 = "http://www.w3.org/1998/Math/MathML", me2 = "http://www.w3.org/2000/svg", fe2 = "http://www.w3.org/1999/xhtml";
        let ge2 = fe2, pe2 = false, he2 = null;
        const be2 = ky({}, [ue2, me2, fe2], hy);
        let ve2;
        const ye2 = ["application/xhtml+xml", "text/html"];
        let Ce2, we2 = null;
        const xe2 = s2.createElement("form"), Ee2 = function(e3) {
          return e3 instanceof RegExp || e3 instanceof Function;
        }, _e2 = function(e3) {
          if (!we2 || we2 !== e3) {
            if (e3 && "object" == typeof e3 || (e3 = {}), e3 = Sy(e3), ve2 = ve2 = -1 === ye2.indexOf(e3.PARSER_MEDIA_TYPE) ? "text/html" : e3.PARSER_MEDIA_TYPE, Ce2 = "application/xhtml+xml" === ve2 ? hy : py, M2 = "ALLOWED_TAGS" in e3 ? ky({}, e3.ALLOWED_TAGS, Ce2) : I2, F2 = "ALLOWED_ATTR" in e3 ? ky({}, e3.ALLOWED_ATTR, Ce2) : U2, he2 = "ALLOWED_NAMESPACES" in e3 ? ky({}, e3.ALLOWED_NAMESPACES, hy) : be2, de2 = "ADD_URI_SAFE_ATTR" in e3 ? ky(Sy(ce2), e3.ADD_URI_SAFE_ATTR, Ce2) : ce2, ie2 = "ADD_DATA_URI_TAGS" in e3 ? ky(Sy(le2), e3.ADD_DATA_URI_TAGS, Ce2) : le2, se2 = "FORBID_CONTENTS" in e3 ? ky({}, e3.FORBID_CONTENTS, Ce2) : ae2, j2 = "FORBID_TAGS" in e3 ? ky({}, e3.FORBID_TAGS, Ce2) : {}, H2 = "FORBID_ATTR" in e3 ? ky({}, e3.FORBID_ATTR, Ce2) : {}, re2 = "USE_PROFILES" in e3 && e3.USE_PROFILES, $2 = false !== e3.ALLOW_ARIA_ATTR, q2 = false !== e3.ALLOW_DATA_ATTR, V2 = e3.ALLOW_UNKNOWN_PROTOCOLS || false, W2 = false !== e3.ALLOW_SELF_CLOSE_IN_ATTR, K2 = e3.SAFE_FOR_TEMPLATES || false, Y2 = e3.WHOLE_DOCUMENT || false, Q2 = e3.RETURN_DOM || false, J2 = e3.RETURN_DOM_FRAGMENT || false, Z2 = e3.RETURN_TRUSTED_TYPE || false, X2 = e3.FORCE_BODY || false, ee2 = false !== e3.SANITIZE_DOM, te2 = e3.SANITIZE_NAMED_PROPS || false, ne2 = false !== e3.KEEP_CONTENT, oe2 = e3.IN_PLACE || false, L2 = e3.ALLOWED_URI_REGEXP || qy, ge2 = e3.NAMESPACE || fe2, z2 = e3.CUSTOM_ELEMENT_HANDLING || {}, e3.CUSTOM_ELEMENT_HANDLING && Ee2(e3.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (z2.tagNameCheck = e3.CUSTOM_ELEMENT_HANDLING.tagNameCheck), e3.CUSTOM_ELEMENT_HANDLING && Ee2(e3.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (z2.attributeNameCheck = e3.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), e3.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof e3.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (z2.allowCustomizedBuiltInElements = e3.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), K2 && (q2 = false), J2 && (Q2 = true), re2 && (M2 = ky({}, [...Dy]), F2 = [], true === re2.html && (ky(M2, Ry), ky(F2, Ly)), true === re2.svg && (ky(M2, Ay), ky(F2, My), ky(F2, Fy)), true === re2.svgFilters && (ky(M2, Ty), ky(F2, My), ky(F2, Fy)), true === re2.mathMl && (ky(M2, By), ky(F2, Iy), ky(F2, Fy))), e3.ADD_TAGS && (M2 === I2 && (M2 = Sy(M2)), ky(M2, e3.ADD_TAGS, Ce2)), e3.ADD_ATTR && (F2 === U2 && (F2 = Sy(F2)), ky(F2, e3.ADD_ATTR, Ce2)), e3.ADD_URI_SAFE_ATTR && ky(de2, e3.ADD_URI_SAFE_ATTR, Ce2), e3.FORBID_CONTENTS && (se2 === ae2 && (se2 = Sy(se2)), ky(se2, e3.FORBID_CONTENTS, Ce2)), ne2 && (M2["#text"] = true), Y2 && ky(M2, ["html", "head", "body"]), M2.table && (ky(M2, ["tbody"]), delete j2.tbody), e3.TRUSTED_TYPES_POLICY) {
              if ("function" != typeof e3.TRUSTED_TYPES_POLICY.createHTML) throw xy('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');
              if ("function" != typeof e3.TRUSTED_TYPES_POLICY.createScriptURL) throw xy('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
              C2 = e3.TRUSTED_TYPES_POLICY, w2 = C2.createHTML("");
            } else void 0 === C2 && (C2 = function(e4, t3) {
            ...
            }(g2, r2)), null !== C2 && "string" == typeof w2 && (w2 = C2.createHTML(""));
            iy && iy(e3), we2 = e3;
          }
        }, ke2 = ky({}, ["mi", "mo", "mn", "ms", "mtext"]), Se2 = ky({}, ["foreignobject", "desc", "title", "annotation-xml"]), Ne2 = ky({}, ["title", "style", "font", "a", "script"]), Re2 = ky({}, Ay);
        ky(Re2, Ty), ky(Re2, Oy);
        const Ae2 = ky({}, By);
        ky(Ae2, Py);
        const Te2 = function(e3) {
          ...
          if (t3.removeAttribute(e3), "is" === e3 && !F2[e3]) if (Q2 || J2) try {
            Te2(t3);
          } catch (e4) {
          }
          else try {
          ...
          let t3, n3;
          if (X2) e3 = "<remove></remove>" + e3;
          else {
            const t4 = by(e3, /^[\r\n\t ]+/);
            n3 = t4 && t4[0];
          }
          "application/xhtml+xml" === ve2 && ge2 === fe2 && (e3 = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e3 + "</body></html>");
          const o3 = C2 ? C2.createHTML(e3) : e3;
          if (ge2 === fe2) try {
            t3 = new f2().parseFromString(o3, ve2);
          } catch (e4) {
          }
          if (!t3 || !t3.documentElement) {
            t3 = x2.createDocument(ge2, "template", null);
            try {
              t3.documentElement.innerHTML = pe2 ? w2 : o3;
            } catch (e4) {
            }
          }
          const r3 = t3.body || t3.documentElement;
          return e3 && n3 && r3.insertBefore(s2.createTextNode(n3), r3.childNodes[0] || null), ge2 === fe2 ? k2.call(t3, Y2 ? "html" : "body")[0] : Y2 ? t3.documentElement : r3;
        }, Pe2 = function(e3) {
          return E2.call(e3.ownerDocument || e3, e3, c2.SHOW_ELEMENT | c2.SHOW_COMMENT | c2.SHOW_TEXT, null, false);
        }, De2 = function(e3) {
          return "object" == typeof l2 ? e3 instanceof l2 : e3 && "object" == typeof e3 && "number" == typeof e3.nodeType && "string" == typeof e3.nodeName;
        }, Le2 = function(e3, t3, o3) {
          N2[e3] && my(N2[e3], (e4) => {
            e4.call(n2, t3, o3, we2);
          });
        }, Me2 = function(e3) {
          let t3;
          if (Le2("beforeSanitizeElements", e3, null), (o3 = e3) instanceof m2 && ("string" != typeof o3.nodeName || "string" != typeof o3.textContent || "function" != typeof o3.removeChild || !(o3.attributes instanceof u2) || "function" != typeof o3.removeAttribute || "function" != typeof o3.setAttribute || "string" != typeof o3.namespaceURI || "function" != typeof o3.insertBefore || "function" != typeof o3.hasChildNodes)) return Te2(e3), true;
          var o3;
          const r3 = Ce2(e3.nodeName);
          if (Le2("uponSanitizeElement", e3, { tagName: r3, allowedTags: M2 }), e3.hasChildNodes() && !De2(e3.firstElementChild) && (!De2(e3.content) || !De2(e3.content.firstElementChild)) && wy(/<[/\w]/g, e3.innerHTML) && wy(/<[/\w]/g, e3.textContent)) return Te2(e3), true;
          if (!M2[r3] || j2[r3]) {
            if (!j2[r3] && Fe2(r3)) {
              if (z2.tagNameCheck instanceof RegExp && wy(z2.tagNameCheck, r3)) return false;
              if (z2.tagNameCheck instanceof Function && z2.tagNameCheck(r3)) return false;
            }
            if (ne2 && !se2[r3]) {
              const t4 = y2(e3) || e3.parentNode, n3 = v2(e3) || e3.childNodes;
              if (n3 && t4) for (let o4 = n3.length - 1; o4 >= 0; --o4) t4.insertBefore(h2(n3[o4], true), b2(e3));
            }
            return Te2(e3), true;
          }
          return e3 instanceof d2 && !function(e4) {
            let t4 = y2(e4);
            t4 && t4.tagName || (t4 = { namespaceURI: ge2, tagName: "template" });
            const n3 = py(e4.tagName), o4 = py(t4.tagName);
            return !!he2[e4.namespaceURI] && (e4.namespaceURI === me2 ? t4.namespaceURI === fe2 ? "svg" === n3 : t4.namespaceURI === ue2 ? "svg" === n3 && ("annotation-xml" === o4 || ke2[o4]) : Boolean(Re2[n3]) : e4.namespaceURI === ue2 ? t4.namespaceURI === fe2 ? "math" === n3 : t4.namespaceURI === me2 ? "math" === n3 && Se2[o4] : Boolean(Ae2[n3]) : e4.namespaceURI === fe2 ? !(t4.namespaceURI === me2 && !Se2[o4]) && !(t4.namespaceURI === ue2 && !ke2[o4]) && !Ae2[n3] && (Ne2[n3] || !Re2[n3]) : !("application/xhtml+xml" !== ve2 || !he2[e4.namespaceURI]));
          }(e3) ? (Te2(e3), true) : "noscript" !== r3 && "noembed" !== r3 && "noframes" !== r3 || !wy(/<\/no(script|embed|frames)/i, e3.innerHTML) ? (K2 && 3 === e3.nodeType && (t3 = e3.textContent, t3 = vy(t3, R2, " "), t3 = vy(t3, A2, " "), t3 = vy(t3, T2, " "), e3.textContent !== t3 && (gy(n2.removed, { element: e3.cloneNode() }), e3.textContent = t3)), Le2("afterSanitizeElements", e3, null), false) : (Te2(e3), true);
        }, Ie2 = function(e3, t3, n3) {
          if (ee2 && ("id" === t3 || "name" === t3) && (n3 in s2 || n3 in xe2)) return false;
          if (q2 && !H2[t3] && wy(O2, t3)) ;
          else if ($2 && wy(B2, t3)) ;
          else if (!F2[t3] || H2[t3]) {
            if (!(Fe2(e3) && (z2.tagNameCheck instanceof RegExp && wy(z2.tagNameCheck, e3) || z2.tagNameCheck instanceof Function && z2.tagNameCheck(e3)) && (z2.attributeNameCheck instanceof RegExp && wy(z2.attributeNameCheck, t3) || z2.attributeNameCheck instanceof Function && z2.attributeNameCheck(t3)) || "is" === t3 && z2.allowCustomizedBuiltInElements && (z2.tagNameCheck instanceof RegExp && wy(z2.tagNameCheck, n3) || z2.tagNameCheck instanceof Function && z2.tagNameCheck(n3)))) return false;
          } else if (de2[t3]) ;
          else if (wy(L2, vy(n3, D2, ""))) ;
          else if ("src" !== t3 && "xlink:href" !== t3 && "href" !== t3 || "script" === e3 || 0 !== yy(n3, "data:") || !ie2[e3]) {
            if (V2 && !wy(P2, vy(n3, D2, ""))) ;
          ...
          let t3, n3, o3, r3;
          Le2("beforeSanitizeAttributes", e3, null);
          const { attributes: s3 } = e3;
          if (!s3) return;
          const a3 = { attrName: "", attrValue: "", keepAttr: true, allowedAttributes: F2 };
          for (r3 = s3.length; r3--; ) {
            t3 = s3[r3];
            const { name: i3, namespaceURI: l3 } = t3;
            n3 = "value" === i3 ? t3.value : Cy(t3.value);
            const d3 = n3;
            if (o3 = Ce2(i3), a3.attrName = o3, a3.attrValue = n3, a3.keepAttr = true, a3.forceKeepAttr = void 0, Le2("uponSanitizeAttribute", e3, a3), n3 = a3.attrValue, a3.forceKeepAttr) continue;
            if (!a3.keepAttr) {
              Oe2(i3, e3);
              continue;
            }
            ...
            K2 && (n3 = vy(n3, R2, " "), n3 = vy(n3, A2, " "), n3 = vy(n3, T2, " "));
            const c3 = Ce2(e3.nodeName);
            if (Ie2(c3, o3, n3)) {
              if (!te2 || "id" !== o3 && "name" !== o3 || (Oe2(i3, e3), n3 = "user-content-" + n3), C2 && "object" == typeof g2 && "function" == typeof g2.getAttributeType) if (l3) ;
              else switch (g2.getAttributeType(c3, o3)) {
                case "TrustedHTML":
                  n3 = C2.createHTML(n3);
                  break;
                case "TrustedScriptURL":
                  n3 = C2.createScriptURL(n3);
              }
              if (n3 !== d3) try {
                l3 ? e3.setAttributeNS(l3, i3, n3) : e3.setAttribute(i3, n3);
              } catch (t4) {
                Oe2(i3, e3);
              }
            } else Oe2(i3, e3);
          }
          Le2("afterSanitizeAttributes", e3, null);
        }, ze2 = function e3(t3) {
          let n3;
          const o3 = Pe2(t3);
          for (Le2("beforeSanitizeShadowDOM", t3, null); n3 = o3.nextNode(); ) Le2("uponSanitizeShadowNode", n3, null), Me2(n3) || (n3.content instanceof a2 && e3(n3.content), Ue2(n3));
          Le2("afterSanitizeShadowDOM", t3, null);
        };
        return n2.sanitize = function(e3) {
          let t3, r3, s3, i3, d3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          if (pe2 = !e3, pe2 && (e3 = "<!-->"), "string" != typeof e3 && !De2(e3)) {
            if ("function" != typeof e3.toString) throw xy("toString is not a function");
            if ("string" != typeof (e3 = e3.toString())) throw xy("dirty is not a string, aborting");
          }
          if (!n2.isSupported) return e3;
          if (G2 || _e2(d3), n2.removed = [], "string" == typeof e3 && (oe2 = false), oe2) {
            if (e3.nodeName) {
              const t4 = Ce2(e3.nodeName);
              if (!M2[t4] || j2[t4]) throw xy("root node is forbidden and cannot be sanitized in-place");
            }
          } else if (e3 instanceof l2) t3 = Be2("<!---->"), r3 = t3.ownerDocument.importNode(e3, true), 1 === r3.nodeType && "BODY" === r3.nodeName || "HTML" === r3.nodeName ? t3 = r3 : t3.appendChild(r3);
          else {
            if (!Q2 && !K2 && !Y2 && -1 === e3.indexOf("<")) return C2 && Z2 ? C2.createHTML(e3) : e3;
            if (t3 = Be2(e3), !t3) return Q2 ? null : Z2 ? w2 : "";
          }
          t3 && X2 && Te2(t3.firstChild);
          const c3 = Pe2(oe2 ? e3 : t3);
          for (; s3 = c3.nextNode(); ) Me2(s3) || (s3.content instanceof a2 && ze2(s3.content), Ue2(s3));
          if (oe2) return e3;
          if (Q2) {
            if (J2) for (i3 = _2.call(t3.ownerDocument); t3.firstChild; ) i3.appendChild(t3.firstChild);
            else i3 = t3;
            return (F2.shadowroot || F2.shadowrootmode) && (i3 = S2.call(o2, i3, true)), i3;
          }
          let u3 = Y2 ? t3.outerHTML : t3.innerHTML;
          return Y2 && M2["!doctype"] && t3.ownerDocument && t3.ownerDocument.doctype && t3.ownerDocument.doctype.name && wy(Ky, t3.ownerDocument.doctype.name) && (u3 = "<!DOCTYPE " + t3.ownerDocument.doctype.name + ">\n" + u3), K2 && (u3 = vy(u3, R2, " "), u3 = vy(u3, A2, " "), u3 = vy(u3, T2, " ")), C2 && Z2 ? C2.createHTML(u3) : u3;
        }, n2.setConfig = function(e3) {
          _e2(e3), G2 = true;
        }, n2.clearConfig = function() {
          we2 = null, G2 = false;
        }, n2.isValidAttribute = function(e3, t3, n3) {
          we2 || _e2({});
          const o3 = Ce2(e3), r3 = Ce2(t3);
          return Ie2(o3, r3, n3);
        }, n2.addHook = function(e3, t3) {
          "function" == typeof t3 && (N2[e3] = N2[e3] || [], gy(N2[e3], t3));
        }, n2.removeHook = function(e3) {
          if (N2[e3]) return fy(N2[e3]);
      ...
      const Qy = Pt.each, Jy = Pt.trim, Zy = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"], eC = { ftp: 21, http: 80, https: 443, mailto: 25 }, tC = ["img", "video"], nC = (e2, t2, n2) => {
        const o2 = ((e3) => {
          try {
        ...
        return !e2.allow_script_urls && (!!/((java|vb)script|mhtml):/i.test(o2) || !e2.allow_html_data_urls && (/^data:image\//i.test(o2) ? ((e3, t3) => C(e3) ? !e3 : !C(t3) || !H(tC, t3))(e2.allow_svg_data_urls, n2) && /^data:image\/svg\+xml/i.test(o2) : /^data:/i.test(o2)));
      };
      class oC {
        ...
        constructor(e2, t2 = {}) {
          this.path = "", this.directory = "", e2 = Jy(e2), this.settings = t2;
          ...
          if (0 !== e2.indexOf("/") || r2 || (e2 = (n2 && n2.protocol || "http") + "://mce_host" + e2), !/^[\w\-]*:?\/\//.test(e2)) {
            const t3 = n2 ? n2.path : new oC(document.location.href).directory;
        ...
        toRelative(e2) {
          if ("./" === e2) return e2;
          const t2 = new oC(e2, { base_uri: this });
      ...
      const iC = (e2, t2, n2, o2, r2) => {
        ...
        const f2 = yn(e2), g2 = nn(f2, sC), p2 = en(f2, "data-mce-bogus");
        ...
        if (!d2 || h2) {
          if (C(r2) && (r2.allowedTags[u2] = true), d2 && h2 && !g2) {
            if (V(null !== (i2 = h2.attributesForced) && void 0 !== i2 ? i2 : [], (e3) => {
              Jt(f2, e3.name, "{$uid}" === e3.value ? "mce_" + aC++ : e3.value);
            }), V(null !== (l2 = h2.attributesDefault) && void 0 !== l2 ? l2 : [], (e3) => {
              nn(f2, e3.name) || Jt(f2, e3.name, "{$uid}" === e3.value ? "mce_" + aC++ : e3.value);
      ...
      }, lC = (e2, t2, n2, o2, r2, s2) => "html" !== n2 && !ps(o2) || !(r2 in rC && nC(e2, s2, o2)) && (!e2.validate || t2.isValid(o2, r2) || He(r2, "data-") || He(r2, "aria-")), dC = (e2, t2) => e2.hasAttribute(sC) && ("id" === t2 || "class" === t2 || "style" === t2), cC = (e2, t2) => e2 in t2.getBoolAttrs(), uC = (e2, t2, n2, o2) => {
        const { attributes: r2 } = e2;
        for (let s2 = r2.length - 1; s2 >= 0; s2--) {
          const a2 = r2[s2], i2 = a2.name, l2 = a2.value;
          lC(t2, n2, o2, e2.tagName.toLowerCase(), i2, l2) || dC(e2, i2) ? cC(i2, n2) && e2.setAttribute(i2, i2) : e2.removeAttribute(i2);
        }
      }, mC = (e2, t2, n2) => {
        const o2 = Xy();
        return o2.addHook("uponSanitizeElement", (o3, r2) => {
          iC(o3, e2, t2, n2.track(o3), r2);
        }), o2.addHook("uponSanitizeAttribute", (o3, r2) => {
          ((e3, t3, n3, o4, r3) => {
            const s2 = e3.tagName.toLowerCase(), { attrName: a2, attrValue: i2 } = r3;
            r3.keepAttr = lC(t3, n3, o4, s2, a2, i2), r3.keepAttr ? (r3.allowedAttributes[a2] = true, cC(a2, n3) && (r3.attrValue = a2), t3.allow_svg_data_urls && He(i2, "data:image/svg+xml") && (r3.forceKeepAttr = true)) : dC(e3, a2) && (r3.forceKeepAttr = true);
        ...
        return Xy().sanitize(e2, n2), e2.innerHTML;
      }, gC = Pt.makeMap, pC = Pt.extend, hC = (e2, t2, n2, o2) => {
        ...
        for (let t3 = 0, r3 = a2.length; t3 < r3; t3++) {
          ...
          ps(i2.name) || hC(i2, r4, n2, o2), e2.append(i2);
        }
      }, bC = (e2 = {}, t2 = ua()) => {
        const n2 = qv(), o2 = qv(), r2 = { validate: true, root_name: "body", sanitize: true, ...e2 }, s2 = new DOMParser(), a2 = ((e3, t3) => {
          ...
          if (e3.sanitize) {
            const o3 = mC(e3, t3, n3), r3 = (t4, r4) => {
              o3.sanitize(t4, ((e4, t5) => {
                const n4 = { IN_PLACE: true, ALLOW_UNKNOWN_PROTOCOLS: true, ALLOWED_TAGS: ["#comment", "#cdata-section", "body"], ALLOWED_ATTR: [] };
            ...
            return { sanitizeHtmlElement: r3, sanitizeNamespaceElement: fC };
          }
          return { sanitizeHtmlElement: (o3, r3) => {
            ...
            for (; a3 = s3.nextNode(); ) {
              ...
              iC(a3, e3, t3, o4), qo(a3) && uC(a3, e3, t3, o4);
            }
            n3.reset();
          ...
          const o3 = m(n3.attr(sC)), r3 = 1 === n3.type && !Ee(e3, n3.name) && !Bs(t2, n3) && !ps(n3.name);
          ...
          hC(m2, c3, t2.getSpecialElements(), a2.sanitizeNamespaceElement), c3.innerHTML = "";
          const [f3, p3] = ((e4, t3, n4, o4) => {
            const r3 = n4.validate, s3 = t3.getNonEmptyElements(), a3 = t3.getWhitespaceElements(), i4 = pC(gC("script,style,head,html,body,title,meta,param"), t3.getBlockElements()), l3 = da(t3), d4 = /[ \t\r\n]+/g, c4 = /^[ \t\r\n]+/, u3 = /[ \t\r\n]+$/, m3 = (e5) => {
              let t4 = e5.parent;
              for (; C(t4); ) {
          ...
          return x2 && ("body" === m2.name || n3.isRootContent) && ((e4, n4) => {
            const o4 = pC(gC("script,style,head,html,body,title,meta,param"), t2.getBlockElements()), s3 = /^[ \t\r\n]+/, a3 = /[ \t\r\n]+$/;
        ...
        if (Bb(e2)) {
          if (r2.content !== o2) {
            const t3 = bC({ validate: false, forced_root_block: false, ...n2 }).parse(r2.content, { context: e2.name });
        ...
        {
          const o2 = vC(t2, (t3) => rf(e2, { ...n2, content: t3 }), { sanitize: fc(e2), sandbox_iframes: Cc(e2) });
          return o2.content;
        }
      }, wC = (e2, t2) => {
        if (t2.no_events) return pl.value(t2);
        {
          const n2 = vC(t2.content, (n3) => ((e3, t3) => e3.dispatch("BeforeSetContent", t3))(e2, { ...t2, content: n3 }), { sanitize: fc(e2), sandbox_iframes: Cc(e2) });
          return n2.isDefaultPrevented() ? (of(e2, n2), pl.error(void 0)) : pl.value(n2);
        }
      }, xC = (e2, t2, n2) => {
        n2.no_events || of(e2, { ...n2, content: t2 });
      }, EC = (e2, t2, n2) => ({ element: e2, width: t2, rows: n2 }), _C = (e2, t2) => ({ element: e2, cells: t2 }), kC = (e2, t2) => ({ x: e2, y: t2 }), SC = (e2, t2) => tn(e2, t2).bind(Xe).getOr(1), NC = (e2, t2, n2) => {
        const o2 = e2.rows;
        return !!(o2[n2] ? o2[n2].cells : [])[t2];
      }, RC = (e2) => X(e2, (e3, t2) => t2.cells.length > e3 ? t2.cells.length : e3, 0), AC = (e2, t2) => {
        const n2 = e2.rows;
        for (let e3 = 0; e3 < n2.length; e3++) {
          const o2 = n2[e3].cells;
          for (let n3 = 0; n3 < o2.length; n3++) if (_n(o2[n3], t2)) return I.some(kC(n3, e3));
        }
        return I.none();
      }, TC = (e2, t2, n2, o2, r2) => {
        const s2 = [], a2 = e2.rows;
        ...
        }).getOr([])))(r2, t2), i2 = s2.concat(a2.length ? a2 : ((e3) => Sr(e3) ? An(e3).filter(kr).fold(N([]), (t3) => [e3, t3]) : kr(e3) ? [e3] : [])(o2));
        return q(i2, fi);
      }, PC = () => Sf([]), DC = (e2, t2) => ((e3, t3) => eo(t3, "table", T(_n, e3)))(e2, t2[0]).bind((e3) => {
        const n2 = t2[0], o2 = t2[t2.length - 1], r2 = ((e4) => {
          const t3 = EC(fi(e4), 0, []);
          return V(Uo(e4, "tr"), (e5, n3) => {
            V(Uo(e5, "td,th"), (o3, r3) => {
              ((e6, t4, n4, o4, r4) => {
                const s2 = SC(r4, "rowspan"), a2 = SC(r4, "colspan"), i2 = e6.rows;
                for (let e7 = n4; e7 < n4 + s2; e7++) {
                  i2[e7] || (i2[e7] = _C(gi(o4), []));
          ...
          }), EC(t3.element, RC(t3.rows), t3.rows);
        })(e3);
        return ((e4, t3, n3) => AC(e4, t3).bind((t4) => AC(e4, n3).map((n4) => ((e5, t5, n5) => {
          const o3 = t5.x, r3 = t5.y, s2 = n5.x, a2 = n5.y, i2 = r3 < a2 ? TC(e5, o3, r3, s2, a2) : TC(e5, o3, a2, s2, r3);
          return EC(e5.element, RC(i2), i2);
        })(e4, t4, n4))))(r2, n2, o2).map((e4) => Sf([OC(e4)]));
      }).getOrThunk(PC), LC = (e2, t2, n2) => {
        const o2 = Zu(t2, e2);
        return o2.length > 0 ? DC(e2, o2) : ((e3, t3, n3) => t3.length > 0 && t3[0].collapsed ? PC() : ((e4, t4, n4) => ((e5, t5) => {
          const n5 = X(t5, (e6, t6) => (vo(t6, e6), t6), e5);
          return t5.length > 0 ? Sf([n5]) : n5;
        })(yn(t4.cloneContents()), BC(e4, t4, n4)))(e3, t3[0], n3))(e2, t2, n2);
      }, MC = (e2, t2) => t2 >= 0 && t2 < e2.length && Xu(e2.charAt(t2)), IC = (e2) => Dr(e2.innerText), FC = (e2) => qo(e2) ? e2.outerHTML : er(e2) ? ea.encodeRaw(e2.data, false) : or(e2) ? "<!--" + e2.data + "-->" : "", UC = (e2, t2) => (((e3, t3) => {
        let n2 = 0;
        V(e3, (e4) => {
      ...
      })(q(ce(t2.childNodes), FC), e2), t2), t2), zC = De(() => document.implementation.createHTMLDocument("undo")), jC = (e2) => {
        const t2 = e2.serializer.getTempAttrs(), n2 = sp(e2.getBody(), t2);
        return ((e3) => null !== e3.querySelector("iframe"))(n2) ? { type: "fragmented", fragments: Y(q(ce(n2.childNodes), k(Dr, FC)), (e3) => e3.length > 0), content: "", bookmark: null, beforeBookmark: null } : { type: "complete", fragments: null, content: Dr(n2.innerHTML), bookmark: null, beforeBookmark: null };
      }, HC = (e2, t2, n2) => {
        const o2 = n2 ? t2.beforeBookmark : t2.bookmark;
        "fragmented" === t2.type ? UC(t2.fragments, e2.getBody()) : e2.setContent(t2.content, { format: "raw", no_selection: !C(o2) || !Iu(o2) || !o2.isFakeCaret }), o2 && (e2.selection.moveToBookmark(o2), e2.selection.scrollIntoView());
      }, $C = (e2) => "fragmented" === e2.type ? e2.fragments.join("") : e2.content, qC = (e2) => {
        const t2 = bn("body", zC());
        return So(t2, $C(e2)), V(Uo(t2, "*[data-mce-bogus]"), Eo), ko(t2);
      }, VC = (e2, t2) => !(!e2 || !t2) && (!!((e3, t3) => $C(e3) === $C(t3))(e2, t2) || ((e3, t3) => qC(e3) === qC(t3))(e2, t2)), WC = (e2) => 0 === e2.get(), KC = (e2, t2, n2) => {
        WC(n2) && (e2.typing = t2);
      }, YC = (e2, t2) => {
        e2.typing && (KC(e2, false, t2), e2.add());
      }, GC = (e2) => ({ init: { bindEvents: _ }, undoManager: { beforeChange: (t2, n2) => ((e3, t3, n3) => {
        WC(t3) && n3.set(ml(e3.selection));
      })(e2, t2, n2), add: (t2, n2, o2, r2, s2, a2) => ((e3, t3, n3, o3, r3, s3, a3) => {
        const i2 = jC(e3), l2 = Pt.extend(s3 || {}, i2);
        if (!WC(o3) || e3.removed) return null;
        ...
        let r2;
        return t3.typing && (t3.add(), t3.typing = false, KC(t3, false, n3)), o3.get() > 0 && (o3.set(o3.get() - 1), r2 = t3.data[o3.get()], HC(e3, r2, true), e3.setDirty(true), e3.dispatch("Undo", { level: r2 })), r2;
      })(e2, t2, n2, o2), redo: (t2, n2) => ((e3, t3, n3) => {
        let o2;
        return t3.get() < n3.length - 1 && (t3.set(t3.get() + 1), o2 = n3[t3.get()], HC(e3, o2, false), e3.setDirty(true), e3.dispatch("Redo", { level: o2 })), o2;
      })(e2, t2, n2), clear: (t2, n2) => ((e3, t3, n3) => {
        t3.data = [], n3.set(0), t3.typing = false, e3.dispatch("ClearUndos");
      })(e2, t2, n2), reset: (e3) => ((e4) => {
        e4.clear(), e4.add();
      })(e3), hasUndo: (t2, n2) => ((e3, t3, n3) => n3.get() > 0 || t3.typing && t3.data[0] && !VC(jC(e3), t3.data[0]))(e2, t2, n2), hasRedo: (e3, t2) => ((e4, t3) => t3.get() < e4.data.length - 1 && !e4.typing)(e3, t2), transact: (e3, t2, n2) => ((e4, t3, n3) => (YC(e4, t3), e4.beforeChange(), e4.ignore(n3), e4.add()))(e3, t2, n2), ignore: (e3, t2) => ((e4, t3) => {
        try {
          e4.set(e4.get() + 1), t3();
        } finally {
          e4.set(e4.get() - 1);
        ...
        if (t3.transact(o3)) {
          ...
          HC(e3, s2, true), t3.transact(r3) && (t3.data[n3.get() - 1].beforeBookmark = o4);
        }
        ...
        return yC(e3, o2).fold(R, (t4) => {
          const n4 = ((e4, t5) => {
            if ("text" === t5.format) return ((e5) => I.from(e5.selection.getRng()).map((t6) => {
              ...
              ap(a2), ip(a2);
              const i2 = e5.dom.add(r2, s2, { "data-mce-bogus": "all", style: "overflow: hidden; opacity: 0;" }, a2.dom), l2 = IC(i2), d2 = Dr(null !== (n5 = i2.textContent) && void 0 !== n5 ? n5 : "");
              if (e5.dom.remove(i2), MC(d2, 0) || MC(d2, d2.length - 1)) {
                const e6 = o3.getOr(r2), t7 = IC(e6), n6 = t7.indexOf(l2);
                return -1 === n6 ? l2 : (MC(t7, n6 - 1) ? " " : "") + l2 + (MC(t7, n6 + l2.length) ? " " : "");
              }
              return l2;
            }).getOr(""))(e4);
            {
              const n5 = ((e5, t6) => {
                const n6 = e5.selection.getRng(), o3 = e5.dom.create("body"), r2 = e5.selection.getSel(), s2 = Mg(e5, Ju(r2)), a2 = t6.contextual ? LC(yn(e5.getBody()), s2, e5.schema).dom : n6.cloneContents();
      ...
      }))(e2, yn(e2.getBody())) }, raw: { getModel: () => I.none() } }), XC = (e2) => Ee(e2.plugins, "rtc"), QC = (e2) => e2.rtcInstance ? e2.rtcInstance : GC(e2), JC = (e2) => {
        const t2 = e2.rtcInstance;
        if (t2) return t2;
        throw new Error("Failed to get RTC instance not yet initialized.");
      }, ZC = (e2) => JC(e2).init.bindEvents(), ew = (e2) => 0 === e2.dom.length ? (xo(e2), I.none()) : I.some(e2), tw = (e2, t2, n2, o2, r2) => {
      ...
      const ow = (e2) => !(!e2 || !e2.ownerDocument) && kn(yn(e2.ownerDocument), yn(e2)), rw = (e2, t2, n2, o2) => {
        let r2, s2;
        const { selectorChangedWithUnbind: a2 } = /* @__PURE__ */ ((e3, t3) => {
          ...
          wC(e4, o3).each((t5) => {
            ...
            ((e5, t6, n5) => {
              ...
              const s3 = o5.bind(Bn).filter(Kt).bind(ew), a3 = r3.bind(Pn).filter(Kt).bind(ew);
              tw(s3, o5, e5, true, n5), tw(a3, r3, e5, false, n5), e5.collapse(false);
            })(o4, o4.createContextualFragment(n4), e4.schema), e4.selection.setRng(o4), sg(e4, o4), xC(e4, n4, t5);
          });
        })(o2, e3, t3), l2 = (e3) => {
          const t3 = c2();
          ...
          if (!((e4) => !!e4 && ow(e4.startContainer) && ow(e4.endContainer))(e3)) return;
          const n3 = d2();
        ...
        }, getContent: (e3) => ((e4, t3 = {}) => ((e5, t4, n3) => JC(e5).selection.getContent(t4, n3))(e4, t3.format ? t3.format : "html", t3))(o2, e3), setContent: i2, getBookmark: (e3, t3) => g2.getBookmark(e3, t3), moveToBookmark: (e3) => g2.moveToBookmark(e3), select: (t3, n3) => (((e3, t4, n4) => I.from(t4).bind((t5) => I.from(t5.parentNode).map((o3) => {
        ...
        const n2 = ["data-mce-selected"], o2 = { entity_encoding: "named", remove_trailing_brs: true, pad_empty_with_br: false, ...e2 }, r2 = t2 && t2.dom ? t2.dom : za.DOM, s2 = t2 && t2.schema ? t2.schema : ua(o2), a2 = bC(o2, s2);
        return ((e3, t3, n3) => {
        ...
        }, addRules: s2.addValidElements, setRules: s2.setValidElements, addTempAttr: T(sw, a2, n2), getTempAttrs: N(n2), getNodeFilters: a2.getNodeFilters, getAttributeFilters: a2.getAttributeFilters, removeNodeFilter: a2.removeNodeFilter, removeAttributeFilter: a2.removeAttributeFilter };
      }, iw = (e2, t2) => {
        const n2 = aw(e2, t2);
      ...
      }, Ow = Ya.PluginManager, Bw = Ya.ThemeManager, Pw = (e2) => {
        let t2 = [];
        const n2 = () => {
          const t3 = e2.theme;
        ...
        e2._skinLoaded ? Dw(e2, t2) : e2.on("SkinLoaded", () => {
          Dw(e2, t2);
        });
      }, Mw = (e2, t2, n2) => {
        ef(e2, t2, { message: n2 }), console.error(n2);
      }, Iw = (e2, t2, n2) => n2 ? `Failed to load ${e2}: ${n2} from url ${t2}` : `Failed to load ${e2} url: ${t2}`, Fw = (e2, ...t2) => {
        const n2 = window.console;
        n2 && (n2.error ? n2.error(e2, ...t2) : n2.log(e2, ...t2));
      }, Uw = (e2) => "content/" + e2 + "/content.css", zw = (e2, t2) => {
        const n2 = e2.editorManager.baseURL + "/skins/content", o2 = `content${e2.editorManager.suffix}.css`;
        return q(t2, (t3) => ((e3) => tinymce.Resource.has(Uw(e3)))(t3) ? t3 : ((e3) => /^[a-z0-9\-]+$/i.test(e3))(t3) && !e2.inline ? `${n2}/${t3}/${o2}` : e2.documentBaseURI.toAbsolute(t3));
      }, jw = (e2, t2) => {
        const n2 = {};
      ...
      const qw = (e2, t2) => {
      ...
      }, Vw = (e2) => () => e2.notificationManager.open({ text: e2.translate("Image uploading..."), type: "info", timeout: -1, progressBar: true }), Ww = (e2, t2) => qw(t2, { url: Gl(e2), basePath: Xl(e2), credentials: Ql(e2), handler: Jl(e2) }), Kw = (e2) => {
        const t2 = /* @__PURE__ */ (() => {
          let e3 = [];
          const t3 = (e4) => {
        ...
        let n2, o2;
        const r2 = Hw(), s2 = [], a2 = (t3) => (n3) => e2.selection ? t3(n3) : [], i2 = (e3, t3, n3) => {
          let o3 = 0;
          do {
        ...
        }, c2 = () => (n2 || (n2 = Ww(e2, r2)), p2().then(a2((o3) => {
          const r3 = q(o3, (e3) => e3.blobInfo);
          return n2.upload(r3, Vw(e2)).then(a2((n3) => {
            const r4 = [];
            let s3 = false;
            const a3 = q(n3, (n4, a4) => {
              const { blobInfo: i3, image: l3 } = o3[a4];
              let c3 = false;
              return n4.status && Wl(e2) ? (n4.url && !je(l3.src, n4.url) && (s3 = true), t2.removeByUri(l3.src), XC(e2) || ((t3, n5) => {
                ...
                Lw(e3, Ka.translate(["Failed to upload image: {0}", t3]));
              })(e2, n4.error.message)), { element: l3, status: n4.status, uploadUri: n4.url, blobInfo: i3, removed: c3 };
            });
            return r4.length > 0 && !XC(e2) ? e2.undoManager.transact(() => {
              V(_o(r4), (n4) => {
                const o4 = An(n4);
        ...
        }))), u2 = () => ql(e2) ? c2() : Promise.resolve([]), g2 = (e3) => ne(s2, (t3) => t3(e3)), p2 = () => (o2 || (o2 = jw(r2, t2)), o2.findAll(e2.getBody(), g2).then(a2((t3) => {
          const n3 = Y(t3, (t4) => m(t4) ? (Lw(e2, t4), false) : "blob" !== t4.uriType);
          return XC(e2) || V(n3, (e3) => {
      ...
      }, Yw = { remove_similar: true, inherit: false }, Gw = { selector: "td,th", ...Yw }, Xw = { tablecellbackgroundcolor: { styles: { backgroundColor: "%value" }, ...Gw }, tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...Gw }, tablecellbordercolor: { styles: { borderColor: "%value" }, ...Gw }, tablecellclass: { classes: ["%value"], ...Gw }, tableclass: { selector: "table", classes: ["%value"], ...Yw }, tablecellborderstyle: { styles: { borderStyle: "%value" }, ...Gw }, tablecellborderwidth: { styles: { borderWidth: "%value" }, ...Gw } }, Qw = N(Xw), Jw = Pt.each, Zw = za.DOM, ex = (e2) => C(e2) && f(e2), tx = (e2, t2) => {
        const n2 = t2 && t2.schema || ua({}), o2 = (e3) => {
          const t3 = m(e3) ? { name: e3, classes: [], attrs: {} } : e3, n3 = Zw.create(t3.name);
          return ((e4, t4) => {
            t4.classes.length > 0 && Zw.addClass(e4, t4.classes.join(" ")), Zw.setAttribs(e4, t4.attrs);
          })(n3, t3), n3;
        }, r2 = (e3, t3, s3) => {
          let a2;
          const i2 = t3[0], l2 = ex(i2) ? i2.name : void 0, d2 = ((e4, t4) => {
          ...
          const c2 = a2 ? o2(a2) : Zw.create("div");
          c2.appendChild(e3), s3 && Pt.each(s3, (t4) => {
            const n3 = o2(t4);
            c2.insertBefore(n3, e3);
          });
          const u2 = ex(a2) ? a2.siblings : void 0;
          return r2(c2, t3, u2);
        }, s2 = Zw.create("div");
        if (e2.length > 0) {
          const t3 = e2[0], n3 = o2(t3), a2 = ex(t3) ? t3.siblings : void 0;
        ...
        let n2 = "", o2 = wd(e2);
        if ("" === o2) return "";
        const r2 = (e3) => m(e3) ? e3.replace(/%(\w+)/g, "") : "", s2 = (t3, n3) => Zw.getStyle(null != n3 ? n3 : e2.getBody(), t3, true);
        if (m(t2)) {
        ...
        const l2 = (d2 = t2.selector, m(d2) ? (d2 = (d2 = d2.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Pt.map(d2.split(/(?:>|\s+(?![^\[\]]+\]))/), (e3) => {
          const t3 = Pt.map(e3.split(/(?:~\+|~|\+)/), nx), n3 = t3.pop();
          return t3.length && (n3.siblings = t3), n3;
        }).reverse()) : []);
        var d2;
        l2.length > 0 ? (l2[0].name || (l2[0].name = i2), i2 = t2.selector, a2 = tx(l2, e2)) : a2 = tx([i2], e2);
        const c2 = Zw.select(i2, a2)[0] || a2.firstChild;
        Jw(t2.styles, (e3, t3) => {
          const n3 = r2(e3);
          n3 && Zw.setStyle(c2, t3, n3);
        }), Jw(t2.attributes, (e3, t3) => {
          const n3 = r2(e3);
          n3 && Zw.setAttrib(c2, t3, n3);
        }), Jw(t2.classes, (e3) => {
          const t3 = r2(e3);
          Zw.hasClass(c2, t3) || Zw.addClass(c2, t3);
        }), e2.dispatch("PreviewFormats"), Zw.setStyles(a2, { position: "absolute", left: -65535 }), e2.getBody().appendChild(a2);
        const u2 = s2("fontSize"), f2 = /px$/.test(u2) ? parseInt(u2, 10) : 0;
        return Jw(o2.split(" "), (e3) => {
          let t3 = s2(e3, c2);
        ...
        }), e2.dispatch("AfterPreviewFormats"), Zw.remove(a2), n2;
      }, rx = (e2) => {
        const t2 = ((e3) => {
          const t3 = {}, n3 = (e4, o2) => {
            e4 && (m(e4) ? (p(o2) || (o2 = [o2]), V(o2, (e5) => {
              v(e5.deep) && (e5.deep = !Sm(e5)), v(e5.split) && (e5.split = !Sm(e5) || Nm(e5)), v(e5.remove) && Sm(e5) && !Nm(e5) && (e5.remove = "none"), Sm(e5) && Nm(e5) && (e5.mixed = true, e5.block_expand = true), m(e5.classes) && (e5.classes = e5.classes.split(/\s+/));
          ...
          })(e3)), n3(Qw()), n3(Cd(e3)), { get: (e4) => C(e4) ? t3[e4] : t3, has: (e4) => Ee(t3, e4), register: n3, unregister: (e4) => (e4 && t3[e4] && delete t3[e4], t3) };
        })(e2), n2 = $a({});
        return ((e3) => {
          ...
          ((e3, t4, n4, o3) => {
            JC(e3).formatter.apply(t4, n4, o3);
          })(e2, t3, n3, o2);
        }, remove: (t3, n3, o2, r2) => {
          ((e3, t4, n4, o3, r3) => {
            JC(e3).formatter.remove(t4, n4, o3, r3);
          })(e2, t3, n3, o2, r2);
        }, toggle: (t3, n3, o2) => {
          ((e3, t4, n4, o3) => {
            JC(e3).formatter.toggle(t4, n4, o3);
          })(e2, t3, n3, o2);
        }, match: (t3, n3, o2, r2) => ((e3, t4, n4, o3, r3) => JC(e3).formatter.match(t4, n4, o3, r3))(e2, t3, n3, o2, r2), closest: (t3) => ((e3, t4) => JC(e3).formatter.closest(t4))(e2, t3), matchAll: (t3, n3) => ((e3, t4, n4) => JC(e3).formatter.matchAll(t4, n4))(e2, t3, n3), matchNode: (t3, n3, o2, r2) => ((e3, t4, n4, o3, r3) => JC(e3).formatter.matchNode(t4, n4, o3, r3))(e2, t3, n3, o2, r2), canApply: (t3) => ((e3, t4) => JC(e3).formatter.canApply(t4))(e2, t3), formatChanged: (t3, o2, r2, s2) => ((e3, t4, n3, o3, r3, s3) => JC(e3).formatter.formatChanged(t4, n3, o3, r3, s3))(e2, n2, t3, o2, r2, s2), getCssText: T(ox, e2) };
      }, sx = (e2) => {
        ...
        const t2 = Xa(), n2 = $a(0), o2 = $a(0), r2 = { data: [], typing: false, beforeChange: () => {
          ((e3, t3, n3) => {
            JC(e3).undoManager.beforeChange(t3, n3);
          })(e2, n2, t2);
        }, add: (s2, a2) => ((e3, t3, n3, o3, r3, s3, a3) => JC(e3).undoManager.add(t3, n3, o3, r3, s3, a3))(e2, r2, o2, n2, t2, s2, a2), dispatchChange: () => {
          e2.setDirty(true);
          const t3 = jC(e2);
          t3.bookmark = ml(e2.selection), e2.dispatch("change", { level: t3, lastLevel: ie(r2.data, o2.get()).getOrUndefined() });
        }, undo: () => ((e3, t3, n3, o3) => JC(e3).undoManager.undo(t3, n3, o3))(e2, r2, n2, o2), redo: () => ((e3, t3, n3) => JC(e3).undoManager.redo(t3, n3))(e2, o2, r2.data), clear: () => {
          ((e3, t3, n3) => {
            JC(e3).undoManager.clear(t3, n3);
          })(e2, r2, o2);
        }, reset: () => {
          ((e3, t3) => {
            JC(e3).undoManager.reset(t3);
          })(e2, r2);
        }, hasUndo: () => ((e3, t3, n3) => JC(e3).undoManager.hasUndo(t3, n3))(e2, r2, o2), hasRedo: () => ((e3, t3, n3) => JC(e3).undoManager.hasRedo(t3, n3))(e2, r2, o2), transact: (t3) => ((e3, t4, n3, o3) => JC(e3).undoManager.transact(t4, n3, o3))(e2, r2, n2, t3), ignore: (t3) => {
          ((e3, t4, n3) => {
            JC(e3).undoManager.ignore(t4, n3);
          })(e2, n2, t3);
        }, extra: (t3, n3) => {
          ((e3, t4, n4, o3, r3) => {
            JC(e3).undoManager.extra(t4, n4, o3, r3);
          })(e2, r2, o2, t3, n3);
        } };
        return XC(e2) || ((e3, t3, n3) => {
          const o3 = $a(false), r3 = (e4) => {
            KC(t3, false, n3), t3.add({}, e4);
          };
          e3.on("init", () => {
            t3.add();
          }), e3.on("BeforeExecCommand", (e4) => {
            const o4 = e4.command;
            sx(o4) || (YC(t3, n3), t3.beforeChange());
            ...
            (s2 >= 33 && s2 <= 36 || s2 >= 37 && s2 <= 40 || 45 === s2 || n4.ctrlKey || a2) && (r3(), e3.nodeChanged()), 46 !== s2 && 8 !== s2 || e3.nodeChanged(), o3.get() && t3.typing && !VC(jC(e3), t3.data[0]) && (e3.isDirty() || e3.setDirty(true), e3.dispatch("TypingUndo"), o3.set(false), e3.nodeChanged());
          }), e3.on("keydown", (e4) => {
            const s2 = e4.keyCode;
            ...
            if ((s2 < 16 || s2 > 20) && 224 !== s2 && 91 !== s2 && !t3.typing && !a2) return t3.beforeChange(), KC(t3, true, n3), t3.add({}, e4), void o3.set(true);
      ...
      }, ix = [9, 27, af.HOME, af.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, af.DOWN, af.UP, af.LEFT, af.RIGHT].concat(At.browser.isFirefox() ? [224] : []), lx = "data-mce-placeholder", dx = (e2) => "keydown" === e2.type || "keyup" === e2.type, cx = (e2) => {
        const t2 = e2.keyCode;
        return t2 === af.BACKSPACE || t2 === af.DELETE;
      }, ux = (e2, t2) => ({ from: e2, to: t2 }), mx = (e2, t2) => {
        const n2 = yn(e2), o2 = yn(t2.container());
        return Ah(n2, o2).map((e3) => /* @__PURE__ */ ((e4, t3) => ({ block: e4, position: t3 }))(e3, t2));
      }, fx = (e2, t2) => Jn(t2, (e3) => Rr(e3) || lr(e3.dom), (t3) => _n(t3, e2)).filter(Wt).getOr(e2), gx = (e2, t2) => {
        const n2 = ((e3, t3) => {
          const n3 = Mn(e3);
      ...
      }, yx = (e2, t2, n2, o2) => (vx(true, t2), vx(false, n2), ((e3, t3) => kn(t3, e3) ? ((e4, t4) => {
        const n3 = Bp(t4, e4);
        return I.from(n3[n3.length - 1]);
      })(t3, e3) : I.none())(t2, n2).fold(T(bx, e2, t2, n2, o2), T(hx, e2, t2, n2, o2))), Cx = (e2, t2, n2, o2, r2) => t2 ? yx(e2, o2, n2, r2) : yx(e2, n2, o2, r2), wx = (e2, t2) => {
        const n2 = yn(e2.getBody()), o2 = ((e3, t3, n3) => n3.collapsed ? ((e4, t4, n4) => {
          const o3 = mx(e4, Vi.fromRangeStart(n4)), r2 = o3.bind((n5) => ku(t4, e4, n5.position).bind((n6) => mx(e4, n6).map((n7) => ((e5, t5, n8) => ar(n8.position.getNode()) && !gs(n8.block) ? Ru(false, n8.block.dom).bind((o4) => o4.isEqual(n8.position) ? ku(t5, e5, o4).bind((t6) => mx(e5, t6)) : I.some(n8)).getOr(n8) : n8)(e4, t4, n7))));
          return Mt(o3, r2, ux).filter((t5) => ((e5) => !_n(e5.from.block, e5.to.block))(t5) && ((e5, t6) => {
            const n5 = yn(e5);
            return _n(fx(n5, t6.from.block), fx(n5, t6.to.block));
          ...
          Cx(n2, t2, o3.from.block, o3.to.block, e2.schema).each((t3) => {
        ...
        return ((e3, t3) => {
          ...
          return !((e4, t4) => xx(e4, t4.startContainer) || xx(e4, t4.endContainer))(e3, t3) && n2 && o2;
          ...
          return Mt(Ah(e3, yn(o2.startContainer)), Ah(e3, yn(o2.endContainer)), (r2, s2) => _n(r2, s2) ? I.none() : I.some(() => {
            o2.deleteContents(), Cx(e3, true, r2, s2, n2).each((e4) => {
              t3.setRng(e4.toRange());
            });
          })).getOr(I.none());
        })(t2, e2.selection, e2.schema);
      }, _x = (e2, t2) => e2.selection.isCollapsed() ? I.none() : Ex(e2), kx = (e2, t2, n2, o2, r2) => I.from(t2._selectionOverrides.showCaret(e2, n2, o2, r2)), Sx = (e2, t2) => e2.dispatch("BeforeObjectSelected", { target: t2 }).isDefaultPrevented() ? I.none() : I.some(((e3) => {
        const t3 = e3.ownerDocument.createRange();
        return t3.selectNode(e3), t3;
      })(t2)), Nx = (e2, t2, n2) => t2.collapsed ? ((e3, t3, n3) => {
        const o2 = ru(1, e3.getBody(), t3), r2 = Vi.fromRangeStart(o2), s2 = r2.getNode();
        if (Lc(s2)) return kx(1, e3, s2, !r2.isAtEnd(), false);
        const a2 = r2.getNode(true);
        if (Lc(a2)) return kx(1, e3, a2, false, false);
        const i2 = lb(e3.dom.getRoot(), r2.getNode());
        return Lc(i2) ? kx(1, e3, i2, false, n3) : I.none();
      })(e2, t2, n2).getOr(t2) : t2, Rx = (e2) => Ap(e2) || kp(e2), Ax = (e2) => Tp(e2) || Sp(e2), Tx = (e2, t2, n2, o2, r2, s2) => {
        kx(o2, e2, s2.getNode(!r2), r2, true).each((n3) => {
          if (t2.collapsed) {
        ...
        const o2 = t3 ? cu.Forwards : cu.Backwards, r2 = wu(e3.getBody()), s2 = T(lu, t3 ? r2.next : r2.prev), a2 = t3 ? Rx : Ax, i2 = au(o2, e3.getBody(), n2), l2 = s2(i2), d2 = l2 ? Eh(t3, l2) : l2;
        if (!d2 || !du(i2, d2)) return I.none();
        if (a2(d2)) return I.some(() => Tx(e3, n2, i2.getNode(), o2, t3, d2));
        const c2 = s2(d2);
        return c2 && a2(c2) && du(d2, c2) ? I.some(() => Tx(e3, n2, i2.getNode(), o2, t3, c2)) : I.none();
      })(e2, t2), Bx = (e2, t2) => {
        const n2 = e2.getBody();
        return t2 ? Ou(n2).filter(Ap) : Bu(n2).filter(Tp);
      }, Px = (e2) => {
        const t2 = e2.selection.getRng();
        return !t2.collapsed && (Bx(e2, true).exists((e3) => e3.isEqual(Vi.fromRangeStart(t2))) || Bx(e2, false).exists((e3) => e3.isEqual(Vi.fromRangeEnd(t2))));
      }, Dx = hl([{ remove: ["element"] }, { moveToElement: ["element"] }, { moveToPosition: ["position"] }]), Lx = (e2, t2, n2, o2) => ku(t2, e2, n2).bind((r2) => {
        return s2 = r2.getNode(), C(s2) && (Rr(yn(s2)) || Sr(yn(s2))) || ((e3, t3, n3, o3, r3) => {
          ...
          return Ah(yn(e3), yn(n3.getNode())).map((e4) => gs(e4) ? Dx.remove(e4.dom) : Dx.moveToElement(r3)).orThunk(() => I.some(Dx.moveToElement(r3)));
        })(e2, t2, n2, r2) : t2 && Tp(n2) || !t2 && Ap(n2) ? I.some(Dx.moveToPosition(r2)) : I.none();
        var s2;
      }), Mx = (e2, t2) => I.from(lb(e2.getBody(), t2)), Ix = (e2, t2) => {
        const n2 = e2.selection.getNode();
        return Mx(e2, n2).filter(dr).fold(() => ((e3, t3, n3, o2) => {
          const r2 = ru(t3 ? 1 : -1, e3, n3), s2 = Vi.fromRangeStart(r2), a2 = yn(e3);
          return !t3 && Tp(s2) ? I.some(Dx.remove(s2.getNode(true))) : t3 && Ap(s2) ? I.some(Dx.remove(s2.getNode())) : !t3 && Ap(s2) && qp(a2, s2, o2) ? Vp(a2, s2, o2).map((e4) => Dx.remove(e4.getNode())) : t3 && Tp(s2) && $p(a2, s2, o2) ? Wp(a2, s2, o2).map((e4) => Dx.remove(e4.getNode())) : ((e4, t4, n4, o3) => ((e5, t5) => {
            const n5 = t5.getNode(!e5), o4 = e5 ? "after" : "before";
            return qo(n5) && n5.getAttribute("data-mce-caret") === o4;
          })(t4, n4) ? ((e5, t5) => y(t5) ? I.none() : e5 && dr(t5.nextSibling) ? I.some(Dx.moveToElement(t5.nextSibling)) : !e5 && dr(t5.previousSibling) ? I.some(Dx.moveToElement(t5.previousSibling)) : I.none())(t4, n4.getNode(!t4)).orThunk(() => Lx(e4, t4, n4, o3)) : Lx(e4, t4, n4, o3).bind((t5) => ((e5, t6, n5) => n5.fold((e6) => I.some(Dx.remove(e6)), (e6) => I.some(Dx.moveToElement(e6)), (n6) => Qc(t6, n6, e5) ? I.none() : I.some(Dx.moveToPosition(n6))))(e4, n4, t5)))(e3, t3, s2, o2);
        ...
        return true;
      }, Ux = (e2, t2) => e2.selection.isCollapsed() ? Ix(e2, t2) : ((e3, t3) => {
        const n2 = e3.selection.getNode();
        return dr(n2) && !cr(n2) ? Mx(e3, n2.parentNode).filter(dr).fold(() => I.some(() => {
          var n3;
          n3 = yn(e3.getBody()), V(Uo(n3, ".mce-offscreen-selection"), xo), vh(e3, t3, yn(e3.selection.getNode())), Th(e3);
        }), () => I.some(_)) : Px(e3) ? I.some(() => {
          Ph(e3, e3.selection.getRng(), yn(e3.getBody()));
        }) : I.none();
      })(e2, t2), zx = (e2, t2) => e2.selection.isCollapsed() ? ((e3, t3) => {
        const n2 = Vi.fromRangeStart(e3.selection.getRng());
        return ku(t3, e3.getBody(), n2).filter((e4) => t3 ? Ep(e4) : _p(e4)).bind((e4) => Jc(t3 ? 0 : -1, e4)).map((t4) => () => e3.selection.select(t4));
      })(e2, t2) : I.none(), jx = er, Hx = (e2) => jx(e2) && e2.data[0] === Br, $x = (e2) => jx(e2) && e2.data[e2.data.length - 1] === Br, qx = (e2) => {
        var t2;
        return (null !== (t2 = e2.ownerDocument) && void 0 !== t2 ? t2 : document).createTextNode(Br);
      }, Vx = (e2, t2) => e2 ? ((e3) => {
        var t3;
        if (jx(e3.previousSibling)) return $x(e3.previousSibling) || e3.previousSibling.appendData(Br), e3.previousSibling;
        if (jx(e3)) return Hx(e3) || e3.insertData(0, Br), e3;
        {
          const n2 = qx(e3);
        ...
        var t3, n2;
        if (jx(e3.nextSibling)) return Hx(e3.nextSibling) || e3.nextSibling.insertData(0, Br), e3.nextSibling;
        if (jx(e3)) return $x(e3) || e3.appendData(Br), e3;
        {
          const o2 = qx(e3);
      ...
      })(t2), Wx = T(Vx, true), Kx = T(Vx, false), Yx = (e2, t2) => er(e2.container()) ? Vx(t2, e2.container()) : Vx(t2, e2.getNode()), Gx = (e2, t2) => {
        const n2 = t2.get();
        ...
        return I.none();
      }, Jx = hl([{ before: ["element"] }, { start: ["element"] }, { end: ["element"] }, { after: ["element"] }]), Zx = (e2, t2) => Xc(t2, e2) || e2, eE = (e2, t2, n2) => {
        const o2 = _h(n2), r2 = Zx(t2, o2.container());
        return xh(e2, r2, o2).fold(() => Au(r2, o2).bind(T(xh, e2, r2)).map((e3) => Jx.before(e3)), I.none);
      }, tE = (e2, t2) => null === Lu(e2, t2), nE = (e2, t2, n2) => xh(e2, t2, n2).filter(T(tE, t2)), oE = (e2, t2, n2) => {
        const o2 = kh(n2);
        return nE(e2, t2, o2).bind((e3) => Tu(e3, o2).isNone() ? I.some(Jx.start(e3)) : I.none());
      }, rE = (e2, t2, n2) => {
        const o2 = _h(n2);
        return nE(e2, t2, o2).bind((e3) => Au(e3, o2).isNone() ? I.some(Jx.end(e3)) : I.none());
      }, sE = (e2, t2, n2) => {
        const o2 = kh(n2), r2 = Zx(t2, o2.container());
        return xh(e2, r2, o2).fold(() => Tu(r2, o2).bind(T(xh, e2, r2)).map((e3) => Jx.after(e3)), I.none);
      }, aE = (e2) => !wh(lE(e2)), iE = (e2, t2, n2) => Qx([eE, oE, rE, sE], [e2, t2, n2]).filter(aE), lE = (e2) => e2.fold(R, R, R, R), dE = (e2) => e2.fold(N("before"), N("start"), N("end"), N("after")), cE = (e2) => e2.fold(Jx.before, Jx.before, Jx.after, Jx.after), uE = (e2) => e2.fold(Jx.start, Jx.start, Jx.end, Jx.end), mE = (e2, t2, n2, o2, r2, s2) => Mt(xh(t2, n2, o2), xh(t2, n2, r2), (t3, o3) => t3 !== o3 && ((e3, t4, n3) => {
        const o4 = Xc(t4, e3), r3 = Xc(n3, e3);
        return C(o4) && o4 === r3;
      })(n2, t3, o3) ? Jx.after(e2 ? t3 : o3) : s2).getOr(s2), fE = (e2, t2) => e2.fold(M, (e3) => {
        return o2 = t2, !(dE(n2 = e3) === dE(o2) && lE(n2) === lE(o2));
        var n2, o2;
      }), gE = (e2, t2) => e2 ? t2.fold(k(I.some, Jx.start), I.none, k(I.some, Jx.after), I.none) : t2.fold(I.none, k(I.some, Jx.before), I.none, k(I.some, Jx.end)), pE = (e2, t2, n2) => {
        const o2 = e2 ? 1 : -1;
      ...
      const bE = (e2, t2) => e2 === cu.Backwards ? oe(t2) : t2, vE = (e2, t2, n2) => e2 === cu.Forwards ? t2.next(n2) : t2.prev(n2), yE = (e2, t2, n2, o2) => ar(o2.getNode(t2 === cu.Forwards)) ? hE.Br : false === Qc(n2, o2) ? hE.Block : hE.Wrap, CE = (e2, t2, n2, o2) => {
        const r2 = wu(n2);
        let s2 = o2;
        const a2 = [];
        for (; s2; ) {
          const n3 = vE(t2, r2, s2);
          if (!n3) break;
          if (ar(n3.getNode(false))) return t2 === cu.Forwards ? { positions: bE(t2, a2).concat([n3]), breakType: hE.Br, breakAt: I.some(n3) } : { positions: bE(t2, a2), breakType: hE.Br, breakAt: I.some(n3) };
          if (n3.isVisible()) {
            if (e2(s2, n3)) {
              const e3 = yE(0, t2, s2, n3);
              return { positions: bE(t2, a2), breakType: e3, breakAt: I.some(n3) };
            }
            a2.push(n3), s2 = n3;
          } else s2 = n3;
        }
        return { positions: bE(t2, a2), breakType: hE.Eol, breakAt: I.none() };
      }, wE = (e2, t2, n2, o2) => t2(n2, o2).breakAt.map((o3) => {
        const r2 = t2(n2, o3).positions;
        return e2 === cu.Backwards ? r2.concat(o3) : [o3].concat(r2);
      }).getOr([]), xE = (e2, t2) => X(e2, (e3, n2) => e3.fold(() => I.some(n2), (o2) => Mt(le(o2.getClientRects()), le(n2.getClientRects()), (e4, r2) => {
        const s2 = Math.abs(t2 - e4.left);
        return Math.abs(t2 - r2.left) <= s2 ? n2 : o2;
      }).or(e3)), I.none()), EE = (e2, t2) => le(t2.getClientRects()).bind((t3) => xE(e2, t3.left)), _E = T(CE, Vi.isAbove, -1), kE = T(CE, Vi.isBelow, 1), SE = T(wE, -1, _E), NE = T(wE, 1, kE), RE = (e2, t2) => _E(e2, t2).breakAt.isNone(), AE = (e2, t2) => kE(e2, t2).breakAt.isNone(), TE = (e2, t2) => EE(SE(e2, t2), t2), OE = (e2, t2) => EE(NE(e2, t2), t2), BE = dr, PE = (e2, t2) => Math.abs(e2.left - t2), DE = (e2, t2) => Math.abs(e2.right - t2), LE = (e2, t2) => Oe(e2, (e3, n2) => {
        const o2 = Math.min(PE(e3, t2), DE(e3, t2)), r2 = Math.min(PE(n2, t2), DE(n2, t2));
        return r2 === o2 && _e(n2, "node") && BE(n2.node) || r2 < o2 ? n2 : e3;
      }), ME = (e2) => {
        const t2 = (t3) => q(t3, (t4) => {
          const n2 = vi(t4);
      ...
      const UE = (e2, t2, n2, o2, r2, s2) => {
      ...
      }, zE = T(UE, FE.Up, wi, xi), jE = T(UE, FE.Down, xi, wi), HE = (e2) => Pe(e2.getClientRects()), $E = (e2) => (t2) => ((e3, t3) => t3.line > e3)(e2, t2), qE = (e2) => (t2) => ((e3, t3) => t3.line === e3)(e2, t2), VE = (e2, t2) => {
        e2.selection.setRng(t2), sg(e2, e2.selection.getRng());
      }, WE = (e2, t2, n2) => I.some(Nx(e2, t2, n2)), KE = (e2, t2, n2, o2, r2, s2) => {
        const a2 = t2 === cu.Forwards, i2 = wu(e2.getBody()), l2 = T(lu, a2 ? i2.next : i2.prev), d2 = a2 ? o2 : r2;
        if (!n2.collapsed) {
          const o3 = _i(n2);
          if (s2(o3)) return kx(t2, e2, o3, t2 === cu.Backwards, false);
          if (Px(e2)) {
        ...
        if (d2(c2)) return Sx(e2, c2.getNode(!a2));
        let u2 = l2(c2);
        const m2 = Wr(n2);
        if (!u2) return m2 ? I.some(n2) : I.none();
        if (u2 = Eh(a2, u2), d2(u2)) return kx(t2, e2, u2.getNode(!a2), a2, false);
        const f2 = l2(u2);
        return f2 && d2(f2) && du(u2, f2) ? kx(t2, e2, f2.getNode(!a2), a2, false) : m2 ? WE(e2, u2.toRange(), false) : I.none();
      }, YE = (e2, t2, n2, o2, r2, s2) => {
        const a2 = au(t2, e2.getBody(), n2), i2 = Pe(a2.getClientRects()), l2 = t2 === FE.Down, d2 = e2.getBody();
        if (!i2) return I.none();
        if (Px(e2)) {
          const e3 = l2 ? Vi.fromRangeEnd(n2) : Vi.fromRangeStart(n2);
          return (l2 ? OE : TE)(d2, e3).orThunk(() => I.from(e3)).map((e4) => e4.toRange());
        }
        const c2 = (l2 ? jE : zE)(d2, $E(1), a2), u2 = Y(c2, qE(1)), m2 = i2.left, f2 = LE(u2, m2);
        if (f2 && s2(f2.node)) {
          const n3 = Math.abs(m2 - f2.left), o3 = Math.abs(m2 - f2.right);
          return kx(t2, e2, f2.node, n3 < o3, false);
        }
        let g2;
        if (g2 = o2(a2) ? a2.getNode() : r2(a2) ? a2.getNode(true) : _i(n2), g2) {
          ...
          let o3 = LE(Y(n3, qE(1)), m2);
          if (o3) return WE(e2, o3.position.toRange(), false);
          if (o3 = Pe(Y(n3, qE(0))), o3) return WE(e2, o3.position.toRange(), false);
        }
        return 0 === u2.length ? GE(e2, l2).filter(l2 ? r2 : o2).map((t3) => Nx(e2, t3.toRange(), false)) : I.none();
      }, GE = (e2, t2) => {
      ...
      }, XE = (e2, t2, n2) => GE(e2, t2).filter(n2).exists((t3) => (e2.selection.setRng(t3.toRange()), true)), QE = (e2, t2) => {
      ...
      }, ZE = (e2, t2, n2) => Xx(t2, n2).map((t3) => (QE(e2, t3), n2)), e_ = (e2, t2, n2) => {
        ...
        return ((e3, t3, n3, o3) => {
          const r3 = Eh(e3, o3), s2 = iE(t3, n3, r3);
          return iE(t3, n3, r3).bind(T(gE, e3)).orThunk(() => ((e4, t4, n4, o4, r4) => {
            const s3 = Eh(e4, r4);
            return ku(e4, n4, s3).map(T(Eh, e4)).fold(() => o4.map(cE), (r5) => iE(t4, n4, r5).map(T(mE, e4, t4, n4, s3, r5)).filter(T(fE, o4))).filter(aE);
          })(e3, t3, n3, s2, o3));
        })(n2, T(Ch, e2), o2, r2).bind((n3) => ZE(e2, t2, n3));
      }, t_ = (e2, t2, n2) => !!yd(e2) && e_(e2, t2, n2).isSome(), n_ = (e2, t2, n2) => !!yd(t2) && ((e3, t3) => {
        const n3 = t3.selection.getRng(), o2 = e3 ? Vi.fromRangeEnd(n3) : Vi.fromRangeStart(n3);
        return !!((e4) => w(e4.selection.getSel().modify))(t3) && (e3 && jr(o2) ? pE(true, t3.selection, o2) : !(e3 || !Hr(o2)) && pE(false, t3.selection, o2));
      })(e2, t2), o_ = (e2) => {
          ...
          yd(e2) && (((e3, t3, n3) => {
            ...
            if (t3.selection.isCollapsed()) {
              ...
              V(r2, (o4) => {
                ...
                iE(e3, t3.getBody(), r3).bind((e4) => ZE(t3, n3, e4));
              });
            }
          })(n2, e2, t2, o2.parents));
        }), t2;
      }, r_ = T(n_, true), s_ = T(n_, false), a_ = (e2, t2, n2) => {
        if (yd(e2)) {
          const o2 = GE(e2, t2).getOrThunk(() => {
            const n3 = e2.selection.getRng();
            return t2 ? Vi.fromRangeEnd(n3) : Vi.fromRangeStart(n3);
          });
          return iE(T(Ch, e2), e2.getBody(), o2).exists((t3) => {
            const o3 = cE(t3);
            return Xx(n2, o3).exists((t4) => (QE(e2, t4), true));
          });
        }
        return false;
      }, i_ = (e2, t2) => (n2) => Xx(t2, n2).map((t3) => () => QE(e2, t3)), l_ = (e2, t2, n2, o2) => {
        ...
        e2.undoManager.ignore(() => {
          ...
          })(n2, o2)), Nh(e2), iE(s2, r2, Vi.fromRangeStart(e2.selection.getRng())).map(uE).bind(i_(e2, t2)).each(D);
        }), e2.nodeChanged();
      }, d_ = (e2, t2, n2) => {
        if (e2.selection.isCollapsed() && yd(e2)) {
          const o2 = Vi.fromRangeStart(e2.selection.getRng());
          return ((e3, t3, n3, o3) => {
            const r2 = ((e4, t4) => Xc(t4, e4) || e4)(e3.getBody(), o3.container()), s2 = T(Ch, e3), a2 = iE(s2, r2, o3);
            return a2.bind((e4) => n3 ? e4.fold(N(I.some(uE(e4))), I.none, N(I.some(cE(e4))), I.none) : e4.fold(I.none, N(I.some(cE(e4))), I.none, N(I.some(uE(e4))))).map(i_(e3, t3)).getOrThunk(() => {
              const i2 = Su(n3, r2, o3), l2 = i2.bind((e4) => iE(s2, r2, e4));
              return Mt(a2, l2, () => xh(s2, r2, o3).bind((t4) => ((e4) => Mt(Ou(e4), Bu(e4), (t5, n4) => {
                ...
                n3 ? l_(e3, t3, o3, r3) : l_(e3, t3, r3, o3);
              })));
            });
          })(e2, t2, n2, o2);
        }
      ...
      }, u_ = (e2) => 1 === zn(e2), m_ = (e2, t2) => {
        const n2 = T(Zb, e2);
        return te(t2, (e3) => n2(e3) ? [e3.dom] : []);
      }, f_ = (e2) => {
        const t2 = ((e3) => c_(e3, (t3) => e3.schema.isBlock(Ht(t3))))(e2);
        return m_(e2, t2);
      }, g_ = (e2, t2) => {
        const n2 = Y(((e3) => c_(e3, (t3) => e3.schema.isBlock(Ht(t3)) || ((e4) => zn(e4) > 1)(t3)))(e2), u_);
      ...
      }, h_ = (e2) => er(e2.startContainer), b_ = (e2) => {
        const t2 = e2.selection.getRng();
        return ((e3) => 0 === e3.startOffset && h_(e3))(t2) && ((e3, t3) => {
      ...
      }, v_ = (e2, t2) => e2.selection.isCollapsed() ? g_(e2, t2) : ((e3) => {
        if (b_(e3)) {
          const t3 = f_(e3);
          return I.some(() => {
            Nh(e3), ((e4, t4) => {
              const n2 = re(t4, f_(e4));
              n2.length > 0 && p_(e4, n2);
            })(e3, t3);
          });
        }
        return I.none();
      })(e2), y_ = (e2, t2) => Qn(e2, (e3) => Du(e3.dom), (e3) => t2.isBlock(Ht(e3))).isSome(), C_ = (e2) => (((e3) => {
        const t2 = e3.selection.getRng();
        return t2.collapsed && (h_(t2) || e3.dom.isEmpty(t2.startContainer)) && !((e4) => y_(yn(e4.selection.getStart()), e4.schema))(e3);
      })(e2) && p_(e2, []), true), w_ = (e2, t2, n2) => C(n2) ? I.some(() => {
        e2._selectionOverrides.hideFakeCaret(), vh(e2, t2, yn(n2));
      }) : I.none(), x_ = (e2, t2) => e2.selection.isCollapsed() ? ((e3, t3) => {
        const n2 = t3 ? kp : Sp, o2 = t3 ? cu.Forwards : cu.Backwards, r2 = au(o2, e3.getBody(), e3.selection.getRng());
        return n2(r2) ? w_(e3, t3, r2.getNode(!t3)) : I.from(Eh(t3, r2)).filter((e4) => n2(e4) && du(r2, e4)).bind((n3) => w_(e3, t3, n3.getNode(!t3)));
      })(e2, t2) : ((e3, t3) => {
        const n2 = e3.selection.getNode();
        return mr(n2) ? w_(e3, t3, n2) : I.none();
      })(e2, t2), E_ = (e2) => Xe(null != e2 ? e2 : "").getOr(0), __ = (e2, t2) => (e2 || "table" === Ht(t2) ? "margin" : "padding") + ("rtl" === co(t2, "direction") ? "-right" : "-left"), k_ = (e2) => {
        const t2 = N_(e2);
        return !e2.mode.isReadOnly() && (t2.length > 1 || ((e3, t3) => ne(t3, (t4) => {
          const n2 = __(od(e3), t4), o2 = mo(t4, n2).map(E_).getOr(0);
          return "false" !== e3.dom.getContentEditable(t4.dom) && o2 > 0;
        }))(e2, t2));
      }, S_ = (e2) => kr(e2) || Sr(e2), N_ = (e2) => Y(_o(e2.selection.getSelectedBlocks()), (e3) => !S_(e3) && !((e4) => An(e4).exists(S_))(e3) && Jn(e3, (e4) => lr(e4.dom) || dr(e4.dom)).exists((e4) => lr(e4.dom))), R_ = (e2, t2) => {
        var n2, o2;
        const { dom: r2 } = e2, s2 = rd(e2), a2 = null !== (o2 = null === (n2 = /[a-z%]+$/i.exec(s2)) || void 0 === n2 ? void 0 : n2[0]) && void 0 !== o2 ? o2 : "px", i2 = E_(s2), l2 = od(e2);
        V(N_(e2), (e3) => {
          ((e4, t3, n3, o3, r3, s3) => {
            const a3 = __(n3, yn(s3)), i3 = E_(e4.getStyle(s3, a3));
            if ("outdent" === t3) {
      ...
      }, A_ = (e2) => R_(e2, "outdent"), T_ = (e2) => {
        if (e2.selection.isCollapsed() && k_(e2)) {
          const t2 = e2.dom, n2 = e2.selection.getRng(), o2 = Vi.fromRangeStart(n2), r2 = t2.getParent(n2.startContainer, t2.isBlock);
          if (null !== r2 && Ip(yn(r2), o2, e2.schema)) return I.some(() => A_(e2));
        }
        return I.none();
      }, O_ = (e2, t2, n2) => ue([T_, Ux, Ox, (e3, n3) => d_(e3, t2, n3), wx, ib, zx, x_, _x, v_], (t3) => t3(e2, n2)).filter((t3) => e2.selection.isEditable()), B_ = (e2, t2) => {
      ...
      }, P_ = (e2) => void 0 === e2.touches || 1 !== e2.touches.length ? I.none() : I.some(e2.touches[0]), D_ = (e2, t2) => Ee(e2, t2.nodeName), L_ = (e2, t2) => !!er(t2) || !!qo(t2) && !(D_(e2.getBlockElements(), t2) || Ku(t2) || Ts(e2, t2) || hs(t2)), M_ = (e2, t2) => {
        if (er(t2)) {
          if (0 === t2.data.length) return true;
          if (/^\s+$/.test(t2.data)) return !t2.nextSibling || D_(e2, t2.nextSibling) || hs(t2.nextSibling);
        }
        return false;
      }, I_ = (e2) => e2.dom.create(Il(e2), Fl(e2)), F_ = (e2) => {
        ...
        if (n2) return "compositionstart" === t2.type ? (t2.preventDefault(), t2.stopPropagation(), void $_(e2, n2)) : void (zr(n2) && ($_(e2, n2), e2.undoManager.add()));
      }, V_ = dr, W_ = (e2, t2, n2) => {
        ...
        return ((e4, t4, n3) => KE(t4, e4, n3, Ap, Tp, V_))(n2, e3, o2).orThunk(() => (W_(e3, n2, o2), I.none()));
      })(e2, ((e3, t3) => {
        const n2 = t3 ? e3.getEnd(true) : e3.getStart(true);
        return wh(n2) ? !t3 : t3;
      })(e2.selection, t2)).exists((t3) => (VE(e2, t3), true)), Y_ = (e2, t2) => ((e3, t3) => {
        const n2 = t3 ? 1 : -1, o2 = e3.selection.getRng();
        return ((e4, t4, n3) => YE(t4, e4, n3, (e5) => Ap(e5) || Np(e5), (e5) => Tp(e5) || Rp(e5), V_))(n2, e3, o2).orThunk(() => (W_(e3, n2, o2), I.none()));
      })(e2, t2).exists((t3) => (VE(e2, t3), true)), G_ = (e2, t2) => XE(e2, t2, t2 ? Tp : Ap), X_ = (e2, t2) => Bx(e2, !t2).map((n2) => {
      ...
      }).exists((t3) => (VE(e2, t3), true)), Q_ = (e2) => H(["figcaption"], Ht(e2)), J_ = (e2, t2) => !!e2.selection.isCollapsed() && ((e3, t3) => {
        const n2 = yn(e3.getBody()), o2 = Vi.fromRangeStart(e3.selection.getRng());
        return ((e4, t4, n3) => {
          const o3 = T(_n, t4);
          return Jn(yn(e4.container()), (e5) => n3.isBlock(Ht(e5)), o3).filter(Q_);
        })(o2, n2, e3.schema).exists(() => {
          if (((e4, t4, n3) => t4 ? AE(e4.dom, n3) : RE(e4.dom, n3))(n2, t3, o2)) {
            const o3 = U_(e3, n2, t3 ? vo : bo);
            return e3.selection.setRng(o3), true;
          }
          return false;
        });
      })(e2, t2), Z_ = (e2, t2) => ((e3, t3) => t3 ? I.from(e3.dom.getParent(e3.selection.getNode(), "details")).map((t4) => ((e4, t5) => {
        const n2 = e4.selection.getRng(), o2 = Vi.fromRangeStart(n2);
        return !(e4.getBody().lastChild !== t5 || !AE(t5, o2) || (e4.execCommand("InsertNewBlockAfter"), 0));
        ...
        return !(e4.getBody().firstChild !== t5 || !RE(n3, r2) || (e4.execCommand("InsertNewBlockBefore"), 0));
      })(e3, n2, t4))).getOr(false))(e2, t2), ek = { shiftKey: false, altKey: false, ctrlKey: false, metaKey: false, keyCode: 0 }, tk = (e2, t2) => t2.keyCode === e2.keyCode && t2.shiftKey === e2.shiftKey && t2.altKey === e2.altKey && t2.ctrlKey === e2.ctrlKey && t2.metaKey === e2.metaKey, nk = (e2, ...t2) => () => e2.apply(null, t2), ok = (e2, t2) => J(((e3, t3) => te(((e4) => q(e4, (e5) => ({ ...ek, ...e5 })))(e3), (e4) => tk(e4, t3) ? [e4] : []))(e2, t2), (e3) => e3.action()), rk = (e2, t2) => ue(((e3, t3) => te(((e4) => q(e4, (e5) => ({ ...ek, ...e5 })))(e3), (e4) => tk(e4, t3) ? [e4] : []))(e2, t2), (e3) => e3.action()), sk = (e2, t2) => {
        const n2 = t2 ? cu.Forwards : cu.Backwards, o2 = e2.selection.getRng();
        return KE(e2, n2, o2, kp, Sp, mr).exists((t3) => (VE(e2, t3), true));
      }, ak = (e2, t2) => {
        const n2 = t2 ? 1 : -1, o2 = e2.selection.getRng();
        return YE(e2, n2, o2, kp, Sp, mr).exists((t3) => (VE(e2, t3), true));
      }, ik = (e2, t2) => XE(e2, t2, t2 ? Sp : kp), lk = hl([{ none: ["current"] }, { first: ["current"] }, { middle: ["current", "target"] }, { last: ["current"] }]), dk = { ...lk, none: (e2) => lk.none(e2) }, ck = (e2, t2, n2) => te(Mn(e2), (e3) => xn(e3, t2) ? n2(e3) ? [e3] : [] : ck(e3, t2, n2)), uk = (e2, t2) => no(e2, "table", t2), mk = (e2, t2, n2, o2, r2 = M) => {
        const s2 = 1 === o2;
        if (!s2 && n2 <= 0) return dk.first(e2[0]);
        if (s2 && n2 >= e2.length - 1) return dk.last(e2[e2.length - 1]);
        {
          const s3 = n2 + o2, a2 = e2[s3];
          return r2(a2) ? dk.middle(t2, a2) : mk(e2, t2, s3, o2, r2);
        }
      }, fk = (e2, t2) => uk(e2, t2).bind((t3) => {
        const n2 = ck(t3, "th,td", M);
      ...
      }, pk = T(gk, (e2) => e2.bottom, (e2, t2) => e2.y < t2), hk = T(gk, (e2) => e2.top, (e2, t2) => e2.y > t2), bk = (e2, t2, n2) => {
        const o2 = e2(t2, n2);
        return ((e3) => e3.breakType === hE.Wrap && 0 === e3.positions.length)(o2) || !ar(n2.getNode()) && ((e3) => e3.breakType === hE.Br && 1 === e3.positions.length)(o2) ? !((e3, t3, n3) => n3.breakAt.exists((n4) => e3(t3, n4).breakAt.isSome()))(e2, t2, o2) : o2.breakAt.isNone();
      }, vk = T(bk, _E), yk = T(bk, kE), Ck = (e2, t2, n2, o2) => {
        const r2 = e2.selection.getRng(), s2 = t2 ? 1 : -1;
        return !(!Dc() || !((e3, t3, n3) => {
          const o3 = Vi.fromRangeStart(t3);
          return Ru(!e3, n3).exists((e4) => e4.isEqual(o3));
        })(t2, r2, n2) || (kx(s2, e2, n2, !t2, false).each((t3) => {
          VE(e2, t3);
        }), 0));
      }, wk = (e2, t2, n2) => {
        const o2 = ((e3, t3) => {
        ...
        o2.fold(() => VE(e2, n2.toRange()), (o3) => Ru(r2, e2.getBody()).filter((e3) => e3.isEqual(n2)).fold(() => VE(e2, n2.toRange()), (n3) => ((e3, t3, n4) => {
          t3.undoManager.transact(() => {
            const o4 = e3 ? ho : po, r3 = U_(t3, yn(n4), o4);
            VE(t3, r3);
          });
        })(t2, e2, o3)));
      }, xk = (e2, t2, n2, o2) => {
        ...
        if (!t2 && vk(o2, s2)) {
          const o3 = ((e3, t3, n3) => ((e4, t4) => le(t4.getClientRects()).bind((t5) => pk(e4, t5.left, t5.top)).bind((e5) => {
            return EE(Bu(n4 = e5).map((e6) => _E(n4, e6).positions.concat(e6)).getOr([]), t4);
            var n4;
          }))(t3, n3).orThunk(() => le(n3.getClientRects()).bind((n4) => xE(SE(e3, Vi.before(t3)), n4.left))).getOr(Vi.before(t3)))(a2, n2, s2);
          return wk(e2, t2, o3), true;
        }
        if (t2 && yk(o2, s2)) {
          const o3 = ((e3, t3, n3) => ((e4, t4) => de(t4.getClientRects()).bind((t5) => hk(e4, t5.left, t5.top)).bind((e5) => {
            return EE(Ou(n4 = e5).map((e6) => [e6].concat(kE(n4, e6).positions)).getOr([]), t4);
            var n4;
          }))(t3, n3).orThunk(() => le(n3.getClientRects()).bind((n4) => xE(NE(e3, Vi.after(t3)), n4.left))).getOr(Vi.after(t3)))(a2, n2, s2);
          return wk(e2, t2, o3), true;
        }
        return false;
      }, Ek = (e2, t2, n2) => I.from(e2.dom.getParent(e2.selection.getNode(), "td,th")).bind((o2) => I.from(e2.dom.getParent(o2, "table")).map((r2) => n2(e2, t2, r2, o2))).getOr(false), _k = (e2, t2) => Ek(e2, t2, Ck), kk = (e2, t2) => Ek(e2, t2, xk), Sk = (e2, t2, n2) => n2.fold(I.none, I.none, (e3, t3) => {
        return (n3 = t3, Zn(n3, Fg)).map((e4) => ((e5) => {
          const t4 = xf.exact(e5, 0, e5, 0);
          return Nf(t4);
        })(e4));
        var n3;
      }, (n3) => (e2.execCommand("mceTableInsertRowAfter"), Nk(e2, t2, n3))), Nk = (e2, t2, n2) => {
        return Sk(e2, t2, (r2 = oo, fk(o2 = n2, void 0).fold(() => dk.none(o2), (e3) => mk(e3.all, o2, e3.index, 1, r2))));
        var o2, r2;
      }, Rk = (e2, t2, n2) => {
        return Sk(e2, t2, (r2 = oo, fk(o2 = n2, void 0).fold(() => dk.none(), (e3) => mk(e3.all, o2, e3.index, -1, r2))));
        var o2, r2;
      }, Ak = (e2, t2) => {
        ...
        return ((e3, t3) => ((e4, t4, n3 = L) => n3(t4) ? I.none() : H(e4, Ht(t4)) ? I.some(t4) : eo(t4, e4.join(","), (e5) => xn(e5, "table") || n3(e5)))(["td", "th"], e3, t3))(yn(t2 ? s2.endContainer : s2.startContainer), r2).map((n3) => (uk(n3, r2).each((t3) => {
          e2.model.table.clearSelectedCells(t3.dom);
        }), e2.selection.collapse(!t2), (t2 ? Nk : Rk)(e2, r2, n3).each((t3) => {
          e2.selection.setRng(t3);
        }), true)).getOr(false);
      }, Tk = (e2, t2) => ({ container: e2, offset: t2 }), Ok = za.DOM, Bk = (e2) => (t2) => e2 === t2 ? -1 : 0, Pk = (e2, t2, n2) => {
        if (er(e2) && t2 >= 0) return I.some(Tk(e2, t2));
        {
          const o2 = hi(Ok);
          return I.from(o2.backwards(e2, t2, Bk(e2), n2)).map((e3) => Tk(e3.container, e3.container.data.length));
        }
      }, Dk = (e2, t2, n2) => {
        if (!er(e2)) return I.none();
        const o2 = e2.data;
        if (t2 >= 0 && t2 <= o2.length) return I.some(Tk(e2, t2));
        {
          const o3 = hi(Ok);
          return I.from(o3.backwards(e2, t2, Bk(e2), n2)).bind((e3) => {
            const o4 = e3.container.data;
            return Dk(e3.container, t2 + o4.length, n2);
          });
        }
      }, Lk = (e2, t2, n2) => {
        if (!er(e2)) return I.none();
        const o2 = e2.data;
        if (t2 <= o2.length) return I.some(Tk(e2, t2));
        {
          const r2 = hi(Ok);
          return I.from(r2.forwards(e2, t2, Bk(e2), n2)).bind((e3) => Lk(e3.container, t2 - o2.length, n2));
        }
      }, Mk = (e2, t2, n2, o2, r2) => {
      ...
      }, Ik = (e2) => Dr(e2.toString().replace(/\u00A0/g, " ")), Fk = (e2) => "" !== e2 && -1 !== "  \f\n\r	\v".indexOf(e2), Uk = (e2, t2) => e2.substring(t2.length), zk = (e2, t2, n2, o2 = 0) => {
        return (r2 = yn(t2.startContainer), no(r2, Ug)).fold(() => ((e3, t3, n3, o3 = 0) => {
          ...
          return Mk(e3, t3.startContainer, t3.startOffset, (e4, t4, o4) => (s2.text = o4 + s2.text, s2.offset += t4, ((e5, t5, n4) => {
            let o5;
            const r4 = n4.charAt(0);
            for (o5 = t5 - 1; o5 >= 0; o5--) {
              const s3 = e5.charAt(o5);
              if (Fk(s3)) return I.none();
            ...
            const s3 = Ik(r4);
            return 0 !== s3.lastIndexOf(n3) || Uk(s3, n3).length < o3 ? I.none() : I.some({ text: Uk(s3, n3), range: r4, trigger: n3 });
          });
        })(e2, t2, n2, o2), (t3) => {
          const o3 = e2.createRng();
          o3.selectNode(t3.dom);
          const r3 = Ik(o3);
          return I.some({ range: o3, text: Uk(r3, n2), trigger: n2 });
        });
        var r2;
      }, jk = (e2) => {
        if (((e3) => 3 === e3.nodeType)(e2)) return Tk(e2, e2.data.length);
        {
          const t2 = e2.childNodes;
          return t2.length > 0 ? jk(t2[t2.length - 1]) : Tk(e2, t2.length);
        }
      }, Hk = (e2, t2) => {
        const n2 = e2.childNodes;
        return n2.length > 0 && t2 < n2.length ? Hk(n2[t2], 0) : n2.length > 0 && ((e3) => 1 === e3.nodeType)(e2) && n2.length === t2 ? jk(n2[n2.length - 1]) : Tk(e2, t2);
      }, $k = (e2, t2, n2, o2 = {}) => {
        var r2;
        const s2 = t2(), a2 = null !== (r2 = e2.selection.getRng().startContainer.nodeValue) && void 0 !== r2 ? r2 : "", i2 = Y(s2.lookupByTrigger(n2.trigger), (t3) => n2.text.length >= t3.minChars && t3.matches.getOrThunk(() => /* @__PURE__ */ ((e3) => (t4) => {
          const n3 = Hk(t4.startContainer, t4.startOffset);
          return !((e4, t5) => {
            var n4;
            const o3 = null !== (n4 = e4.getParent(t5.container, e4.isBlock)) && void 0 !== n4 ? n4 : e4.getRoot();
            return Mk(e4, t5.container, t5.offset, (e5, t6) => 0 === t6 ? -1 : t6, o3).filter((e5) => {
      ...
      const Vk = (e2, t2, n2) => e2.stype === qk.Error ? t2(e2.serror) : n2(e2.svalue), Wk = (e2) => ({ stype: qk.Value, svalue: e2 }), Kk = (e2) => ({ stype: qk.Error, serror: e2 }), Yk = Vk, Gk = (e2) => f(e2) && me(e2).length > 100 ? " removed due to size" : JSON.stringify(e2, null, 2), Xk = (e2, t2) => Kk([{ path: e2, getErrorInfo: t2 }]), Qk = (e2, t2) => ({ extract: (n2, o2) => xe(o2, e2).fold(() => ((e3, t3) => Xk(e3, () => 'Choice schema did not contain choice key: "' + t3 + '"'))(n2, e2), (e3) => ((e4, t3, n3, o3) => xe(n3, o3).fold(() => ((e5, t4, n4) => Xk(e5, () => 'The chosen schema: "' + n4 + '" did not exist in branches: ' + Gk(t4)))(e4, n3, o3), (n4) => n4.extract(e4.concat(["branch: " + o3]), t3)))(n2, o2, t2, e3)), toString: () => "chooseOn(" + e2 + "). Possible values: " + me(t2) }), Jk = (e2) => (...t2) => {
        ...
        return n2;
      }, Zk = Jk((e2, t2) => g(e2) && g(t2) ? Zk(e2, t2) : t2), eS = (Jk((e2, t2) => t2), (e2) => ({ tag: "defaultedThunk", process: N(e2) })), tS = (e2) => {
        const t2 = ((e3) => {
          const t3 = [], n3 = [];
          return V(e3, (e4) => {
            Vk(e4, (e5) => n3.push(e5), (e5) => t3.push(e5));
          }), { values: t3, errors: n3 };
        })(e2);
        return t2.errors.length > 0 ? (n2 = t2.errors, k(Kk, ee)(n2)) : Wk(t2.values);
        var n2;
      }, nS = (e2, t2, n2) => {
        switch (e2.tag) {
          case "field":
        ...
        return o2 = e2(n2), r2 = (e3) => ((e4, t3) => Xk(e4, N(t3)))(t2, e3), o2.stype === qk.Error ? r2(o2.serror) : o2;
        var o2, r2;
      }, toString: N("val") }), rS = oS(Wk), sS = (e2, t2, n2, o2) => o2(xe(e2, t2).getOrThunk(() => n2(e2))), aS = (e2, t2, n2, o2, r2) => {
        const s2 = (e3) => r2.extract(t2.concat([o2]), e3), a2 = (e3) => e3.fold(() => Wk(I.none()), (e4) => {
          const n3 = r2.extract(t2.concat([o2]), e4);
          return s3 = n3, a3 = I.some, s3.stype === qk.Value ? { stype: qk.Value, svalue: a3(s3.svalue) } : s3;
          var s3, a3;
        });
        switch (e2.tag) {
          case "required":
            return ((e3, t3, n3, o3) => xe(t3, n3).fold(() => ((e4, t4, n4) => Xk(e4, () => 'Could not find valid *required* value for "' + t4 + '" in ' + Gk(n4)))(e3, n3, t3), o3))(t2, n2, o2, s2);
          case "defaultedThunk":
            return sS(n2, o2, e2.process, s2);
          case "option":
            return ((e3, t3, n3) => n3(xe(e3, t3)))(n2, o2, a2);
          case "defaultedOptionThunk":
            return ((e3, t3, n3, o3) => o3(xe(e3, t3).map((t4) => true === t4 ? n3(e3) : t4)))(n2, o2, e2.process, a2);
          case "mergeWithThunk":
            return sS(n2, o2, N({}), (t3) => {
              const o3 = Zk(e2.process(n2), t3);
              return s2(o3);
            });
        }
      }, iS = (e2) => ({ extract: (t2, n2) => ((e3, t3, n3) => {
        const o2 = {}, r2 = [];
        for (const s2 of n3) nS(s2, (n4, s3, a2, i2) => {
          const l2 = aS(a2, e3, t3, n4, i2);
          Yk(l2, (e4) => {
            r2.push(...e4);
          }, (e4) => {
            o2[s3] = e4;
        ...
        return r2.length > 0 ? Kk(r2) : Wk(o2);
      })(t2, n2, e2), toString: () => {
        const t2 = q(e2, (e3) => nS(e3, (e4, t3, n2, o2) => e4 + " -> " + o2.toString(), (e4, t3) => "state(" + e4 + ")"));
        return "obj{\n" + t2.join("\n") + "}";
      } }), lS = (e2) => ({ extract: (t2, n2) => {
        const o2 = q(n2, (n3, o3) => e2.extract(t2.concat(["[" + o3 + "]"]), n3));
        return tS(o2);
      }, toString: () => "array(" + e2.toString() + ")" }), dS = (e2, t2, n2) => {
        return o2 = ((e3, t3, n3) => ((e4, t4) => e4.stype === qk.Error ? { stype: qk.Error, serror: t4(e4.serror) } : e4)(t3.extract([e3], n3), (e4) => ({ input: n3, errors: e4 })))(e2, t2, n2), Vk(o2, pl.error, pl.value);
        var o2;
      }, cS = (e2, t2) => Qk(e2, pe(t2, iS)), uS = N(rS), mS = (e2, t2) => oS((n2) => {
        const o2 = typeof n2;
        return e2(n2) ? Wk(n2) : Kk(`Expected type: ${t2} but got: ${o2}`);
      }), fS = mS(x, "number"), gS = mS(m, "string"), pS = mS(b, "boolean"), hS = mS(w, "function"), bS = (e2, t2, n2, o2) => ({ tag: "field", key: e2, newKey: t2, presence: n2, prop: o2 }), vS = (e2, t2) => ({ tag: "custom", newKey: e2, instantiator: t2 }), yS = (e2, t2) => bS(e2, e2, { tag: "required", process: {} }, t2), CS = (e2) => yS(e2, gS), wS = (e2) => yS(e2, hS), xS = (e2, t2) => bS(e2, e2, { tag: "option", process: {} }, t2), ES = (e2) => xS(e2, gS), _S = (e2, t2, n2) => bS(e2, e2, eS(t2), n2), kS = (e2, t2) => _S(e2, t2, fS), SS = (e2, t2, n2) => _S(e2, t2, ((e3) => {
        return t3 = (t4) => H(e3, t4) ? pl.value(t4) : pl.error(`Unsupported value: "${t4}", choose one of "${e3.join(", ")}".`), oS((e4) => t3(e4).fold(Kk, Wk));
        var t3;
      })(n2)), NS = (e2, t2) => _S(e2, t2, pS), RS = (e2, t2) => _S(e2, t2, hS), AS = CS("type"), TS = wS("fetch"), OS = wS("onAction"), BS = RS("onSetup", () => _), PS = ES("text"), DS = ES("icon"), LS = ES("tooltip"), MS = ES("label"), IS = NS("active", false), FS = NS("enabled", true), US = NS("primary", false), zS = (e2) => ((e3, t2) => _S("type", t2, gS))(0, e2), jS = iS([AS, CS("trigger"), kS("minChars", 1), (1, ((e2, t2) => bS(e2, e2, eS(1), uS()))("columns")), kS("maxResults", 10), ("matches", xS("matches", hS)), TS, OS, (HS = gS, _S("highlightOn", [], lS(HS)))]);
      var HS;
      const $S = [FS, LS, DS, PS, BS], qS = [IS].concat($S), VS = [RS("predicate", L), SS("scope", "node", ["node", "editor"]), SS("position", "selection", ["node", "selection", "line"])], WS = $S.concat([zS("contextformbutton"), US, OS, vS("original", R)]), KS = qS.concat([zS("contextformbutton"), US, OS, vS("original", R)]), YS = $S.concat([zS("contextformbutton")]), GS = qS.concat([zS("contextformtogglebutton")]), XS = cS("type", { contextformbutton: WS, contextformtogglebutton: KS });
      iS([zS("contextform"), RS("initValue", N("")), MS, ((e2, t2) => bS(e2, e2, { tag: "required", process: {} }, lS(t2)))("commands", XS), xS("launch", cS("type", { contextformbutton: YS, contextformtogglebutton: GS }))].concat(VS));
      const QS = (e2) => {
        const t2 = e2.ui.registry.getAll().popups, n2 = pe(t2, (e3) => {
          return (t3 = e3, dS("Autocompleter", jS, { trigger: t3.ch, ...t3 })).fold((e4) => {
            ...
            })((t4 = e4).errors).join("\n") + "\n\nInput object: " + Gk(t4.input));
            var t4;
          }, R);
          var t3;
        }), o2 = ke(Ce(n2, (e3) => e3.trigger)), r2 = we(n2);
        return { dataset: n2, triggers: o2, lookupByTrigger: (e3) => Y(r2, (t3) => t3.trigger === e3) };
      }, JS = (e2) => {
        const t2 = Xa(), n2 = $a(false), o2 = t2.isSet, r2 = () => {
          o2() && (((e3) => {
            JC(e3).autocompleter.removeDecoration();
          })(e2), ((e3) => {
            e3.dispatch("AutocompleterEnd");
          })(e2), n2.set(false), t2.clear());
        }, s2 = De(() => QS(e2)), a2 = (a3) => {
          ((n3) => t2.get().map((t3) => zk(e2.dom, e2.selection.getRng(), t3.trigger).bind((t4) => $k(e2, s2, t4, n3))).getOrThunk(() => ((e3, t3) => {
            const n4 = t3(), o3 = e3.selection.getRng();
            return ((e4, t4, n5) => ue(n5.triggers, (n6) => zk(e4, t4, n6)))(e3.dom, o3, n4).bind((n5) => $k(e3, t3, n5));
          })(e2, s2)))(a3).fold(r2, (s3) => {
            ((n3) => {
              o2() || (((e3, t3) => {
                JC(e3).autocompleter.addDecoration(t3);
      ...
      }, ZS = xt().browser.isSafari(), eN = (e2) => Or(yn(e2)), tN = (e2, t2) => {
        var n2;
        return 0 === e2.startOffset && e2.endOffset === (null === (n2 = t2.textContent) || void 0 === n2 ? void 0 : n2.length);
      }, nN = (e2, t2) => I.from(e2.getParent(t2.container(), "details")), oN = (e2, t2) => nN(e2, t2).isSome(), rN = (e2, t2) => {
        const n2 = t2.getNode();
        ...
        if (o2 && !o2.open) {
          ...
          t3 && (n2 ? Ou(t3) : Bu(t3)).each((t4) => rN(e2, t4));
        } else rN(e2, t2);
      }, aN = (e2, t2, n2) => {
        const { dom: o2, selection: r2 } = e2, s2 = e2.getBody();
        if ("character" === n2) {
          const n3 = Vi.fromRangeStart(r2.getRng()), a2 = o2.getParent(n3.container(), o2.isBlock), i2 = nN(o2, n3), l2 = a2 && o2.isEmpty(a2), d2 = h(null == a2 ? void 0 : a2.previousSibling), c2 = h(null == a2 ? void 0 : a2.nextSibling);
          return !!(l2 && (t2 ? c2 : d2) && Su(!t2, s2, n3).exists((e3) => oN(o2, e3) && !Lt(i2, nN(o2, e3)))) || Su(t2, s2, n3).fold(L, (n4) => {
            const r3 = nN(o2, n4);
            if (oN(o2, n4) && !Lt(i2, r3)) {
              if (t2 || sN(e2, n4, false), a2 && l2) {
                if (t2 && d2) return true;
                if (!t2 && c2) return true;
                sN(e2, n4, t2), e2.dom.remove(a2);
              }
              return true;
            }
            return false;
        ...
        return I.none();
      })(e3.dom, e3.selection.getRng()).fold(() => aN(e3, t3, n3), (o2) => iN(e3, o2, t3, n3) || aN(e3, t3, n3)))(e2, t2, n2) || ZS && ((e3, t3, n3) => {
        const o2 = e3.selection, r2 = o2.getNode(), s2 = o2.getRng(), a2 = Vi.fromRangeStart(s2);
        return !!pr(r2) && ("selection" === n3 && tN(s2, r2) || Oh(t3, a2, r2) ? eN(r2) : e3.undoManager.transact(() => {
          const s3 = o2.getSel();
          ...
          u2(r2, m2), r2.appendChild(m2), c2(), "word" !== n3 && "line" !== n3 || null == s3 || s3.modify("extend", t3 ? "right" : "left", n3), !o2.isCollapsed() && tN(o2.getRng(), m2) ? eN(r2) : (e3.execCommand(t3 ? "ForwardDelete" : "Delete"), a3 = null == s3 ? void 0 : s3.anchorNode, i2 = null == s3 ? void 0 : s3.anchorOffset, l2 = null == s3 ? void 0 : s3.focusNode, d2 = null == s3 ? void 0 : s3.focusOffset, u2(m2, r2), c2()), e3.dom.remove(m2);
        }), true);
      })(e2, t2, n2) ? I.some(_) : I.none(), dN = (e2) => (t2, n2, o2 = {}) => {
      ...
      }, cN = dN("input"), uN = dN("beforeinput"), mN = xt(), fN = mN.os, gN = fN.isMacOS() || fN.isiOS(), pN = mN.browser.isFirefox(), hN = (e2, t2) => {
        ...
        return r2 !== n2 ? o2 : n2;
      }, vN = (e2) => I.from(e2.dom.getParent(e2.selection.getStart(true), e2.dom.isBlock)), yN = (e2) => {
        ...
        return CN(e2, f2), yN(g2), f2;
      }, xN = (e2, t2) => {
        const n2 = null == e2 ? void 0 : e2.parentNode;
        return C(n2) && n2.nodeName === t2;
      }, EN = (e2) => C(e2) && /^(OL|UL|LI)$/.test(e2.nodeName), _N = (e2) => C(e2) && /^(LI|DT|DD)$/.test(e2.nodeName), kN = (e2) => {
        const t2 = e2.parentNode;
        return _N(t2) ? t2 : e2;
      }, SN = (e2, t2, n2) => {
        ...
        return o2 === t2;
      }, NN = (e2) => X(Ce(fo(yn(e2)), (e3, t2) => `${t2}: ${e3};`), (e3, t2) => e3 + t2, ""), RN = (e2, t2) => t2 && "A" === t2.nodeName && e2.isEmpty(t2), AN = (e2, t2) => e2.nodeName === t2 || e2.previousSibling && e2.previousSibling.nodeName === t2, TN = (e2, t2) => C(t2) && e2.isBlock(t2) && !/^(TD|TH|CAPTION|FORM)$/.test(t2.nodeName) && !/^(fixed|absolute)/i.test(t2.style.position) && e2.isEditable(t2.parentNode) && "false" !== e2.getContentEditable(t2), ON = (e2, t2, n2) => er(t2) ? e2 ? 1 === n2 && t2.data.charAt(n2 - 1) === Br ? 0 : n2 : n2 === t2.data.length - 1 && t2.data.charAt(n2) === Br ? t2.data.length : n2 : n2, BN = { insert: (e2, t2) => {
        let n2, o2, r2, s2, a2 = false;
        const i2 = e2.dom, l2 = e2.schema.getNonEmptyElements(), d2 = e2.selection.getRng(), c2 = Il(e2), u2 = yn(d2.startContainer), f2 = In(u2, d2.startOffset), g2 = f2.exists((e3) => Vt(e3) && !oo(e3)), p2 = d2.collapsed && g2, b2 = (t3, o3) => wN(e2, n2, k2, _2, Hl(e2), t3, o3), v2 = (e3) => {
          const t3 = ON(e3, n2, o2);
          if (er(n2) && (e3 ? t3 > 0 : t3 < n2.data.length)) return false;
          if (n2.parentNode === k2 && a2 && !e3) return true;
          if (e3 && qo(n2) && n2 === k2.firstChild) return true;
          if (AN(n2, "TABLE") || AN(n2, "HR")) return a2 && !e3 || !a2 && e3;
          const r3 = new jo(n2, k2);
          let s3;
          ...
          let t3;
          return t3 = /^(H[1-6]|PRE|FIGURE)$/.test(r2) && "HGROUP" !== S2 ? b2(c2) : b2(), ((e3, t4) => {
            const n3 = $l(e3);
            return !y(t4) && (m(n3) ? H(Pt.explode(n3), t4.nodeName.toLowerCase()) : n3);
          })(e2, s2) && TN(i2, s2) && i2.isEmpty(k2, void 0, { includeZwsp: true }) ? t3 = i2.split(s2, k2) : i2.insertAfter(t3, k2), hN(e2, t3), t3;
        };
        Mf(i2, d2).each((e3) => {
        ...
        x2 || (n2 = ((e3, t3, n3, o3, r3) => {
          var s3, a3;
          const i3 = e3.dom, l3 = null !== (s3 = bN(i3, o3)) && void 0 !== s3 ? s3 : i3.getRoot();
          let d3 = i3.getParent(o3, i3.isBlock);
          if (!d3 || !TN(i3, d3)) {
            if (d3 = d3 || l3, !d3.hasChildNodes()) {
              const o4 = i3.create(t3);
              return CN(e3, o4), d3.appendChild(o4), n3.setStart(o4, 0), n3.setEnd(o4, 0), o4;
            }
            let s4, c3 = o3;
            ...
            if (s4 && u3 && e3.schema.isValidChild(u3, t3.toLowerCase())) {
              ...
              for (CN(e3, l4), a4.insertBefore(l4, s4), c3 = s4; c3 && !i3.isBlock(c3); ) {
        ...
        let k2 = i2.getParent(n2, i2.isBlock) || i2.getRoot();
        s2 = C(null == k2 ? void 0 : k2.parentNode) ? i2.getParent(k2.parentNode, i2.isBlock) : null, r2 = k2 ? k2.nodeName.toUpperCase() : "";
        const S2 = s2 ? s2.nodeName.toUpperCase() : "";
        if ("LI" !== S2 || E2 || (k2 = s2, s2 = s2.parentNode, r2 = S2), qo(s2) && ((e3, t3, n3) => !t3 && n3.nodeName.toLowerCase() === Il(e3) && e3.dom.isEmpty(n3) && ((t4, n4, o3) => {
          let r3 = n4;
          ...
          var s3;
          return false;
        })(e3.getBody(), n3))(e2, x2, k2)) return ((e3, t3, n3) => {
          var o3, r3, s3;
          const a3 = t3(Il(e3)), i3 = ((e4, t4) => e4.dom.getParent(t4, gr))(e3, n3);
          i3 && (e3.dom.insertAfter(a3, i3), hN(e3, a3), (null !== (s3 = null === (r3 = null === (o3 = n3.parentElement) || void 0 === o3 ? void 0 : o3.childNodes) || void 0 === r3 ? void 0 : r3.length) && void 0 !== s3 ? s3 : 0) > 1 && e3.dom.remove(n3));
        })(e2, b2, k2);
        if (/^(LI|DT|DD)$/.test(r2) && qo(s2) && i2.isEmpty(k2)) return void ((e3, t3, n3, o3, r3) => {
          const s3 = e3.dom, a3 = e3.selection.getRng(), i3 = n3.parentNode;
          if (n3 === e3.getBody() || !i3) return;
          var l3;
          EN(l3 = n3) && EN(l3.parentNode) && (r3 = "LI");
          const d3 = _N(o3) ? NN(o3) : void 0;
          let c3 = _N(o3) && d3 ? t3(r3, { style: NN(o3) }) : t3(r3);
          if (SN(n3, o3, true) && SN(n3, o3, false)) if (xN(n3, "LI")) {
            const e4 = kN(n3);
          ...
          else if (SN(n3, o3, true)) xN(n3, "LI") ? (s3.insertAfter(c3, kN(n3)), c3.appendChild(s3.doc.createTextNode(" ")), c3.appendChild(n3)) : i3.insertBefore(c3, n3), s3.remove(o3);
          else if (SN(n3, o3, false)) s3.insertAfter(c3, kN(n3)), s3.remove(o3);
          else {
            n3 = kN(n3);
        ...
        if (!(p2 || k2 !== e2.getBody() && TN(i2, k2))) return;
        const N2 = k2.parentNode;
        let R2;
        if (p2) R2 = b2(c2), f2.fold(() => {
        ...
        else if (Ir(k2)) R2 = Vr(k2), i2.isEmpty(k2) && yN(k2), CN(e2, R2), hN(e2, R2);
        else if (v2(false)) R2 = w2();
        else if (v2(true) && N2) {
          R2 = N2.insertBefore(b2(), k2);
          const t3 = yn(d2.startContainer).dom.hasChildNodes() && d2.collapsed;
          hN(e2, AN(k2, "HR") || t3 ? R2 : k2);
        } else {
          const t3 = ((e3) => {
            const t4 = e3.cloneRange();
            return t4.setStart(e3.startContainer, ON(true, e3.startContainer, e3.startOffset)), t4.setEnd(e3.endContainer, ON(false, e3.endContainer, e3.endOffset)), t4;
          })(d2).cloneRange();
          t3.setEndAfter(k2);
          ...
          ((e3) => {
          ...
          })(n3), R2 = n3.firstChild, i2.insertAfter(n3, k2), ((e3, t4, n4) => {
            var o3;
            const r3 = [];
            if (!n4) return;
            let s3 = n4;
            ...
            let a3 = r3.length;
            for (; a3--; ) s3 = r3[a3], (!s3.hasChildNodes() || s3.firstChild === s3.lastChild && "" === (null === (o3 = s3.firstChild) || void 0 === o3 ? void 0 : o3.nodeValue) || RN(e3, s3)) && e3.remove(s3);
          })(i2, l2, R2), ((e3, t4) => {
            t4.normalize();
            const n4 = t4.lastChild;
            (!n4 || qo(n4) && /^(left|right)$/gi.test(e3.getStyle(n4, "float", true))) && e3.add(t4, "br");
          })(i2, k2), i2.isEmpty(k2) && yN(k2), R2.normalize(), i2.isEmpty(R2) ? (i2.remove(R2), w2()) : (CN(e2, R2), hN(e2, R2));
        }
        i2.setAttrib(R2, "id", ""), e2.dispatch("NewBlock", { newBlock: R2 });
      }, fakeEventName: "insertParagraph" }, PN = (e2, t2, n2) => {
        ...
        MN(e2.getBody(), t2) || ho(yn(t2), bn("br"));
        const n2 = bn("br");
        ho(yn(t2), n2), PN(e2, n2.dom, false), e2.undoManager.add();
      }, MN = (e2, t2) => {
        return n2 = Vi.after(t2), !!ar(n2.getNode()) || Au(e2, Vi.after(t2)).map((e3) => ar(e3.getNode())).getOr(false);
        var n2;
      }, IN = (e2) => e2 && "A" === e2.nodeName && "href" in e2, FN = (e2) => e2.fold(L, IN, IN, L), UN = (e2, t2) => {
        t2.fold(_, T(DN, e2), T(LN, e2), _);
      }, zN = { insert: (e2, t2) => {
        const n2 = ((e3) => {
          const t3 = T(Ch, e3), n3 = Vi.fromRangeStart(e3.selection.getRng());
          return iE(t3, e3.getBody(), n3).filter(FN);
        })(e2);
        n2.isSome() ? n2.each(T(UN, e2)) : ((e3, t3) => {
          ...
          "LI" !== u2 || m2 || (d2 = c2), er(l2) && i2 >= l2.data.length && (((e4, t4, n4) => {
            ...
            return false;
          })(e3.schema, l2, d2 || o2.getRoot()) || (s2 = o2.create("br"), r2.insertNode(s2), r2.setStartAfter(s2), r2.setEndAfter(s2), a2 = true)), s2 = o2.create("br"), Ki(o2, r2, s2), PN(e3, s2, a2), e3.undoManager.add();
        })(e2, t2);
      }, fakeEventName: "insertLineBreak" }, jN = (e2, t2) => vN(e2).filter((e3) => t2.length > 0 && xn(yn(e3), t2)).isSome(), HN = hl([{ br: [] }, { block: [] }, { none: [] }]), $N = (e2, t2) => ((e3) => jN(e3, jl(e3)))(e2), qN = (e2) => (t2, n2) => ((e3) => vN(e3).filter((e4) => Sr(yn(e4))).isSome())(t2) === e2, VN = (e2, t2) => (n2, o2) => {
        const r2 = ((e3) => vN(e3).fold(N(""), (e4) => e4.nodeName.toUpperCase()))(n2) === e2.toUpperCase();
        return r2 === t2;
      }, WN = (e2) => {
        const t2 = bN(e2.dom, e2.selection.getStart());
        return y(t2);
      }, KN = (e2) => VN("pre", e2), YN = (e2) => (t2, n2) => Ml(t2) === e2, GN = (e2, t2) => ((e3) => jN(e3, zl(e3)))(e2), XN = (e2, t2) => t2, QN = (e2) => {
        const t2 = Il(e2), n2 = bN(e2.dom, e2.selection.getStart());
      ...
      }, ZN = (e2, t2) => (n2, o2) => X(e2, (e3, t3) => e3 && t3(n2, o2), true) ? I.some(t2) : I.none(), eR = (e2, t2, n2) => {
        t2.selection.isCollapsed() || ((e3) => {
          e3.execCommand("delete");
        })(t2), C(n2) && uN(t2, e2.fakeEventName).isDefaultPrevented() || (e2.insert(t2, n2), C(n2) && cN(t2, e2.fakeEventName));
      }, tR = (e2, t2) => {
        const n2 = () => eR(zN, e2, t2), o2 = () => eR(BN, e2, t2), r2 = ((e3, t3) => Qx([ZN([$N], HN.none()), ZN([KN(true), WN], HN.none()), ZN([VN("summary", true)], HN.br()), ZN([KN(true), YN(false), XN], HN.br()), ZN([KN(true), YN(false)], HN.block()), ZN([KN(true), YN(true), XN], HN.block()), ZN([KN(true), YN(true)], HN.br()), ZN([qN(true), XN], HN.br()), ZN([qN(true)], HN.block()), ZN([GN], HN.br()), ZN([XN], HN.br()), ZN([QN], HN.block()), ZN([JN], HN.block())], [e3, !(!t3 || !t3.shiftKey)]).getOr(HN.none()))(e2, t2);
        switch (Ul(e2)) {
          case "linebreak":
            r2.fold(n2, n2, _);
            break;
      ...
      }, nR = xt(), oR = nR.os.isiOS() && nR.browser.isSafari(), rR = (e2, t2) => {
        var n2;
        t2.isDefaultPrevented() || (t2.preventDefault(), (n2 = e2.undoManager).typing && (n2.typing = false, n2.add()), e2.undoManager.transact(() => {
          tR(e2, t2);
        }));
      }, sR = xt(), aR = (e2) => e2.stopImmediatePropagation(), iR = (e2) => e2.keyCode === af.PAGE_UP || e2.keyCode === af.PAGE_DOWN, lR = (e2, t2, n2) => {
        n2 && !e2.get() ? t2.on("NodeChange", aR, true) : !n2 && e2.get() && t2.off("NodeChange", aR), e2.set(n2);
      }, dR = (e2, t2) => {
        const n2 = t2.container(), o2 = t2.offset();
        ...
        if (e2.selection.isCollapsed()) {
          ...
          return iE(o2, e2.getBody(), r2).bind(/* @__PURE__ */ ((e3) => (t3) => t3.fold((t4) => Tu(e3.dom, Vi.before(t4)), (e4) => Ou(e4), (e4) => Bu(e4), (t4) => Au(e3.dom, Vi.after(t4))))(n2)).map((o3) => () => (/* @__PURE__ */ ((e3, t3, n3) => (o4) => Zp(e3, o4, n3) ? cR(t3) : uR(t3))(n2, t2, e2.schema))(o3).each(mR(e2)));
        }
        return I.none();
      }, gR = (e2) => {
        return It(At.browser.isFirefox() && e2.selection.isEditable() && (t2 = e2.dom, n2 = e2.selection.getRng().startContainer, t2.isEditable(t2.getParent(n2, "summary"))), () => {
          ...
          e2.selection.isCollapsed() || e2.getDoc().execCommand("Delete"), ((e3, t4, n3) => Zp(e3, t4, n3) ? cR(t4) : uR(t4))(t3, Vi.fromRangeStart(e2.selection.getRng()), e2.schema).each(mR(e2));
        });
        var t2, n2;
      }, pR = (e2) => hc(e2) ? [{ keyCode: af.TAB, action: nk(Ak, e2, true) }, { keyCode: af.TAB, shiftKey: true, action: nk(Ak, e2, false) }] : [], hR = (e2) => {
        if (e2.addShortcut("Meta+P", "", "mcePrint"), JS(e2), XC(e2)) return $a(null);
        {
          const t2 = o_(e2);
          return ((e3) => {
            ...
            e3.on("keyup compositionstart", T(q_, e3));
          })(e2), ((e3, t3) => {
            e3.on("keydown", (n2) => {
              n2.isDefaultPrevented() || ((e4, t4, n3) => {
                const o2 = At.os.isMacOS() || At.os.isiOS();
                ok([{ keyCode: af.RIGHT, action: nk(K_, e4, true) }, { keyCode: af.LEFT, action: nk(K_, e4, false) }, { keyCode: af.UP, action: nk(Y_, e4, false) }, { keyCode: af.DOWN, action: nk(Y_, e4, true) }, ...o2 ? [{ keyCode: af.UP, action: nk(X_, e4, false), metaKey: true, shiftKey: true }, { keyCode: af.DOWN, action: nk(X_, e4, true), metaKey: true, shiftKey: true }] : [], { keyCode: af.RIGHT, action: nk(_k, e4, true) }, { keyCode: af.LEFT, action: nk(_k, e4, false) }, { keyCode: af.UP, action: nk(kk, e4, false) }, { keyCode: af.DOWN, action: nk(kk, e4, true) }, { keyCode: af.UP, action: nk(kk, e4, false) }, { keyCode: af.UP, action: nk(Z_, e4, false) }, { keyCode: af.DOWN, action: nk(Z_, e4, true) }, { keyCode: af.RIGHT, action: nk(sk, e4, true) }, { keyCode: af.LEFT, action: nk(sk, e4, false) }, { keyCode: af.UP, action: nk(ak, e4, false) }, { keyCode: af.DOWN, action: nk(ak, e4, true) }, { keyCode: af.RIGHT, action: nk(t_, e4, t4, true) }, { keyCode: af.LEFT, action: nk(t_, e4, t4, false) }, { keyCode: af.RIGHT, ctrlKey: !o2, altKey: o2, action: nk(r_, e4, t4) }, { keyCode: af.LEFT, ctrlKey: !o2, altKey: o2, action: nk(s_, e4, t4) }, { keyCode: af.UP, action: nk(J_, e4, false) }, { keyCode: af.DOWN, action: nk(J_, e4, true) }], n3).each((e5) => {
                  n3.preventDefault();
                });
              })(e3, t3, n2);
            });
            ...
            e3.on("keydown", (o2) => {
              n2 = o2.keyCode === af.BACKSPACE, o2.isDefaultPrevented() || ((e4, t4, n3) => {
                ...
                rk([{ keyCode: af.BACKSPACE, action: nk(T_, e4) }, { keyCode: af.BACKSPACE, action: nk(Ux, e4, false) }, { keyCode: af.DELETE, action: nk(Ux, e4, true) }, { keyCode: af.BACKSPACE, action: nk(Ox, e4, false) }, { keyCode: af.DELETE, action: nk(Ox, e4, true) }, { keyCode: af.BACKSPACE, action: nk(d_, e4, t4, false) }, { keyCode: af.DELETE, action: nk(d_, e4, t4, true) }, { keyCode: af.BACKSPACE, action: nk(ib, e4, false) }, { keyCode: af.DELETE, action: nk(ib, e4, true) }, { keyCode: af.BACKSPACE, action: nk(lN, e4, false, s2) }, { keyCode: af.DELETE, action: nk(lN, e4, true, s2) }, ...gN ? [{ keyCode: af.BACKSPACE, altKey: true, action: nk(lN, e4, false, a2(true)) }, { keyCode: af.DELETE, altKey: true, action: nk(lN, e4, true, a2(true)) }, { keyCode: af.BACKSPACE, metaKey: true, action: nk(lN, e4, false, a2(false)) }] : [{ keyCode: af.BACKSPACE, ctrlKey: true, action: nk(lN, e4, false, a2(true)) }, { keyCode: af.DELETE, ctrlKey: true, action: nk(lN, e4, true, a2(true)) }], { keyCode: af.BACKSPACE, action: nk(zx, e4, false) }, { keyCode: af.DELETE, action: nk(zx, e4, true) }, { keyCode: af.BACKSPACE, action: nk(x_, e4, false) }, { keyCode: af.DELETE, action: nk(x_, e4, true) }, { keyCode: af.BACKSPACE, action: nk(_x, e4, false) }, { keyCode: af.DELETE, action: nk(_x, e4, true) }, { keyCode: af.BACKSPACE, action: nk(wx, e4, false) }, { keyCode: af.DELETE, action: nk(wx, e4, true) }, { keyCode: af.BACKSPACE, action: nk(v_, e4, false) }, { keyCode: af.DELETE, action: nk(v_, e4, true) }], n3).filter((t5) => e4.selection.isEditable()).each((t5) => {
                  n3.preventDefault(), uN(e4, o3).isDefaultPrevented() || (t5(), cN(e4, o3));
                });
              })(e3, t3, o2);
            }), e3.on("keyup", (t4) => {
              t4.isDefaultPrevented() || ((e4, t5, n3) => {
                ok([{ keyCode: af.BACKSPACE, action: nk(Fx, e4) }, { keyCode: af.DELETE, action: nk(Fx, e4) }, ...gN ? [{ keyCode: af.BACKSPACE, altKey: true, action: nk(C_, e4) }, { keyCode: af.DELETE, altKey: true, action: nk(C_, e4) }, ...n3 ? [{ keyCode: pN ? 224 : 91, action: nk(C_, e4) }] : []] : [{ keyCode: af.BACKSPACE, ctrlKey: true, action: nk(C_, e4) }, { keyCode: af.DELETE, ctrlKey: true, action: nk(C_, e4) }]], t5);
              })(e3, t4, n2), n2 = false;
            });
          })(e2, t2), ((e3) => {
            let t3 = I.none();
            e3.on("keydown", (n2) => {
              n2.keyCode === af.ENTER && (oR && ((e4) => {
              ...
              n2.keyCode === af.ENTER && t3.each(() => ((e4, n3) => {
                e4.undoManager.undo(), t3.fold(_, (t4) => e4.selection.moveToBookmark(t4)), rR(e4, n3), t3 = I.none();
              })(e3, n2));
            });
          })(e2), ((e3) => {
            e3.on("keydown", (t3) => {
              t3.isDefaultPrevented() || ((e4, t4) => {
                rk([{ keyCode: af.SPACEBAR, action: nk(fR, e4) }, { keyCode: af.SPACEBAR, action: nk(gR, e4) }], t4).each((n2) => {
                  t4.preventDefault(), uN(e4, "insertText", { data: " " }).isDefaultPrevented() || (n2(), cN(e4, "insertText", { data: " " }));
                });
              })(e3, t3);
            });
          })(e2), ((e3) => {
            ...
            e3.on("keydown", (n2) => {
              n2.isDefaultPrevented() || ((e4, t4, n3) => {
                const o2 = At.os.isMacOS() || At.os.isiOS();
                ok([{ keyCode: af.END, action: nk(G_, e4, true) }, { keyCode: af.HOME, action: nk(G_, e4, false) }, ...o2 ? [] : [{ keyCode: af.HOME, action: nk(X_, e4, false), ctrlKey: true, shiftKey: true }, { keyCode: af.END, action: nk(X_, e4, true), ctrlKey: true, shiftKey: true }], { keyCode: af.END, action: nk(ik, e4, true) }, { keyCode: af.HOME, action: nk(ik, e4, false) }, { keyCode: af.END, action: nk(a_, e4, true, t4) }, { keyCode: af.HOME, action: nk(a_, e4, false, t4) }], n3).each((e5) => {
                  n3.preventDefault();
                });
              })(e3, t3, n2);
            });
          })(e2, t2), ((e3, t3) => {
            if (sR.os.isMacOS()) return;
            const n2 = $a(false);
            e3.on("keydown", (t4) => {
              iR(t4) && lR(n2, e3, true);
            }), e3.on("keyup", (o2) => {
              o2.isDefaultPrevented() || ((e4, t4, n3) => {
                ok([{ keyCode: af.PAGE_UP, action: nk(a_, e4, false, t4) }, { keyCode: af.PAGE_DOWN, action: nk(a_, e4, true, t4) }], n3);
              })(e3, t3, o2), iR(o2) && n2.get() && (lR(n2, e3, false), e3.nodeChanged());
            });
          })(e2, t2), t2;
        }
      };
      ...
      const vR = ui("image"), yR = ui("event"), CR = (e2) => (t2) => {
        t2[yR] = e2;
      }, wR = CR(0), xR = CR(2), ER = CR(1), _R = (0, (e2) => {
        const t2 = e2;
        return I.from(t2[yR]).exists((e3) => 0 === e3);
      });
      const kR = ui("mode"), SR = (e2) => (t2) => {
        t2[kR] = e2;
      }, NR = (e2, t2) => SR(t2)(e2), RR = SR(0), AR = SR(2), TR = SR(1), OR = (e2) => (t2) => {
        const n2 = t2;
        return I.from(n2[kR]).exists((t3) => t3 === e2);
      }, BR = OR(0), PR = OR(1), DR = ["none", "copy", "link", "move"], LR = ["none", "copy", "copyLink", "copyMove", "link", "linkMove", "move", "all", "uninitialized"], MR = () => {
        ...
        const o2 = { get dropEffect() {
          ...
          return PR(o2) ? Object.freeze({ length: 0, item: (e3) => null }) : e2.files;
        }, get types() {
          return e2.types;
        }, setDragImage: (t3, n3, r2) => {
          var s2;
          BR(o2) && (s2 = { image: t3, x: n3, y: r2 }, o2[vR] = s2, e2.setDragImage(t3, n3, r2));
        }, getData: (t3) => PR(o2) ? "" : e2.getData(t3), setData: (t3, n3) => {
          BR(o2) && e2.setData(t3, n3);
        }, clearData: (t3) => {
          BR(o2) && e2.clearData(t3);
        } };
        return RR(o2), o2;
      }, IR = (e2, t2) => e2.setData("text/html", t2), FR = "x-tinymce/html", UR = N(FR), zR = "<!-- " + FR + " -->", jR = (e2) => zR + e2, HR = (e2) => -1 !== e2.indexOf(zR), $R = "%MCEPASTEBIN%", qR = (e2) => e2.dom.get("mcepastebin"), VR = (e2) => C(e2) && "mcepastebin" === e2.id, WR = (e2) => e2 === $R, KR = (e2, t2) => (Pt.each(t2, (t3) => {
        e2 = u(t3, RegExp) ? e2.replace(t3, "") : e2.replace(t3[0], t3[1]);
      }), e2), YR = (e2) => KR(e2, [/^[\s\S]*<body[^>]*>\s*|\s*<\/body[^>]*>[\s\S]*$/gi, /<!--StartFragment-->|<!--EndFragment-->/g, [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e3, t2, n2) => t2 || n2 ? br : " "], /<br class="Apple-interchange-newline">/g, /<br>$/i]), GR = (e2, t2) => ({ content: e2, cancelled: t2 }), XR = (e2, t2) => (e2.insertContent(t2, { merge: tc(e2), paste: true }), true), QR = (e2) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e2), JR = (e2, t2, n2) => !(e2.selection.isCollapsed() || !QR(t2)) && ((e3, t3, n3) => (e3.undoManager.extra(() => {
        n3(e3, t3);
      }, () => {
        e3.execCommand("mceInsertLink", false, t3);
      }), true))(e2, t2, n2), ZR = (e2, t2, n2) => !!((e3, t3) => QR(t3) && $(pc(e3), (e4) => $e(t3.toLowerCase(), `.${e4.toLowerCase()}`)))(e2, t2) && ((e3, t3, n3) => (e3.undoManager.extra(() => {
        n3(e3, t3);
      }, () => {
        e3.insertContent('<img src="' + t3 + '">');
      }), true))(e2, t2, n2), eA = /* @__PURE__ */ ((e2) => {
        let t2 = 0;
        return () => "mceclip" + t2++;
      })(), tA = (e2) => {
        const t2 = MR();
        return IR(t2, e2), AR(t2), t2;
      }, nA = (e2, t2, n2, o2, r2) => {
        const s2 = ((e3, t3, n3) => ((e4, t4, n4) => {
          const o3 = ((e5, t5, n5) => e5.dispatch("PastePreProcess", { content: t5, internal: n5 }))(e4, t4, n4), r3 = ((e5, t5) => {
            const n5 = bC({ sanitize: fc(e5), sandbox_iframes: Cc(e5) }, e5.schema);
          ...
          return e4.hasEventListeners("PastePostProcess") && !o3.isDefaultPrevented() ? ((e5, t5, n5) => {
            ...
            return GR(r4.node.innerHTML, r4.isDefaultPrevented());
          })(e4, r3, n4) : GR(r3, o3.isDefaultPrevented());
        })(e3, t3, n3))(e2, t2, n2);
        if (!s2.cancelled) {
          const t3 = s2.content, n3 = () => ((e3, t4, n4) => {
            n4 || !nc(e3) ? XR(e3, t4) : ((e4, t5) => {
              Pt.each([JR, ZR, XR], (n5) => !n5(e4, t5, XR));
            })(e3, t4);
          })(e2, t3, o2);
          r2 ? uN(e2, "insertFromPaste", { dataTransfer: tA(t3) }).isDefaultPrevented() || (n3(), cN(e2, "insertFromPaste")) : n3();
        }
      }, oA = (e2, t2, n2, o2) => {
        const r2 = n2 || HR(t2);
        nA(e2, ((e3) => e3.replace(zR, ""))(t2), r2, false, o2);
      }, rA = (e2, t2, n2) => {
        ...
        return t2;
      }, aA = (e2, t2) => t2 in e2 && e2[t2].length > 0, iA = (e2) => aA(e2, "text/html") || aA(e2, "text/plain"), lA = (e2, t2, n2) => {
              ...
              ((e3, t5) => {
                Kv(t5.uri).each(({ data: n3, type: o3, base64Encoded: r3 }) => {
                  const s3 = r3 ? n3 : btoa(n3), a2 = t5.file, i2 = e3.editorUpload.blobCache, l2 = i2.getByData(s3, o3), d2 = null != l2 ? l2 : ((e4, t6, n4, o4) => {
                    const r4 = eA(), s4 = Vl(e4) && C(n4.name), a3 = s4 ? ((e5, t7) => {
                  ...
                  oA(e3, `<img src="${d2.blobUri()}">`, false, true);
                });
              })(e2, t4);
            });
          }), true;
        ...
        let s2 = YR(n2);
        const a2 = aA(t2, UR()) || HR(n2), i2 = !a2 && ((e3) => !/<(?:\/?(?!(?:div|p|br|span)>)\w+|(?:(?!(?:span style="white-space:\s?pre;?">)|br\s?\/>))\w+\s[^>]+)>/i.test(e3))(s2), l2 = QR(s2);
        (WR(s2) || !s2.length || i2 && !l2) && (o2 = true), (o2 || l2) && (s2 = aA(t2, "text/plain") && i2 ? t2["text/plain"] : ((e3) => {
          const t3 = ua(), n3 = bC({}, t3);
          let o3 = "";
          ...
          return e3 = KR(e3, [/<!\[[^\]]+\]>/g]), i3(n3.parse(e3)), o3;
        })(s2)), WR(s2) || (o2 ? rA(e2, s2, r2) : oA(e2, s2, a2, r2));
      }, cA = (e2, t2, n2) => {
        ((e3, t3, n3) => {
          let o2;
          e3.on("keydown", (e4) => {
            ...
            o2 = false;
            const a2 = sA(r2.clipboardData);
            !iA(a2) && lA(e3, r2, t3.getLastRng() || e3.selection.getRng()) || (aA(a2, "text/html") ? (r2.preventDefault(), dA(e3, a2, a2["text/html"], s2, true)) : aA(a2, "text/plain") && aA(a2, "text/uri-list") ? (r2.preventDefault(), dA(e3, a2, a2["text/plain"], s2, true)) : (t3.create(), vg.setEditorTimeout(e3, () => {
              const n4 = t3.getHtml();
              t3.remove(), dA(e3, a2, n4, s2, false);
            }, 0)));
          });
        })(e2, t2, n2), ((e3) => {
        ...
        ((e3, t3, n3) => {
          if (!e3) return false;
          try {
            return e3.clearData(), e3.setData("text/html", t3), e3.setData("text/plain", n3), e3.setData(UR(), t3), true;
          } catch (e4) {
            return false;
          }
      ...
      }, fA = (e2) => ({ html: jR(e2.selection.getContent({ contextual: true })), text: e2.selection.getContent({ format: "text" }) }), gA = (e2) => !e2.selection.isCollapsed() || ((e3) => !!e3.dom.getParent(e3.selection.getStart(), "td[data-mce-selected],th[data-mce-selected]", e3.getBody()))(e2), pA = (e2, t2) => {
        var n2, o2;
      ...
      }, bA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi, vA = (e2) => Pt.trim(e2).replace(bA, Ca).toLowerCase(), yA = (e2, t2, n2) => {
        const o2 = Zd(e2);
        ...
        if (r2 && "none" !== o2) {
          ...
          t2 = t2.replace(/(<[^>]+) style="([^"]*)"([^>]*>)/gi, (e3, t3, s2, a2) => {
            ...
            for (let e4 = 0; e4 < r2.length; e4++) {
              ...
              /color/.test(r2[e4]) && (s3 = vA(s3), a3 = vA(a3)), a3 !== s3 && (l2[r2[e4]] = t4);
            }
        ...
        const t2 = $a(false), n2 = $a(oc(e2) ? "text" : "html"), o2 = ((e3) => {
          ...
          return { create: () => ((e4, t4) => {
            ...
            t4.set(o3.getRng());
            const s2 = n3.add(e4.getBody(), "div", { id: "mcepastebin", class: "mce-pastebin", contentEditable: true, "data-mce-bogus": "all", style: "position: fixed; top: 50%; width: 10px; height: 10px; overflow: hidden; opacity: 0" }, $R);
            ...
            if (qR(e4)) {
              let o3;
              const r2 = t4.get();
              for (; o3 = qR(e4); ) n3.remove(o3), n3.unbind(o3);
              r2 && e4.selection.setRng(r2);
            }
            t4.set(null);
          })(e3, t3), getEl: () => qR(e3), getHtml: () => ((e4) => {
            const t4 = e4.dom, n3 = (e5, n4) => {
              e5.appendChild(n4), t4.remove(n4, true);
            }, [o3, ...r2] = Y(e4.getBody().childNodes, VR);
            V(r2, (e5) => {
              n3(o3, e5);
            });
        ...
        ((e3) => {
          ...
          e3.addCommand("mceTogglePlainTextPaste", () => {
            ...
            n3.html && oA(e3, n3.html, n3.internal, false), n3.text && rA(e3, n3.text, false);
          });
        })(e2, n2), ((e3) => {
          const t3 = (t4) => (n4) => {
            t4(e3, n4);
          ...
          ((e3) => {
            e3.on("cut", /* @__PURE__ */ ((e4) => (t3) => {
              !t3.isDefaultPrevented() && gA(e4) && e4.selection.isEditable() && uA(t3, fA(e4), mA(e4), () => {
              ...
              !t3.isDefaultPrevented() && gA(e4) && uA(t3, fA(e4), mA(e4), _);
            })(e3));
          })(e2), ((e3, t3) => {
            Yd(e3) && e3.on("dragend dragover draggesture dragdrop drop drag", (e4) => {
              ...
              const o3 = pA(e3, n3);
              if (y(o3)) return;
              const r2 = sA(n3.dataTransfer), s2 = aA(r2, UR());
              if ((!iA(r2) || ((e4) => {
                const t4 = e4["text/plain"];
                return !!t4 && 0 === t4.indexOf("file://");
              })(r2)) && lA(e3, n3, o3)) return;
              const a2 = r2[UR()], i2 = a2 || r2["text/html"] || r2["text/plain"], l2 = ((e4, t4, n4, o4) => {
              ...
              d2 && !l2 || i2 && (n3.preventDefault(), vg.setEditorTimeout(e3, () => {
                e3.undoManager.transact(() => {
                  (a2 || d2 && l2) && e3.execCommand("Delete"), hA(e3, o3);
                  const t4 = YR(i2);
                  r2["text/html"] ? oA(e3, t4, s2, true) : rA(e3, t4, true);
                });
              }));
            }), e3.on("dragstart", (e4) => {
              t3.set(true);
            }), e3.on("dragover dragend", (n3) => {
              Gd(e3) && !t3.get() && (n3.preventDefault(), hA(e3, pA(e3, n3))), "dragend" === n3.type && t3.set(false);
            }), ((e4) => {
              e4.on("input", (t4) => {
      ...
      }, wA = ar, xA = er, EA = (e2) => dr(e2.dom), _A = (e2) => (t2) => _n(yn(e2), t2), kA = (e2, t2) => Jn(yn(e2), EA, _A(t2)), SA = (e2, t2, n2) => {
        const o2 = new jo(e2, t2), r2 = n2 ? o2.next.bind(o2) : o2.prev.bind(o2);
        let s2 = e2;
        for (let t3 = n2 ? e2 : r2(); t3 && !wA(t3); t3 = r2()) ts(t3) && (s2 = t3);
        return s2;
      }, NA = (e2) => {
        const t2 = ((e3, t3, n2) => {
          const o2 = Vi.fromRangeStart(e3).getNode(), r2 = ((e4, t4, n3) => Jn(yn(e4), (e5) => ((e6) => lr(e6.dom))(e5) || n3.isBlock(Ht(e5)), _A(t4)).getOr(yn(t4)).dom)(o2, t3, n2), s2 = SA(o2, r2, false), a2 = SA(o2, r2, true), i2 = document.createRange();
          return kA(s2, r2).fold(() => {
            xA(s2) ? i2.setStart(s2, 0) : i2.setStartBefore(s2);
          }, (e4) => i2.setStartBefore(e4.dom)), kA(a2, r2).fold(() => {
            xA(a2) ? i2.setEnd(a2, a2.data.length) : i2.setEndAfter(a2);
      ...
      const AA = (e2, t2) => Math.abs(e2.left - t2), TA = (e2, t2) => Math.abs(e2.right - t2), OA = (e2, t2) => ((e3) => X(e3, (e4, t3) => e4.fold(() => I.some(t3), (e5) => {
        ...
        return [n2, o2];
      }), BA = (e2, t2, n2) => t2 > e2.left && t2 < e2.right ? 0 : Math.min(Math.abs(e2.left - t2), Math.abs(e2.right - t2)), PA = (e2, t2, n2, o2) => {
        const r2 = (e3) => ts(e3.node) ? I.some(e3) : qo(e3.node) ? PA(ce(e3.node.childNodes), t2, n2, false) : I.none(), s2 = (e3, s3) => {
        ...
        }, [a2, i2] = OA(IE(e2), n2), { pass: l2, fail: d2 } = K(i2, (e3) => e3.top < n2);
        return s2(a2, BA).orThunk(() => s2(d2, Ei)).orThunk(() => s2(l2, Ei));
      }, DA = (e2, t2, n2) => ((e3, t3, n3) => {
        const o2 = yn(e3), r2 = Nn(o2), s2 = Cn(r2, t3, n3).filter((e4) => kn(o2, e4)).getOr(o2);
        return ((e4, t4, n4, o3) => {
          const r3 = (t5, s3) => {
            const a2 = Y(t5.dom.childNodes, O((e5) => qo(e5) && e5.classList.contains("mce-drag-container")));
            return s3.fold(() => PA(a2, n4, o3, true), (e5) => {
              const t6 = Y(a2, (t7) => t7 !== e5.dom);
              return PA(t6, n4, o3, true);
            }).orThunk(() => (_n(t5, e4) ? I.none() : Tn(t5)).bind((e5) => r3(e5, I.some(t5))));
          };
          return r3(t4, I.none());
        })(o2, s2, t3, n3);
      })(e2, t2, n2).filter((e3) => Mc(e3.node)).map((e3) => ((e4, t3) => ({ node: e4.node, position: AA(e4, t3) < TA(e4, t3) ? RA.Before : RA.After }))(e3, t2)), LA = (e2) => {
        var t2, n2;
      ...
      }, MA = (e2) => ({ target: e2, srcElement: e2 }), IA = (e2, t2, n2, o2) => {
        const r2 = ((e3, t3) => {
          const n3 = ((e4) => {
            const t4 = MR(), n4 = ((e5) => {
              const t5 = e5;
            ...
            return AR(e4), wR(t4), t4.dropEffect = e4.dropEffect, t4.effectAllowed = e4.effectAllowed, ((e5) => {
              const t5 = e5;
              return I.from(t5[vR]);
      ...
      }, HA = jA("left", -32), $A = jA("left", 32), qA = jA("top", -32), VA = jA("top", 32), WA = (e2) => {
        e2 && e2.parentNode && e2.parentNode.removeChild(e2);
      }, KA = (e2, t2, n2, o2, r2) => {
        "dragstart" === t2 && IR(o2, e2.dom.getOuterHTML(n2));
        const s2 = IA(t2, n2, o2, r2);
        return e2.dispatch(t2, s2);
      }, YA = (e2, t2) => {
        const n2 = Qa((e3, n3) => ((e4, t3, n4) => {
          e4._selectionOverrides.hideFakeCaret(), DA(e4.getBody(), t3, n4).fold(() => e4.selection.placeCaretAt(t3, n4), (o3) => {
            const r2 = e4._selectionOverrides.showCaret(1, o3.node, o3.position === RA.Before, false);
        ...
        return (r2) => e2.on((e3) => {
          ...
          if (!e3.dragging && s2 > 10) {
            const n3 = KA(t2, "dragstart", e3.element, e3.dataTransfer, r2);
          ...
          if (e3.dragging) {
            const s3 = r2.currentTarget === t2.getDoc().documentElement, l2 = ((e4, t3) => ({ pageX: t3.pageX - e4.relX, pageY: t3.pageY + 5 }))(e3, ((e4, t3) => {
              return n3 = ((e5) => e5.inline ? LA(e5.getBody()) : { left: 0, top: 0 })(e4), o3 = ((e5) => {
                const t4 = e5.getBody();
                return e5.inline ? { left: t4.scrollLeft, top: t4.scrollTop } : { left: 0, top: 0 };
              })(e4), r3 = ((e5, t4) => {
                if (t4.target.ownerDocument !== e5.getDoc()) {
                  const n4 = LA(e5.getContentAreaContainer()), o4 = ((e6) => {
            ...
            a2 = e3.ghost, i2 = t2.getBody(), a2.parentNode !== i2 && i2.appendChild(a2), ((e4, t3, n3, o3, r3, s4, a3, i3, l3, d2, c2, u2) => {
              ...
              c2.on((e5) => {
                e5.intervalId.clear(), e5.dragging && u2 && (a3 + 8 >= g2 ? e5.intervalId.set(VA(d2)) : a3 - 8 <= 0 ? e5.intervalId.set(qA(d2)) : i3 + 8 >= p2 ? e5.intervalId.set($A(d2)) : i3 - 8 <= 0 ? e5.intervalId.set(HA(d2)) : h2 + 16 >= window.innerHeight ? e5.intervalId.set(VA(window)) : h2 - 16 <= 0 ? e5.intervalId.set(qA(window)) : b2 + 16 >= window.innerWidth ? e5.intervalId.set($A(window)) : b2 - 16 <= 0 && e5.intervalId.set(HA(window)));
              });
        ...
        e2.on((e3) => {
          e3.intervalId.clear(), e3.dragging && n2.fold(() => KA(t2, "dragend", e3.element, e3.dataTransfer), (n3) => KA(t2, "dragend", e3.element, e3.dataTransfer, n3));
        }), XA(e2);
      }, XA = (e2) => {
        e2.on((e3) => {
          e3.intervalId.clear(), WA(e3.ghost);
        }), e2.clear();
      }, QA = (e2) => {
        const t2 = Xa(), n2 = za.DOM, o2 = document, r2 = /* @__PURE__ */ ((e3, t3) => (n3) => {
          if (((e4) => 0 === e4.button)(n3)) {
            const o3 = J(t3.dom.getParents(n3.target), UA).getOr(null);
            if (C(o3) && ((e4, t4, n4) => FA(n4) && n4 !== t4 && e4.isEditable(n4.parentElement))(t3.dom, t3.getBody(), o3)) {
              const r3 = t3.dom.getPos(o3), s3 = t3.getBody(), a3 = t3.getDoc().documentElement;
              e3.set({ element: o3, dataTransfer: MR(), dragging: false, screenX: n3.screenX, screenY: n3.screenY, maxX: (t3.inline ? s3.scrollWidth : a3.offsetWidth) - 2, maxY: (t3.inline ? s3.scrollHeight : a3.offsetHeight) - 2, relX: n3.pageX - r3.x, relY: n3.pageY - r3.y, width: o3.offsetWidth, height: o3.offsetHeight, ghost: zA(t3, o3, o3.offsetWidth, o3.offsetHeight), intervalId: Ga(100) });
            }
          }
        })(t2, e2), s2 = YA(t2, e2), a2 = /* @__PURE__ */ ((e3, t3) => (n3) => {
          e3.on((e4) => {
            var o3;
            if (e4.intervalId.clear(), e4.dragging) {
              if (((e5, t4, n4) => !y(t4) && t4 !== n4 && !e5.dom.isChildOf(t4, n4) && e5.dom.isEditable(t4))(t3, ((e5) => {
                ...
                KA(t3, "drop", r3, e4.dataTransfer, n3).isDefaultPrevented() || t3.undoManager.transact(() => {
                  ((e5, t4) => {
                    const n4 = e5.getParent(t4.parentNode, e5.isBlock);
                    WA(t4), n4 && n4 !== e5.getRoot() && e5.isEmpty(n4) && Or(yn(n4));
              ...
              KA(t3, "dragend", t3.getBody(), e4.dataTransfer, n3);
            }
          }), XA(e3);
        })(t2, e2), i2 = /* @__PURE__ */ ((e3, t3) => (n3) => GA(e3, t3, I.some(n3)))(t2, e2);
        e2.on("mousedown", r2), e2.on("mousemove", s2), e2.on("mouseup", a2), n2.bind(o2, "mousemove", s2), n2.bind(o2, "mouseup", i2), e2.on("remove", () => {
          ...
          n3.keyCode === af.ESC && GA(t2, e2, I.none());
        });
      }, JA = dr, ZA = (e2, t2) => lb(e2.getBody(), t2), eT = (e2) => {
        const t2 = e2.selection, n2 = e2.dom, o2 = e2.getBody(), r2 = Pc(e2, o2, n2.isBlock, () => Rg(e2)), s2 = "sel-" + n2.uniqueId(), a2 = "data-mce-selected";
        let i2;
        const l2 = (e3) => e3 !== o2 && (JA(e3) || mr(e3)) && n2.isChildOf(e3, o2) && n2.isEditable(e3.parentNode), d2 = (n3, o3, s3, a3 = true) => e2.dispatch("ShowCaret", { target: o3, direction: n3, before: s3 }).isDefaultPrevented() ? null : (a3 && t2.scrollIntoView(o3, -1 === n3), r2.show(s3, o3)), c2 = (e3) => Ur(e3) || $r(e3) || qr(e3), u2 = (e3) => c2(e3.startContainer) || c2(e3.endContainer), m2 = (t3) => {
          ...
          if (er(m3) && 0 === f3 && JA(m3.parentNode) && (m3 = m3.parentNode, f3 = n2.nodeIndex(m3), m3 = m3.parentNode), !qo(m3)) return null;
        ...
        return XC(e2) || (e2.on("click", (t3) => {
          ...
          const n3 = t3.target, o3 = ZA(e2, n3);
          JA(o3) ? (t3.preventDefault(), Sx(e2, o3).each(f2)) : l2(n3) && Sx(e2, n3).each(f2);
          ...
          if (!((e3, t3, n3) => {
            const o3 = yn(e3.getBody()), r4 = e3.inline ? o3 : yn(Nn(o3).dom.documentElement), s4 = ((e4, t4, n4, o4) => {
              ...
              return { x: n4 - (e4 ? r5.left + t4.dom.clientLeft + Aw(t4) : 0), y: o4 - (e4 ? r5.top + t4.dom.clientTop + Rw(t4) : 0) };
            })(e3.inline, r4, t3, n3);
            return ((e4, t4, n4) => {
              const o4 = Sw(e4), r5 = Nw(e4);
              return t4 >= 0 && n4 >= 0 && t4 <= o4 && n4 <= r5;
            })(r4, s4.x, s4.y);
          })(e2, r3.clientX, r3.clientY)) return;
          g2(), p2();
          const a3 = ZA(e2, s3);
          JA(a3) ? (r3.preventDefault(), Sx(e2, a3).each(f2)) : DA(o2, r3.clientX, r3.clientY).each((n3) => {
            var o3;
            r3.preventDefault(), (o3 = d2(1, n3.node, n3.position === RA.Before, false)) && t2.setRng(o3), Vo(a3) ? a3.focus() : e2.getBody().focus();
          });
        }), e2.on("keypress", (e3) => {
          af.modifierPressed(e3) || JA(t2.getNode()) && e3.preventDefault();
          ...
          QA(e3), Id(e3) && ((e4) => {
            const t3 = (t4) => {
              if (!t4.isDefaultPrevented()) {
                ...
                n4 && (H(n4.types, "Files") || n4.files.length > 0) && (t4.preventDefault(), "drop" === t4.type && Lw(e4, "Dropped file type is not supported"));
              }
            }, n3 = (n4) => {
          ...
          e3.on("init", () => {
            e3.on("focusin", (t3) => {
              ...
              if (mr(n3)) {
                ...
                e3.selection.getNode() !== o3 && Sx(e3, o3).each((t5) => e3.selection.setRng(t5));
              }
            });
          });
        ...
        const s2 = r2 && er(n2) ? [tT(n2, o2)] : [o2];
        let a2 = n2;
        for (; a2 !== t2 && a2.parentNode; ) s2.push(e2.nodeIndex(a2, r2)), a2 = a2.parentNode;
        return a2 === t2 ? s2.reverse() : [];
      }, oT = (e2, t2, n2, o2, r2, s2, a2 = false) => ({ start: nT(e2, t2, n2, o2, a2), end: nT(e2, t2, r2, s2, a2) }), rT = (e2, t2) => {
      ...
      }, sT = (e2, t2) => rT(e2, t2.start).bind(({ node: n2, offset: o2 }) => rT(e2, t2.end).map(({ node: e3, offset: t3 }) => {
        const r2 = document.createRange();
        return r2.setStart(n2, o2), r2.setEnd(e3, t3), r2;
      })), aT = (e2, t2, n2) => {
        if (t2 && e2.isEmpty(t2) && !n2(t2)) {
          const o2 = t2.parentNode;
          e2.remove(t2, er(t2.firstChild) && ss(t2.firstChild.data)), aT(e2, o2, n2);
        }
      }, iT = (e2, t2, n2, o2 = true) => {
        const r2 = t2.startContainer.parentNode, s2 = t2.endContainer.parentNode;
        t2.deleteContents(), o2 && !n2(t2.startContainer) && (er(t2.startContainer) && 0 === t2.startContainer.data.length && e2.remove(t2.startContainer), er(t2.endContainer) && 0 === t2.endContainer.data.length && e2.remove(t2.endContainer), aT(e2, r2, n2), r2 !== s2 && aT(e2, s2, n2));
      }, lT = (e2, t2) => I.from(e2.dom.getParent(t2.startContainer, e2.dom.isBlock)), dT = (e2, t2, n2) => {
        ...
        ((e3, t3, n3) => {
          if (er(e3) && 0 >= e3.length) return I.some(Tk(e3, 0));
          {
            const t4 = hi(Ok);
            return I.from(t4.forwards(e3, 0, Bk(e3), n3)).map((e4) => Tk(e4.container, 0));
          }
        })(t2, 0, t2).each((o2) => {
          const r2 = o2.container;
          Lk(r2, n2.start.length, t2).each((n3) => {
            const o3 = e2.createRng();
            o3.setStart(r2, 0), o3.setEnd(n3.container, n3.offset), iT(e2, o3, (e3) => e3 === t2);
          });
      ...
      }, mT = (e2, t2) => e2.create("span", { "data-mce-type": "bookmark", id: t2 }), fT = (e2, t2) => {
        const n2 = e2.createRng();
        return n2.setStartAfter(t2.start), n2.setEndBefore(t2.end), n2;
      }, gT = (e2, t2, n2) => {
        const o2 = sT(e2.getRoot(), n2).getOrDie("Unable to resolve path range"), r2 = o2.startContainer, s2 = o2.endContainer, a2 = 0 === o2.endOffset ? s2 : s2.splitText(o2.endOffset), i2 = 0 === o2.startOffset ? r2 : r2.splitText(o2.startOffset), l2 = i2.parentNode;
        return { prefix: t2, end: a2.parentNode.insertBefore(mT(e2, t2 + "-end"), a2), start: l2.insertBefore(mT(e2, t2 + "-start"), i2) };
      }, pT = (e2, t2, n2) => {
        aT(e2, e2.get(t2.prefix + "-end"), n2), aT(e2, e2.get(t2.prefix + "-start"), n2);
      }, hT = (e2) => 0 === e2.start.length, bT = (e2, t2, n2, o2) => {
        const r2 = t2.start;
        var s2;
        return Mk(e2, o2.container, o2.offset, (s2 = r2, (e3, t3) => {
          ...
          }
          {
            ...
            return Dk(o3.container, s4, n2).map((t3) => {
              const n3 = e2.createRng();
              return n3.setStart(t3.container, t3.offset), n3.setEnd(o3.container, o3.offset), n3;
            }).filter((e3) => e3.toString() === r2).orThunk(() => bT(e2, t2, n2, Tk(o3.container, 0)));
          }
        });
      }, vT = (e2, t2, n2, o2) => {
        const r2 = e2.dom, s2 = r2.getRoot(), a2 = n2.pattern, i2 = n2.position.container, l2 = n2.position.offset;
        return Dk(i2, l2 - n2.pattern.end.length, t2).bind((d2) => {
          const c2 = oT(r2, s2, d2.container, d2.offset, i2, l2, o2);
          if (hT(a2)) return I.some({ matches: [{ pattern: a2, startRng: c2, endRng: c2 }], position: d2 });
          {
            const i3 = yT(e2, n2.remainingPatterns, d2.container, d2.offset, t2, o2), l3 = i3.getOr({ matches: [], position: d2 }), u2 = l3.position, m2 = ((e3, t3, n3, o3, r3, s3 = false) => {
              if (0 === t3.start.length && !s3) {
                const t4 = e3.createRng();
                return t4.setStart(n3, o3), t4.setEnd(n3, o3), I.some(t4);
              }
              return Pk(n3, o3, r3).bind((n4) => bT(e3, t3, r3, n4).bind((e4) => {
                var t4;
                if (s3) {
            ...
            return m2.map((e3) => {
              const t3 = ((e4, t4, n3, o3 = false) => oT(e4, t4, n3.startContainer, n3.startOffset, n3.endContainer, n3.endOffset, o3))(r2, s2, e3, o2);
              return { matches: l3.matches.concat([{ pattern: a2, startRng: t3, endRng: c2 }]), position: Tk(e3.startContainer, e3.startOffset) };
            });
          }
        });
      }, yT = (e2, t2, n2, o2, r2, s2) => {
        const a2 = e2.dom;
        return Pk(n2, o2, a2.getRoot()).bind((i2) => {
          const l2 = cT(a2, r2, n2, o2);
          for (let a3 = 0; a3 < t2.length; a3++) {
            const d2 = t2[a3];
            if (!$e(l2, d2.end)) continue;
            const c2 = t2.slice();
            c2.splice(a3, 1);
            const u2 = vT(e2, r2, { pattern: d2, remainingPatterns: c2, position: i2 }, s2);
            if (u2.isNone() && o2 > 0) return yT(e2, t2, n2, o2 - 1, r2, s2);
        ...
        })(yT(e2, r2.inlinePatterns, n2, o2, t2, s2).fold(() => [], (e3) => e3.matches), yT(e2, (a2 = r2.inlinePatterns, ae(a2, (e3, t3) => t3.end.length - e3.end.length)), n2, o2, t2, s2).fold(() => [], (e3) => e3.matches));
      }, xT = (e2, t2) => {
        if (0 === t2.length) return;
        const n2 = e2.dom, o2 = e2.selection.getBookmark(), r2 = ((e3, t3) => {
          const n3 = ui("mce_textpattern"), o3 = G(t3, (t4, o4) => {
            const r3 = gT(e3, n3 + `_end${t4.length}`, o4.endRng);
            return t4.concat([{ ...o4, endMarker: r3 }]);
          }, []);
          return G(o3, (t4, r3) => {
            const s2 = o3.length - t4.length - 1, a2 = hT(r3.pattern) ? r3.endMarker : gT(e3, n3 + `_start${s2}`, r3.startRng);
            return t4.concat([{ ...r3, startMarker: a2 }]);
          }, []);
        })(n2, t2);
        V(r2, (t3) => {
          const o3 = n2.getParent(t3.startMarker.start, n2.isBlock), r3 = (e3) => e3 === o3;
          hT(t3.pattern) ? ((e3, t4, n3, o4) => {
            const r4 = fT(e3.dom, n3);
            iT(e3.dom, r4, o4), CT(e3, t4, r4);
          })(e2, t3.pattern, t3.endMarker, r3) : ((e3, t4, n3, o4, r4) => {
            const s2 = e3.dom, a2 = fT(s2, o4), i2 = fT(s2, n3);
            iT(s2, i2, r4), iT(s2, a2, r4);
            const l2 = { prefix: n3.prefix, start: n3.end, end: o4.start }, d2 = fT(s2, l2);
            CT(e3, t4, d2);
          })(e2, t3.pattern, t3.startMarker, t3.endMarker, r3), pT(n2, t3.endMarker, r3), pT(n2, t3.startMarker, r3);
        }), e2.selection.moveToBookmark(o2);
      }, ET = (e2, t2) => {
        const n2 = e2.selection.getRng();
        return lT(e2, n2).map((o2) => {
          var r2;
          const s2 = Math.max(0, n2.startOffset), a2 = dT(t2, o2, null !== (r2 = o2.textContent) && void 0 !== r2 ? r2 : ""), i2 = wT(e2, o2, n2.startContainer, s2, a2, true), l2 = ((e3, t3, n3, o3) => {
            var r3;
            ...
            })(n3.blockPatterns, i3).map((e4) => Pt.trim(i3).length === e4.start.length ? [] : [{ pattern: e4, range: oT(s3, s3.getRoot(), t3, 0, t3, 0, true) }]).getOr([]);
          })(e2, o2, a2);
          return (l2.length > 0 || i2.length > 0) && (e2.undoManager.add(), e2.undoManager.extra(() => {
            ...
            ((e3) => {
              ...
              V(t4, (t5) => ((e4, t6) => {
                const n5 = e4.dom, o3 = t6.pattern, r3 = sT(n5.getRoot(), t6.range).getOrDie("Unable to resolve path range");
                return lT(e4, r3).each((t7) => {
                  "block-format" === o3.type ? ((e5, t8) => {
                    const n6 = t8.get(e5);
                    return p(n6) && le(n6).exists((e6) => Ee(e6, "block"));
                  })(o3.format, e4.formatter) && e4.undoManager.transact(() => {
                    uT(e4.dom, t7, o3), e4.formatter.apply(o3.format);
                  }) : "block-command" === o3.type && e4.undoManager.transact(() => {
                    uT(e4.dom, t7, o3), e4.execCommand(o3.cmd, false, o3.value);
                  });
                }), true;
              })(e3, t5)), e3.selection.moveToBookmark(n4);
            })(e2, l2);
            const t3 = e2.selection.getRng(), n3 = Pk(t3.startContainer, t3.startOffset, e2.dom.getRoot());
            e2.execCommand("mceInsertNewLine"), n3.each((t4) => {
              const n4 = t4.container;
              n4.data.charAt(t4.offset - 1) === hr && (n4.deleteData(t4.offset - 1, 1), aT(e2.dom, n4.parentNode, (t5) => t5 === e2.dom.getRoot()));
            });
          }), true);
        }).getOr(false);
      }, _T = (e2, t2, n2) => {
        ...
        return XC(e2) ? (d2 && (h2(), v2(), N2(), p2(), c2 && (x2(), E2(), S2())), l2 && (b2(), C2(), w2(), k2())) : (e2.on("keydown", (t3) => {
        ...
        }), c2 ? (x2(), E2(), S2()) : p2()), l2 && (e2.on("keydown", (t3) => {
        ...
        const a2 = Promise.all(((e3, t3, n3) => {
          const { pass: o3, fail: r3 } = K(t3, (e4) => tinymce.Resource.has(Uw(e4))), s3 = o3.map((t4) => {
            const n4 = tinymce.Resource.get(Uw(t4));
            return m(n4) ? Promise.resolve(OT(e3).loadRawCss(t4, n4)) : Promise.resolve();
          }), a3 = [...s3, OT(e3).loadAll(r3)];
        ...
        true !== e2.removed && (((e3) => {
          XC(e3) || e3.load({ initial: true, format: "html" }), e3.startContent = e3.getContent({ format: "raw" });
        })(e2), ((e3) => {
        ...
        let n2 = e2.getDoc();
        e2.inline && (ST.addClass(t2, "mce-content-body"), e2.contentDocument = n2 = document, e2.contentWindow = window, e2.bodyElement = t2, e2.contentAreaContainer = t2);
        const o2 = e2.getBody();
        o2.disabled = true, e2.readonly = Bd(e2), e2._editableRoot = Pd(e2), !e2.readonly && e2.hasEditableRoot() && (e2.inline && "static" === ST.getStyle(o2, "position", true) && (o2.style.position = "relative"), o2.contentEditable = "true"), o2.disabled = false, e2.editorUpload = Kw(e2), e2.schema = ua(TT(e2)), e2.dom = za(n2, { keep_values: true, url_converter: e2.convertURL, url_converter_scope: e2, update_styles: true, root_element: e2.inline ? e2.getBody() : null, collect: e2.inline, schema: e2.schema, contentCssCors: Zl(e2), referrerPolicy: ed(e2), onSetAttrib: (t3) => {
          e2.dispatch("SetAttrib", t3);
        }, force_hex_color: yc(e2) }), e2.parser = ((e3) => {
          const t3 = bC(AT(e3), e3.schema);
        ...
        })(e2), e2.serializer = iw(((e3) => {
          const t3 = e3.options.get;
          return { ...AT(e3), ...TT(e3), ...RT({ remove_trailing_brs: t3("remove_trailing_brs"), pad_empty_with_br: t3("pad_empty_with_br"), url_converter: t3("url_converter"), url_converter_scope: t3("url_converter_scope"), element_format: t3("element_format"), entities: t3("entities"), entity_encoding: t3("entity_encoding"), indent: t3("indent"), indent_after: t3("indent_after"), indent_before: t3("indent_before") }) };
        })(e2), e2), e2.selection = rw(e2.dom, e2.getWin(), e2.serializer, e2), e2.annotator = Qm(e2), e2.formatter = rx(e2), e2.undoManager = ax(e2), e2._nodeChangeDispatcher = new bR(e2), e2._selectionOverrides = eT(e2), ((e3) => {
          ...
          const t3 = "contenteditable", n3 = " " + Pt.trim(dc(e3)) + " ", o3 = " " + Pt.trim(lc(e3)) + " ", r3 = z_(n3), s3 = z_(o3), a2 = cc(e3);
          a2.length > 0 && e3.on("BeforeSetContent", (t4) => {
            ((e4, t5, n4) => {
              let o4 = t5.length, r4 = n4.content;
              if ("raw" !== n4.format) {
                for (; o4--; ) r4 = r4.replace(t5[o4], j_(e4, r4, lc(e4)));
                n4.content = r4;
              }
            })(e3, a2, t4);
            ...
            for (; n4--; ) {
              ...
              a2.length > 0 && i2 ? H_(a2, i2) ? (o4.name = "#text", o4.type = 3, o4.raw = true, o4.value = i2) : o4.remove() : o4.attr(t3, null);
            }
          });
        })(e2), XC(e2) || (((e3) => {
          e3.on("mousedown", (t3) => {
            t3.detail >= 3 && (t3.preventDefault(), NA(e3));
          });
        })(e2), ((e3) => {
          ((e4) => {
            const t3 = [",", ".", ";", ":", "!", "?"], n3 = [32], o3 = () => {
            ...
            e4.on("keydown", (t4) => {
              if (13 === t4.keyCode && !af.modifierPressed(t4) && e4.selection.isCollapsed()) {
                const n4 = o3();
                (n4.inlinePatterns.length > 0 || n4.blockPatterns.length > 0 || r3()) && ET(e4, n4) && t4.preventDefault();
              }
            }, true);
            const s3 = () => {
              if (e4.selection.isCollapsed()) {
                ...
                (t4.inlinePatterns.length > 0 || r3()) && ((e5, t5) => {
                  ...
                  lT(e5, n4).map((o4) => {
                    const r4 = Math.max(0, n4.startOffset - 1), s4 = cT(e5.dom, o4, n4.startContainer, r4), a2 = dT(t5, o4, s4), i2 = wT(e5, o4, n4.startContainer, r4, a2, false);
            ...
            e4.on("keyup", (e5) => {
              _T(n3, e5, (e6, t4) => e6 === t4.keyCode && !af.modifierPressed(t4)) && s3();
            }), e4.on("keypress", (n4) => {
              _T(t3, n4, (e5, t4) => e5.charCodeAt(0) === t4.charCode) && vg.setEditorTimeout(e4, s3);
            });
          })(e3);
        })(e2));
        const r2 = hR(e2);
        B_(e2, r2), ((e3) => {
          e3.on("NodeChange", T(F_, e3));
        })(e2), ((e3) => {
          var t3;
          const n3 = e3.dom, o3 = Il(e3), r3 = null !== (t3 = md(e3)) && void 0 !== t3 ? t3 : "", s3 = (t4, a2) => {
            if (((e4) => {
              if (dx(e4)) {
                const t5 = e4.keyCode;
                return !cx(e4) && (af.metaKeyPressed(e4) || e4.altKey || t5 >= 112 && t5 <= 123 || H(ix, t5));
              }
              return false;
            })(t4)) return;
            const i2 = e3.getBody(), l2 = !((e4) => dx(e4) && !(cx(e4) || "keyup" === e4.type && 229 === e4.keyCode))(t4) && ((e4, t5, n4) => {
              if (gs(yn(t5), false)) {
            ...
            ("" !== n3.getAttrib(i2, lx) !== l2 || a2) && (n3.setAttrib(i2, lx, l2 ? r3 : null), n3.setAttrib(i2, "aria-placeholder", l2 ? r3 : null), ((e4, t5) => {
        ...
        const s2 = ((e3) => {
          const t3 = e3;
          return ((e4) => xe(e4.plugins, "rtc").bind((e5) => I.from(e5.setup)))(e3).fold(() => (t3.rtcInstance = GC(e3), I.none()), (e4) => (t3.rtcInstance = (() => {
        ...
        ((e3) => {
          ...
          ((e4) => {
            e4.dispatch("PreInit");
          })(e3), Wd(e3) || (t3.body.spellcheck = false, ST.setAttrib(n3, "spellcheck", "false")), e3.quirks = kT(e3), ((e4) => {
          ...
          e2.setProgressState(true), BT(e2).then(() => {
            t3().then((t4) => {
              e2.setProgressState(false), PT(e2), ZC(e2);
            }, (t4) => {
              e2.notificationManager.open({ type: "error", text: String(t4) }), PT(e2), ZC(e2);
            });
          });
        });
      }, LT = M, MT = za.DOM, IT = za.DOM, FT = (e2, t2) => ({ editorContainer: e2, iframeContainer: t2, api: {} }), UT = (e2) => {
        const t2 = e2.getElement();
        return e2.inline ? FT(null) : ((e3) => {
          const t3 = IT.create("div");
          return IT.insertAfter(t3, e3), FT(t3, t3);
        })(t2);
      }, zT = async (e2) => {
        e2.dispatch("ScriptsLoaded"), ((e3) => {
          const t3 = Pt.trim(Kl(e3)), n2 = e3.ui.registry.getAll().icons, o2 = { ...xw.get("default").icons, ...xw.get(t3).icons };
          ge(o2, (t4, o3) => {
          ...
          if (m(t3)) {
            const n2 = Bw.get(t3);
            e3.theme = n2(e3, Bw.urls[t3]) || {}, w(e3.theme.init) && e3.theme.init(e3, Bw.urls[t3] || e3.documentBaseUrl.replace(/\/$/, ""));
          } else e3.theme = {};
        })(e2), ((e3) => {
          const t3 = bd(e3), n2 = Ew.get(t3);
          e3.model = n2(e3, Ew.urls[t3]);
        })(e2), ((e3) => {
          const t3 = [];
          V(Ld(e3), (n2) => {
            ((e4, t4, n3) => {
              const o2 = Ow.get(n3), r2 = Ow.urls[n3] || e4.documentBaseUrl.replace(/\/$/, "");
              if (n3 = Pt.trim(n3), o2 && -1 === Pt.inArray(t4, n3)) {
                ...
                try {
                  ...
                  ((e5, t6, n4) => {
                    ...
                    ef(e5, "PluginLoadError", { message: o3 }), Fw(o3, n4), Lw(e5, o3);
                  })(e4, n3, t5);
                }
              }
        ...
        ((e3, t3) => {
          ...
          e3.contentCSS = e3.contentCSS.concat(((e4) => zw(e4, sd(e4)))(e3), ((e4) => zw(e4, id(e4)))(e3));
        })(e2), e2.inline ? DT(e2) : ((e3, t3) => {
          ((e4, t4) => {
            ...
            })(e4), MT.add(t4.iframeContainer, r2);
          })(e3, t3), t3.editorContainer && (t3.editorContainer.style.display = e3.orgDisplay, e3.hidden = MT.isHidden(t3.editorContainer)), e3.getElement().style.display = "none", MT.setAttrib(e3.id, "aria-hidden", "true"), e3.getElement().style.visibility = e3.orgVisibility, ((e4) => {
            const t4 = e4.iframeElement, n2 = () => {
              e4.contentDocument = t4.contentDocument, DT(e4);
            };
            if (gc(e4) || At.browser.isFirefox()) {
              const t5 = e4.getDoc();
              t5.open(), t5.write(e4.iframeHTML), t5.close(), n2();
            } else {
              const r2 = (o2 = yn(t4), No(o2, "load", LT, () => {
                r2.unbind(), n2();
              }));
      ...
      }, jT = za.DOM, HT = (e2) => "-" === e2.charAt(0), $T = (e2, t2, n2) => I.from(t2).filter((e3) => Ye(e3) && !xw.has(e3)).map((t3) => ({ url: `${e2.editorManager.baseURL}/icons/${t3}/icons${n2}.js`, name: I.some(t3) })), qT = (e2, t2) => {
        const n2 = Ha.ScriptLoader, o2 = () => {
          !e2.removed && ((e3) => {
            const t3 = pd(e3);
            return !m(t3) || C(Bw.get(t3));
          })(e2) && ((e3) => {
            const t3 = bd(e3);
            return C(Ew.get(t3));
          })(e2) && zT(e2);
        ...
        ((e3, t3) => {
          ...
          if (!Ka.hasCode(n3) && "en" !== n3) {
            ...
            e3.add(r2).catch(() => {
              ((e4, t4, n4) => {
                Mw(e4, "LanguageLoadError", Iw("language", t4, n4));
              })(t3, r2, n3);
            });
          }
        })(n2, e2), ((e3, t3, n3) => {
          const o3 = $T(t3, "default", n3), r2 = ((e4) => I.from(Yl(e4)).filter(Ye).map((e5) => ({ url: e5, name: I.none() })))(t3).orThunk(() => $T(t3, Kl(t3), ""));
          V(((e4) => {
            const t4 = [], n4 = (e5) => {
              t4.push(e5);
            };
            ...
            e3.add(n4.url).catch(() => {
              ((e4, t4, n5) => {
                Mw(e4, "IconsLoadError", Iw("icons", t4, n5));
          ...
          const n3 = (t4, n4) => {
            Ow.load(t4, n4).catch(() => {
              ((e4, t5, n5) => {
                Mw(e4, "PluginLoadError", Iw("plugin", t5, n5));
              })(e3, n4, t4);
            });
          };
          ge(Md(e3), (t4, o3) => {
            ...
            !(e4 = Pt.trim(e4)) || Ow.urls[e4] || HT(e4) || n3(e4, `plugins/${e4}/plugin${t3}.js`);
          });
        })(e2, t2), n2.loadQueue().then(o2, o2);
      }, VT = xt().deviceType, WT = VT.isPhone(), KT = VT.isTablet(), YT = (e2) => {
        if (y(e2)) return [];
        {
        ...
        var o2, r2;
      }, XT = (e2, t2) => Ee(e2.sections(), t2), QT = (e2, t2) => ({ table_grid: false, object_resizing: false, resize: false, toolbar_mode: xe(e2, "toolbar_mode").getOr("scrolling"), toolbar_sticky: false, ...t2 ? { menubar: false } : {} }), JT = (e2, t2) => {
        var n2;
        const o2 = null !== (n2 = t2.external_plugins) && void 0 !== n2 ? n2 : {};
        return e2 && e2.external_plugins ? Pt.extend({}, e2.external_plugins, o2) : o2;
      }, ZT = (e2, t2, n2, o2, r2) => {
        var s2;
        const a2 = e2 ? { mobile: QT(null !== (s2 = r2.mobile) && void 0 !== s2 ? s2 : {}, t2) } : {}, i2 = GT(["mobile"], Zk(a2, r2)), l2 = Pt.extend(n2, o2, i2.options(), ((e3, t3) => e3 && XT(t3, "mobile"))(e2, i2) ? ((e3, t3, n3 = {}) => {
          const o3 = e3.sections(), r3 = xe(o3, t3).getOr({});
          return Pt.extend({}, n3, r3);
        })(i2, "mobile") : {}, { external_plugins: JT(o2, i2.options()) });
        return ((e3, t3, n3, o3) => {
          const r3 = YT(n3.forced_plugins), s3 = YT(o3.plugins), a3 = ((e4, t4) => XT(e4, t4) ? e4.sections()[t4] : {})(t3, "mobile"), i3 = ((e4, t4, n4, o4) => e4 && XT(t4, "mobile") ? o4 : n4)(e3, t3, s3, a3.plugins ? YT(a3.plugins) : s3), l3 = ((e4, t4) => [...YT(e4), ...YT(t4)])(r3, i3);
        ...
        if (e2.selection.isEditable()) {
          ...
          wC(e2, { ...o2, content: tO(e2, n2), format: "html", set: false, selection: true }).each((t3) => {
            const n3 = ((e3, t4, n4) => QC(e3).editor.insertContent(t4, n4))(e2, t3.content, o2);
            xC(e2, n3, t3), e2.addVisual();
          });
        }
      }, oO = { "font-size": "size", "font-family": "face" }, rO = Xt("font"), sO = (e2) => (t2, n2) => I.from(n2).map(yn).filter(Wt).bind((n3) => ((e3, t3, n4) => Lb(yn(n4), (t4) => ((t5) => mo(t5, e3).orThunk(() => rO(t5) ? xe(oO, e3).bind((e4) => tn(t5, e4)) : I.none()))(t4), (e4) => _n(yn(t3), e4)))(e2, t2, n3.dom).or(((e3, t3) => I.from(za.DOM.getStyle(t3, e3, true)))(e2, n3.dom))).getOr(""), aO = sO("font-size"), iO = k((e2) => e2.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ","), sO("font-family")), lO = (e2) => Ou(e2.getBody()).bind((e3) => {
        const t2 = e3.container();
        return I.from(er(t2) ? t2.parentNode : t2);
      }), dO = (e2, t2) => ((e3, t3) => ((e4) => I.from(e4.selection.getRng()).bind((t4) => {
        const n2 = e4.getBody();
        return t4.startContainer === n2 && 0 === t4.startOffset ? I.none() : I.from(e4.selection.getStart(true));
      }))(e3).orThunk(T(lO, e3)).map(yn).filter(Wt).bind(t3))(e2, S(I.some, t2)), cO = (e2, t2) => {
        if (/^[0-9.]+$/.test(t2)) {
        ...
        const n2 = e2.dom, o2 = e2.selection.getRng(), r2 = t2 ? e2.selection.getStart() : e2.selection.getEnd(), s2 = t2 ? o2.startContainer : o2.endContainer, a2 = bN(n2, s2);
        ...
        ((e3, t3, n3, o3) => {
          ...
          const n3 = wN(e2, s2, t3.dom, a2, false, l2);
          i2(t3, yn(n3)), e2.selection.setCursorLocation(n3, 0), e2.dispatch("NewBlock", { newBlock: n3 }), cN(e2, "insertParagraph");
        });
      }, fO = (e2) => {
        eO(e2), ((e3) => {
          ...
          e3.editorCommands.addCommands({ mceCleanup: () => {
            ...
            nO(e3, e3.dom.createHTML("img", { src: o2 }));
          }, insertHorizontalRule: () => {
            e3.execCommand("mceInsertContent", false, "<hr>");
          }, insertText: (t2, n2, o2) => {
            nO(e3, e3.dom.encode(o2));
          }, insertHTML: (t2, n2, o2) => {
            nO(e3, o2);
          ...
          e3.editorCommands.addCommands({ Indent: () => {
            ...
            A_(e3);
          } }), e3.editorCommands.addCommands({ Outdent: () => k_(e3) }, "state");
        })(e2), ((e3) => {
          ...
          ((e4) => {
            ...
            e4.editorCommands.addCommands({ "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": (e5) => {
              ...
              ((e5, t4) => {
                const n3 = cO(e5, t4);
                e5.formatter.toggle("fontname", { value: uO(n3) }), e5.nodeChanged();
              })(e4, o2);
            }, FontSize: (t3, n2, o2) => {
              ((e5, t4) => {
                e5.formatter.toggle("fontsize", { value: cO(e5, t4) }), e5.nodeChanged();
              })(e4, o2);
            }, LineHeight: (t3, n2, o2) => {
              ((e5, t4) => {
            ...
            e4.editorCommands.addCommands({ "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": (e5) => t2(e5), mceBlockQuote: () => t2("blockquote") }, "state"), e4.editorCommands.addQueryValueHandler("FontName", () => ((e5) => dO(e5, (t3) => iO(e5.getBody(), t3.dom)).getOr(""))(e4)), e4.editorCommands.addQueryValueHandler("FontSize", () => ((e5) => dO(e5, (t3) => aO(e5.getBody(), t3.dom)).getOr(""))(e4)), e4.editorCommands.addQueryValueHandler("LineHeight", () => ((e5) => dO(e5, (t3) => {
          ...
          e3.editorCommands.addCommands({ mceRemoveNode: (t2, n2, o2) => {
            ...
            ((e4, t3) => {
              e4.removed || (t3 ? Tg(e4) : ((e5) => {
                ...
                if (r2 && e5.dom.isChildOf(r2, n3)) return Ng(r2), Sg(e5, o3), void Tg(e5);
                e5.inline || (At.browser.isOpera() || Ng(n3), e5.getWin().focus()), (At.browser.isFirefox() || e5.inline) && (Ng(n3), Sg(e5, o3)), Tg(e5);
              })(e4));
            })(e3, true === o2);
          }, mceToggleVisualAid: () => {
      ...
      }, gO = ["toggleview"], pO = (e2) => H(gO, e2.toLowerCase());
      class hO {
        constructor(e2) {
        ...
        queryCommandState(e2) {
          if (!pO(e2) && this.editor.quirks.isHidden() || this.editor.removed) return false;
          const t2 = e2.toLowerCase(), n2 = this.commands.state[t2];
          return !!w(n2) && n2(t2);
        }
        queryCommandValue(e2) {
          if (!pO(e2) && this.editor.quirks.isHidden() || this.editor.removed) return "";
      ...
      const bO = "data-mce-contenteditable", vO = (e2, t2, n2) => {
        try {
      ...
      }, CO = (e2) => e2.readonly, wO = (e2) => {
        e2.parser.addAttributeFilter("contenteditable", (t2) => {
          CO(e2) && V(t2, (e3) => {
            e3.attr(bO, e3.attr("contenteditable")), e3.attr("contenteditable", "false");
          });
        }), e2.serializer.addAttributeFilter(bO, (t2) => {
          CO(e2) && V(t2, (e3) => {
            e3.attr("contenteditable", e3.attr(bO));
          });
        }), e2.serializer.addTempAttr(bO);
      }, xO = ["copy"], EO = Pt.makeMap("focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input beforeinput contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend touchcancel", " ");
      class _O {
        static isNative(e2) {
          return !!EO[e2.toLowerCase()];
        }
        constructor(e2) {
      ...
      const kO = (e2) => (e2._eventDispatcher || (e2._eventDispatcher = new _O({ scope: e2, toggleEvent: (t2, n2) => {
        _O.isNative(t2) && e2.toggleNativeEvent && e2.toggleNativeEvent(t2, n2);
      } })), e2._eventDispatcher), SO = { fire(e2, t2, n2) {
        return this.dispatch(e2, t2, n2);
      }, dispatch(e2, t2, n2) {
        const o2 = this;
        if (o2.removed && "remove" !== e2 && "detach" !== e2) return _a(e2.toLowerCase(), null != t2 ? t2 : {}, o2);
        const r2 = kO(o2).dispatch(e2, t2);
        ...
        return kO(this).on(e2, t2, n2);
      }, off(e2, t2) {
        return kO(this).off(e2, t2);
      }, once(e2, t2) {
        return kO(this).once(e2, t2);
      }, hasEventListeners(e2) {
        return kO(this).has(e2);
      } }, NO = za.DOM;
      let RO;
      const AO = (e2, t2) => {
        ...
        const n2 = fd(e2);
        return n2 ? (e2.eventRoot || (e2.eventRoot = NO.select(n2)[0]), e2.eventRoot) : e2.getBody();
      }, TO = (e2, t2, n2) => {
        ((e3) => !e3.hidden && !CO(e3))(e2) ? e2.dispatch(t2, n2) : CO(e2) && ((e3, t3) => {
          ...
          } else ((e4) => H(xO, e4.type))(t3) && e3.dispatch(t3.type, t3);
        })(e2, n2);
      }, OO = (e2, t2) => {
        if (e2.delegates || (e2.delegates = {}), e2.delegates[t2] || e2.removed) return;
        const n2 = AO(e2, t2);
        if (fd(e2)) {
          if (RO || (RO = {}, e2.editorManager.on("removeEditor", () => {
            e2.editorManager.activeEditor || RO && (ge(RO, (t3, n3) => {
              e2.dom.unbind(AO(e2, n3));
            }), RO = null);
          })), RO[t2]) return;
          const o2 = (n3) => {
            ...
            for (; s2--; ) {
              ...
              (e3 === o3 || NO.isChildOf(o3, e3)) && TO(r2[s2], t2, n3);
            }
          };
          RO[t2] = o2, NO.bind(n2, t2, o2);
        } else {
          const o2 = (n3) => {
            TO(e2, t2, n3);
          };
          NO.bind(n2, t2, o2), e2.delegates[t2] = o2;
        }
      }, BO = { ...SO, bindPendingEventDelegates() {
        const e2 = this;
        ...
        const n2 = this;
        "focus" !== e2 && "blur" !== e2 && (n2.removed || (t2 ? n2.initialized ? OO(n2, e2) : n2._pendingNativeEvents ? n2._pendingNativeEvents.push(e2) : n2._pendingNativeEvents = [e2] : n2.initialized && n2.delegates && (n2.dom.unbind(AO(n2, e2), e2, n2.delegates[e2]), delete n2.delegates[e2])));
      }, unbindAllNativeEvents() {
        const e2 = this, t2 = e2.getBody(), n2 = e2.dom;
        e2.delegates && (ge(e2.delegates, (t3, n3) => {
          e2.dom.unbind(AO(e2, n3), n3, t3);
      ...
      } }, PO = (e2) => m(e2) ? { value: e2.split(/[ ,]/), valid: true } : E(e2, m) ? { value: e2, valid: true } : { valid: false, message: "The value must be a string[] or a comma/space separated string." }, DO = (e2, t2) => e2 + (Ge(t2.message) ? "" : `. ${t2.message}`), LO = (e2) => e2.valid, MO = (e2, t2, n2 = "") => {
        const o2 = t2(e2);
        return b(o2) ? o2 ? { value: e2, valid: true } : { valid: false, message: n2 } : o2;
      }, IO = ["design", "readonly"], FO = (e2, t2, n2, o2) => {
        ...
        r2.deactivate(), r2.editorReadOnly !== s2.editorReadOnly && ((e3, t3) => {
          ...
          })(e3), e3.readonly = true, yO(n3, false), V(Uo(n3, '*[contenteditable="true"]'), (e4) => {
            Jt(e4, bO, "true"), yO(e4, false);
          })) : (e3.readonly = false, e3.hasEditableRoot() && yO(n3, true), V(Uo(n3, `*[${bO}="true"]`), (e4) => {
            on(e4, bO), yO(e4, true);
          }), vO(e3, "StyleWithCSS", false), vO(e3, "enableInlineTableEditing", false), vO(e3, "enableObjectResizing", false), Ag(e3) && e3.focus(), ((e4) => {
            e4.selection.setRng(e4.selection.getRng());
          })(e3), e3.nodeChanged());
        })(e2, s2.editorReadOnly), t2.set(o2), ((e3, t3) => {
          e3.dispatch("SwitchMode", { mode: t3 });
        })(e2, o2);
      }, UO = Pt.each, zO = Pt.explode, jO = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 }, HO = Pt.makeMap("alt,ctrl,shift,meta,access"), $O = (e2) => {
        const t2 = {}, n2 = At.os.isMacOS() || At.os.isiOS();
        UO(zO(e2.toLowerCase(), "+"), (e3) => {
          ((e4) => e4 in HO)(e3) ? t2[e3] = true : /^[0-9]{2,}$/.test(e3) ? t2.keyCode = parseInt(e3, 10) : (t2.charCode = e3.charCodeAt(0), t2.keyCode = jO[e3] || e3.toUpperCase().charCodeAt(0));
        });
        const o2 = [t2.keyCode];
        let r2;
        for (r2 in HO) t2[r2] ? o2.push(r2) : t2[r2] = false;
      ...
      class qO {
        constructor(e2) {
          ...
          e2.on("keyup keypress keydown", (e3) => {
            !t2.hasModifier(e3) && !t2.isFunctionKey(e3) || e3.isDefaultPrevented() || (UO(t2.shortcuts, (n2) => {
      ...
      }, WO = za.DOM, KO = Pt.extend, YO = Pt.each;
      class GO {
        constructor(e2, t2, n2) {
          ...
          const r2 = ((e3, t3) => ZT(WT || KT, WT, t3, e3, t3))(n2.defaultOptions, t2);
          this.options = /* @__PURE__ */ ((e3, t3) => {
            const n3 = {}, o3 = {}, r3 = (e4, t4, n4) => {
              const r4 = MO(t4, n4);
              return LO(r4) ? (o3[e4] = r4.value, true) : (console.warn(DO(`Invalid value passed for the ${e4} option`, r4)), false);
            }, s3 = (e4) => Ee(n3, e4);
            return { register: (e4, s4) => {
              const a3 = ((e5) => m(e5.processor))(s4) ? ((e5) => {
                ...
                return (n4) => MO(n4, t4, `The value must be a ${e5}.`);
              })(s4.processor) : s4.processor, i3 = ((e5, t4, n4) => {
                if (!v(t4)) {
                  const o4 = MO(t4, n4);
                  if (LO(o4)) return o4.value;
                  console.error(DO(`Invalid default value passed for the "${e5}" option`, o4));
                }
              })(e4, s4.default, a3);
            ...
            t3("id", { processor: "string", default: e3.id }), t3("selector", { processor: "string" }), t3("target", { processor: "object" }), t3("suffix", { processor: "string" }), t3("cache_suffix", { processor: "string" }), t3("base_url", { processor: "string" }), t3("referrer_policy", { processor: "string", default: "" }), t3("language_load", { processor: "boolean", default: true }), t3("inline", { processor: "boolean", default: false }), t3("iframe_attrs", { processor: "object", default: {} }), t3("doctype", { processor: "string", default: "<!DOCTYPE html>" }), t3("document_base_url", { processor: "string", default: e3.documentBaseUrl }), t3("body_id", { processor: Al(e3, "tinymce"), default: "tinymce" }), t3("body_class", { processor: Al(e3), default: "" }), t3("content_security_policy", { processor: "string", default: "" }), t3("br_in_pre", { processor: "boolean", default: true }), t3("forced_root_block", { processor: (e4) => {
            ...
            }, default: kd(e3) ? [] : ["default"] }), t3("content_style", { processor: "string" }), t3("content_css_cors", { processor: "boolean", default: false }), t3("font_css", { processor: (e4) => {
              ...
              t3("directionality", { processor: "string", default: Ka.isRtl() ? "rtl" : void 0 }), t3("placeholder", { processor: "string", default: kl.getAttrib(e3.getElement(), "placeholder") });
            });
          })(o2);
          const s2 = this.options.get;
          s2("deprecation_warnings") && ((e3, t3) => {
            ((e4, t4) => {
              const n3 = gw(e4), o3 = bw(t4), r3 = o3.length > 0, s3 = n3.length > 0, a3 = "mobile" === t4.theme;
              if (r3 || s3 || a3) {
                const e5 = "\n- ", t5 = a3 ? `
...
Options:${e5}${n3.join(e5)}` : "";
              ...
              const n3 = pw(e4), o3 = vw(t4), r3 = o3.length > 0, s3 = n3.length > 0;
              if (r3 || s3) {
                const e5 = "\n- ", t5 = r3 ? `

Plugins:${e5}${o3.map(yw).join(e5)}` : "", a3 = s3 ? `
...
Options:${e5}${n3.join(e5)}` : "";
          ...
          const d2 = Dd(o2);
          C(d2) && za.DOM.styleSheetLoader._setContentCssCors(d2), Ya.languageLoad = s2("language_load"), Ya.baseURL = n2.baseURL, this.setDirty(false), this.documentBaseURI = new oC(Bl(o2), { base_uri: this.baseUri }), this.baseURI = this.baseUri, this.inline = kd(o2), this.hasVisual = Fd(o2), this.shortcuts = new qO(this), this.editorCommands = new hO(this), fO(this);
          const c2 = s2("cache_suffix");
          c2 && (At.cacheSuffix = c2.replace(/^[\?\&]+/, "")), this.ui = { registry: VO(), styleSheetLoader: void 0, show: _, hide: _, setEnabled: _, isEnabled: M }, this.mode = ((e3) => {
            ...
            return ((e4) => {
              e4.serializer ? wO(e4) : e4.on("PreInit", () => {
                wO(e4);
              });
            })(e3), ((e4) => {
              e4.on("ShowCaret", (t4) => {
                CO(e4) && t4.preventDefault();
              }), e4.on("ObjectSelected", (t4) => {
                CO(e4) && t4.preventDefault();
              });
            })(e3), { isReadOnly: () => CO(e3), set: (o3) => ((e4, t4, n4, o4) => {
              if (o4 !== n4.get()) {
                if (!Ee(t4, o4)) throw new Error(`Editor mode '${o4}' is invalid`);
                e4.initialized ? FO(e4, n4, t4, o4) : e4.on("init", () => FO(e4, n4, t4, o4));
              }
            })(e3, n3.get(), t3, o3), get: () => t3.get(), register: (e4, t4) => {
              n3.set(((e5, t5, n4) => {
                if (H(IO, t5)) throw new Error(`Cannot override default mode ${t5}`);
        ...
        render() {
          ((e2) => {
            ...
            Ka.setCode(td(e2));
            const n2 = () => {
              jT.unbind(window, "ready", n2), e2.render();
            };
            if (!Ta.Event.domLoaded) return void jT.bind(window, "ready", n2);
            if (!e2.getElement()) return;
            const o2 = yn(e2.getElement()), r2 = rn(o2);
            e2.on("remove", () => {
              W(o2.dom.attributes, (e3) => on(o2, e3.name)), Zt(o2, r2);
            }), e2.ui.styleSheetLoader = ((e3, t3) => Is.forElement(e3, { contentCssCors: Dd(t3), referrerPolicy: ed(t3) }))(o2, e2), kd(e2) ? e2.inline = true : (e2.orgVisibility = e2.getElement().style.visibility, e2.getElement().style.visibility = "hidden");
            const s2 = e2.getElement().form || jT.getParent(t2, "form");
            s2 && (e2.formElement = s2, Sd(e2) && !Zo(e2.getElement()) && (jT.insertAfter(jT.create("input", { type: "hidden", name: t2 }), t2), e2.hasHiddenInput = true), e2.formEventDelegate = (t3) => {
              e2.dispatch(t3.type, t3);
            }, jT.bind(s2, "submit reset", e2.formEventDelegate), e2.on("reset", () => {
              e2.resetContent();
            }), !Nd(e2) || s2.submit.nodeType || s2.submit.length || s2._mceOldSubmit || (s2._mceOldSubmit = s2.submit, s2.submit = () => (e2.editorManager.triggerSave(), e2.setDirty(false), s2._mceOldSubmit(s2)))), e2.windowManager = Pw(e2), e2.notificationManager = Tw(e2), ((e3) => "xml" === e3.options.get("encoding"))(e2) && e2.on("GetContent", (e3) => {
              e3.save && (e3.content = jT.encode(e3.content));
            }), Rd(e2) && e2.on("submit", () => {
            ...
            }, e2.editorManager.on("BeforeUnload", e2._beforeUnload)), e2.editorManager.add(e2), qT(e2, e2.suffix);
          })(this);
        }
        focus(e2) {
        ...
        hasPlugin(e2, t2) {
          return !(!H(Ld(this), e2) || t2 && void 0 === Ow.get(e2));
        }
        nodeChanged(e2) {
        ...
        show() {
          const e2 = this;
          e2.hidden && (e2.hidden = false, e2.inline ? e2.getBody().contentEditable = "true" : (WO.show(e2.getContainer()), WO.hide(e2.id)), e2.load(), e2.dispatch("show"));
        }
        hide() {
          const e2 = this;
          e2.hidden || (e2.save(), e2.inline ? (e2.getBody().contentEditable = "false", e2 === e2.editorManager.focusedEditor && (e2.editorManager.focusedEditor = null)) : (WO.hide(e2.getContainer()), WO.setStyle(e2.id, "display", e2.orgDisplay)), e2.hidden = true, e2.dispatch("hide"));
        }
        isHidden() {
          return this.hidden;
        }
        ...
        save(e2 = {}) {
          ...
          if (s2.no_events || t2.dispatch("SaveContent", s2), "raw" === s2.format && t2.dispatch("RawSaveContent", s2), r2 = s2.content, Zo(n2)) n2.value = r2;
            ...
            const o3 = WO.getParent(t2.id, "form");
            o3 && YO(o3.elements, (e3) => e3.name !== t2.id || (e3.value = r2, false));
          }
          return s2.element = o2.element = n2 = null, false !== s2.set_dirty && t2.setDirty(false), r2;
        }
        setContent(e2, t2) {
          return lw(this, e2, t2);
        }
        getContent(e2) {
          return ((e3, t2 = {}) => {
            const n2 = ((e4, t3) => ({ ...e4, format: t3, get: true, getInner: true }))(t2, t2.format ? t2.format : "html");
            return yC(e3, n2).fold(R, (t3) => {
              const n3 = ((e4, t4) => QC(e4).editor.getContent(t4))(e3, t3);
              return CC(e3, n3, t3);
            });
          })(this, e2);
        }
        insertContent(e2, t2) {
          t2 && (e2 = KO({ content: e2 }, t2)), this.execCommand("mceInsertContent", false, e2);
        }
        resetContent(e2) {
          void 0 === e2 ? lw(this, this.startContent, { format: "raw" }) : lw(this, e2), this.undoManager.reset(), this.setDirty(false), this.nodeChanged();
        }
        isDirty() {
        ...
        getContainer() {
          const e2 = this;
          return e2.container || (e2.container = e2.editorContainer || WO.get(e2.id + "_parent")), e2.container;
        }
        getContentAreaContainer() {
          return this.contentAreaContainer;
        }
        getElement() {
          return this.targetElm || (this.targetElm = WO.get(this.id)), this.targetElm;
        }
        getWin() {
          const e2 = this;
          if (!e2.contentWindow) {
        ...
        remove() {
          ((e2) => {
            if (!e2.removed) {
              ...
              o2 && e2.save({ is_removing: true }), e2.removed = true, e2.unbindAllNativeEvents(), e2.hasHiddenInput && C(null == r2 ? void 0 : r2.nextSibling) && Cw.remove(r2.nextSibling), ((e3) => {
                e3.dispatch("remove");
              })(e2), e2.editorManager.remove(e2), !e2.inline && o2 && ((e3) => {
                Cw.setStyle(e3.id, "display", e3.orgDisplay);
              })(e2), ((e3) => {
                e3.dispatch("detach");
              })(e2), Cw.remove(e2.getContainer()), ww(t2), ww(n2), e2.destroy();
            }
          })(this);
        }
        destroy(e2) {
          ((e3, t2) => {
            ...
            e3.destroyed || (t2 || e3.removed ? (t2 || (e3.editorManager.off("beforeunload", e3._beforeUnload), e3.theme && e3.theme.destroy && e3.theme.destroy(), ww(n2), ww(o2)), ((e4) => {
              const t3 = e4.formElement;
              t3 && (t3._mceOldSubmit && (t3.submit = t3._mceOldSubmit, delete t3._mceOldSubmit), Cw.unbind(t3, "submit reset", e4.formEventDelegate));
            })(e3), ((e4) => {
              const t3 = e4;
      ...
      const tB = (e2) => {
        ...
        if (e2 !== ZO) {
          const t2 = za.DOM;
          e2 ? (t2.bind(window, "resize", tB), t2.bind(window, "scroll", tB)) : (t2.unbind(window, "resize", tB), t2.unbind(window, "scroll", tB)), ZO = e2;
        }
      }, oB = (e2) => {
        const t2 = eB;
        return eB = Y(eB, (t3) => e2 !== t3), sB.activeEditor === e2 && (sB.activeEditor = eB.length > 0 ? eB[0] : null), sB.focusedEditor === e2 && (sB.focusedEditor = null), t2.length !== eB.length;
      }, rB = "CSS1Compat" !== document.compatMode, sB = { ...SO, baseURI: null, baseURL: null, defaultOptions: {}, documentBaseURL: null, suffix: null, majorVersion: "6", minorVersion: "8.4", releaseDate: "2024-06-19", i18n: Ka, activeEditor: null, focusedEditor: null, setup() {
        const e2 = this;
        let t2 = "", n2 = "", o2 = oC.getDocumentBaseUrl(document.location);
        ...
        var s2;
        e2.baseURL = new oC(o2).toAbsolute(t2), e2.documentBaseURL = o2, e2.baseURI = new oC(e2.baseURL), e2.suffix = n2, (s2 = e2).on("AddEditor", T(_g, s2)), s2.on("RemoveEditor", T(kg, s2));
      }, overrideDefaults(e2) {
        ...
        const s2 = () => {
          ...
          XO.unbind(window, "ready", s2), ((n4) => {
            ...
            return n4;
          })(((e3) => At.browser.isIE() || At.browser.isEdge() ? (Fw("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers"), []) : rB ? (Fw("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), []) : m(e3.selector) ? XO.select(e3.selector) : C(e3.target) ? [e3.target] : [])(e2)), Pt.each(i2, (e3) => {
            var n4;
            (n4 = t2.get(e3.id)) && n4.initialized && !(n4.getContainer() || n4.getBody()).parentNode && (oB(n4), n4.unbindAllNativeEvents(), n4.destroy(true), n4.removed = true);
          }), i2 = Pt.grep(i2, (e3) => !t2.get(e3.id)), 0 === i2.length ? r2([]) : QO(i2, (s3) => {
            ((e3, t3) => e3.inline && t3.tagName.toLowerCase() in o2)(e2, s3) ? Fw("Could not initialize inline editor on invalid inline target element", s3) : ((e3, o3, s4) => {
              const l2 = new GO(e3, o3, t2);
              a2.push(l2), l2.on("init", () => {
                ++n3 === i2.length && r2(a2);
              }), l2.targetElm = l2.targetElm || s4, l2.render();
            })(((e3) => {
              let t3 = e3.id;
              return t3 || (t3 = xe(e3, "name").filter((e4) => !XO.get(e4)).getOrThunk(XO.uniqueId), e3.setAttribute("id", t3)), t3;
            })(s3), e2, s3);
          });
        };
        return XO.bind(window, "ready", s2), new Promise((e3) => {
          n2 ? e3(n2) : r2 = (t3) => {
            e3(t3);
          };
        });
      }, get(e2) {
        return 0 === arguments.length ? eB.slice(0) : m(e2) ? J(eB, (t2) => t2.id === e2).getOr(null) : x(e2) && eB[e2] ? eB[e2] : null;
      }, add(e2) {
        const t2 = this, n2 = t2.get(e2.id);
        return n2 === e2 || (null === n2 && eB.push(e2), nB(true), t2.activeEditor = e2, t2.dispatch("AddEditor", { editor: e2 }), JO || (JO = (e3) => {
          const n3 = t2.dispatch("BeforeUnload");
          if (n3.returnValue) return e3.preventDefault(), e3.returnValue = n3.returnValue, n3.returnValue;
        }, window.addEventListener("beforeunload", JO))), e2;
      }, createEditor(e2, t2) {
        return this.add(new GO(e2, t2, this));
      }, remove(e2) {
        const t2 = this;
        let n2;
        if (e2) {
          if (!m(e2)) return n2 = e2, h(t2.get(n2.id)) ? null : (oB(n2) && t2.dispatch("RemoveEditor", { editor: n2 }), 0 === eB.length && window.removeEventListener("beforeunload", JO), n2.remove(), nB(eB.length > 0), n2);
          QO(XO.select(e2), (e3) => {
            n2 = t2.get(e3.id), n2 && t2.remove(n2);
          });
        } else for (let e3 = eB.length - 1; e3 >= 0; e3--) t2.remove(eB[e3]);
        ...
        this.baseURL = new oC(this.documentBaseURL).toAbsolute(e2.replace(/\/+$/, "")), this.baseURI = new oC(this.baseURL);
      } };
      sB.setup();
      const aB = (() => {
        const e2 = Xa();
      ...
      })(), iB = Math.min, lB = Math.max, dB = Math.round, cB = (e2, t2, n2) => {
        let o2 = t2.x, r2 = t2.y;
        const s2 = e2.w, a2 = e2.h, i2 = t2.w, l2 = t2.h, d2 = (n2 || "").split("");
        return "b" === d2[0] && (r2 += l2), "r" === d2[1] && (o2 += i2), "c" === d2[0] && (r2 += dB(l2 / 2)), "c" === d2[1] && (o2 += dB(i2 / 2)), "b" === d2[3] && (r2 -= a2), "r" === d2[4] && (o2 -= s2), "c" === d2[3] && (r2 -= dB(a2 / 2)), "c" === d2[4] && (o2 -= dB(s2 / 2)), uB(o2, r2, s2, a2);
      }, uB = (e2, t2, n2, o2) => ({ x: e2, y: t2, w: n2, h: o2 }), mB = { inflate: (e2, t2, n2) => uB(e2.x - t2, e2.y - n2, e2.w + 2 * t2, e2.h + 2 * n2), relativePosition: cB, findBestRelativePosition: (e2, t2, n2, o2) => {
        for (let r2 = 0; r2 < o2.length; r2++) {
          const s2 = cB(e2, t2, o2[r2]);
          if (s2.x >= n2.x && s2.x + s2.w <= n2.w + n2.x && s2.y >= n2.y && s2.y + s2.h <= n2.h + n2.y) return o2[r2];
        }
        return null;
      }, intersect: (e2, t2) => {
        const n2 = lB(e2.x, t2.x), o2 = lB(e2.y, t2.y), r2 = iB(e2.x + e2.w, t2.x + t2.w), s2 = iB(e2.y + e2.h, t2.y + t2.h);
        return r2 - n2 < 0 || s2 - o2 < 0 ? null : uB(n2, o2, r2 - n2, s2 - o2);
      }, clamp: (e2, t2, n2) => {
        let o2 = e2.x, r2 = e2.y, s2 = e2.x + e2.w, a2 = e2.y + e2.h;
        const i2 = t2.x + t2.w, l2 = t2.y + t2.h, d2 = lB(0, t2.x - o2), c2 = lB(0, t2.y - r2), u2 = lB(0, s2 - i2), m2 = lB(0, a2 - l2);
        return o2 += d2, r2 += c2, n2 && (s2 += d2, a2 += c2, o2 -= u2, r2 -= m2), s2 -= u2, a2 -= m2, uB(o2, r2, s2 - o2, a2 - r2);
      }, create: uB, fromClientRect: (e2) => uB(e2.left, e2.top, e2.width, e2.height) }, fB = /* @__PURE__ */ (() => {
        const e2 = {}, t2 = {}, n2 = {};
        return { load: (n3, o2) => {
      ...
      try {
        ...
        gB = window.localStorage, gB.setItem(e2, e2), gB.removeItem(e2);
      } catch (e2) {
        gB = (() => {
          let e3 = {}, t2 = [];
      ...
      const pB = { geom: { Rect: mB }, util: { Delay: vg, Tools: Pt, VK: af, URI: oC, EventDispatcher: _O, Observable: SO, I18n: Ka, LocalStorage: gB, ImageUploader: (e2) => {
        const t2 = Hw(), n2 = Ww(e2, t2);
        return { upload: (t3, o2 = true) => n2.upload(t3, o2 ? Vw(e2) : void 0) };
      } }, dom: { EventUtils: Ta, TreeWalker: jo, TextSeeker: hi, DOMUtils: za, ScriptLoader: Ha, RangeUtils: Uf, Serializer: iw, StyleSheetLoader: Ms, ControlSelection: mf, BookmarkManager: Jm, Selection: rw, Event: Ta.Event }, html: { Styles: wa, Entities: ea, Node: Wg, Schema: ua, DomParser: bC, Writer: cp, Serializer: up }, Env: At, AddOnManager: Ya, Annotator: Qm, Formatter: rx, UndoManager: ax, EditorCommands: hO, WindowManager: Pw, NotificationManager: Tw, EditorObservable: BO, Shortcuts: qO, Editor: GO, FocusManager: bg, EditorManager: sB, DOM: za.DOM, ScriptLoader: Ha.ScriptLoader, PluginManager: Ow, ThemeManager: Bw, ModelManager: Ew, IconManager: xw, Resource: fB, FakeClipboard: aB, trim: Pt.trim, isArray: Pt.isArray, is: Pt.is, toArray: Pt.toArray, makeMap: Pt.makeMap, each: Pt.each, map: Pt.map, grep: Pt.grep, inArray: Pt.inArray, extend: Pt.extend, walk: Pt.walk, resolve: Pt.resolve, explode: Pt.explode, _addCacheSuffix: Pt._addCacheSuffix }, hB = Pt.extend(sB, pB);
      ((e2) => {
